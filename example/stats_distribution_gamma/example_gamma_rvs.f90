program example_gamma_rvs
  ...
  ! single standard gamma random variate with shape=2.0
  print *, rgamma(2.0)
  ! 2.50538206

  ! gamma random variate with shape=3.0, rate=2.0 (loc=0.0 by default)
  print *, rgamma(3.0, 2.0)
  ! 1.30591583

  ! gamma random variate with shape=3.0, rate=2.0, loc=1.5
  print *, rgamma(3.0, 2.0, 1.5)
  ! 2.80591583
  ...
  ! an array of 10 random variates with shape=0.5, rate=1.0 (loc=0.0 by default)
  ...
  ! an array of 10 random variates with shape=0.5, rate=1.0, loc=2.0
  print *, rgamma(0.5, 1.0, 10, 2.0)
  ! 2.00013971  2.29641938  2.35211301  4.80515051  2.00036526
  ! 2.19774345  2.05545694  2.09305988  3.02596343  3.85311246

  cshape = (3.0, 4.0)
  crate = (2.0, 0.7)
  ! single complex gamma random variate with real part of shape=3.0, rate=2.0;
  ! imaginary part of shape=4.0, rate=0.7 (loc=(0,0) by default)
  print *, rgamma(cshape, crate)

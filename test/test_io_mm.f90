...
contains
    ...
    subroutine test_io_mm_coordinate(error)
        ...
        block
            ...
            str = "test/io/test_io_mm.fypp"
            i = len_trim(str)
            do while(i > 0)
                if(str(i:i) == '/' .or. str(i:i) == '\') exit
                i = i - 1
            end do
            path = str(:i) // "../data/matrix_market/"

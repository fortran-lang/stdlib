...
contains
    ...
    subroutine test_random_seed(error)
        ...
        integer, parameter :: ans(5) = [-1859553078, -1933696596, -642834430, &
    ...
    subroutine test_random_rand_iint8(error)
        ...
        integer :: put, get, i
        integer(int8) :: res(5)
        integer(int8), parameter :: ans(5) = [118, -15, -72, 101, 70]
    ...
    subroutine test_random_rand_iint16(error)
        ...
        integer :: put, get, i
        integer(int16) :: res(5)
        integer(int16), parameter :: ans(5) = [30286, -3799, -18204, 25947, 18148]
    ...
    subroutine test_random_rand_iint32(error)
        ...
        integer :: put, get, i
        integer(int32) :: res(5)
        integer(int32), parameter :: ans(5)=[1984865646, -248954393, -1192993267, &
    ...
    subroutine test_random_rand_iint64(error)
        ...
        integer :: put, get, i
        integer(int64) :: res(5)
        integer(int64), parameter :: ans(5)=[8524933037632333570_int64, &

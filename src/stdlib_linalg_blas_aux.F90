module stdlib_linalg_blas_aux
     ...
     public :: stdlib_I64_isamax
     public :: stdlib_I64_idamax
     public :: stdlib_I64_icamax
     public :: stdlib_I64_izamax
     ...
     pure subroutine stdlib_I64_xerbla( srname, info )
     !! XERBLA is an error handler for the LAPACK routines.
     !! It is called by an LAPACK routine if an input parameter has an
     !! invalid value.  A message is printed and execution stops.
     !! Installers may consider modifying the STOP statement in order to
     ...
     end subroutine stdlib_I64_xerbla


     pure subroutine stdlib_I64_xerbla_array(srname_array, srname_len, info)
     !! XERBLA_ARRAY assists other languages in calling XERBLA, the LAPACK
     !! and BLAS error handler.  Rather than taking a Fortran string argument
     !! as the function's name, XERBLA_ARRAY takes an array of single
     !! characters along with the array's length.  XERBLA_ARRAY then copies
     ...
     !! errors.  XERBLA_ARRAY calls XERBLA.
        ...
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ! Scalar Arguments 
           integer(ilp64), intent(in) :: srname_len, info
           ! Array Arguments 
           character(1), intent(in) :: srname_array(srname_len)
       ! =====================================================================
           ! Local Scalars 
           ...
           call stdlib_I64_xerbla( srname, info )
           return
     end subroutine stdlib_I64_xerbla_array

     pure integer(ilp64) function stdlib_I64_isamax(n,dx,incx) result(iamax)
     !! IDAMAX: finds the index of the first element having maximum absolute value.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_isamax
     
     pure integer(ilp64) function stdlib_I64_idamax(n,dx,incx) result(iamax)
     !! IDAMAX: finds the index of the first element having maximum absolute value.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_idamax
     
     pure integer(ilp64) function stdlib_I64_icamax(n,zx,incx) result(iamax)
     !! IZAMAX: finds the index of the first element having maximum |Re(.)| + |Im(.)|
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_icamax
     
     pure integer(ilp64) function stdlib_I64_izamax(n,zx,incx) result(iamax)
     !! IZAMAX: finds the index of the first element having maximum |Re(.)| + |Im(.)|
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_izamax

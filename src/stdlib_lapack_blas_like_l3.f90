  ...
  contains
        ...
        ! =====================================================================
           ...
           if( alpha==one ) then
              if( stdlib_lsame( trans, 'N' ) ) then
                 ...
                 do j = 1, nrhs
                    if( n==1_ilp64 ) then
                       b( 1_ilp64, j ) = b( 1_ilp64, j ) + d( 1_ilp64 )*x( 1_ilp64, j )
                    else
                       b( 1_ilp64, j ) = b( 1_ilp64, j ) + d( 1_ilp64 )*x( 1_ilp64, j ) +du( 1_ilp64 )*x( 2_ilp64, j )
                       b( n, j ) = b( n, j ) + dl( n-1 )*x( n-1, j ) +d( n )*x( n, j )
                       do i = 2, n - 1
                          b( i, j ) = b( i, j ) + dl( i-1 )*x( i-1, j ) +d( i )*x( i, j ) + du( i &
                                    )*x( i+1, j )
                 ...
                 do j = 1, nrhs
                    if( n==1_ilp64 ) then
                       ...
                       b( 1_ilp64, j ) = b( 1_ilp64, j ) + d( 1_ilp64 )*x( 1_ilp64, j ) +dl( 1_ilp64 )*x( 2_ilp64, j )
                       b( n, j ) = b( n, j ) + du( n-1 )*x( n-1, j ) +d( n )*x( n, j )
                       do i = 2, n - 1
                          b( i, j ) = b( i, j ) + du( i-1 )*x( i-1, j ) +d( i )*x( i, j ) + dl( i &
                                    )*x( i+1, j )
        ...
        ! =====================================================================
           ...
           if( alpha==one ) then
              if( stdlib_lsame( trans, 'N' ) ) then
                 ...
                 do j = 1, nrhs
                    if( n==1_ilp64 ) then
                       b( 1_ilp64, j ) = b( 1_ilp64, j ) + conjg( d( 1_ilp64 ) )*x( 1_ilp64, j )
                    else
                       b( 1_ilp64, j ) = b( 1_ilp64, j ) + conjg( d( 1_ilp64 ) )*x( 1_ilp64, j ) +conjg( dl( 1_ilp64 ) )*x(&
                           & 2_ilp64, &
                                 j )
                       b( n, j ) = b( n, j ) + conjg( du( n-1 ) )*x( n-1, j ) + conjg( d( n ) )*x(&
                                  n, j )
     ...
     !! C is M by N and complex.
        ...
        ! =====================================================================
           ...
           l = m*n + 1_ilp64
           call stdlib_I64_sgemm( 'N', 'N', m, n, n, one, rwork, m, b, ldb, zero,rwork( l ), m )
     ...
     !! C is M by N and complex.
        ...
        ! =====================================================================
           ...
           l = m*n + 1_ilp64
           call stdlib_I64_dgemm( 'N', 'N', m, n, n, one, rwork, m, b, ldb, zero,rwork( l ), m )
     ...
     !! C is M by N and complex.
        ...
        ! =====================================================================
           ...
           l = m*n + 1_ilp64
           call stdlib_I64_sgemm( 'N', 'N', m, n, m, one, a, lda, rwork, m, zero,rwork( l ), m )
     ...
     !! C is M by N and complex.
        ...
        ! =====================================================================
           ...
           l = m*n + 1_ilp64
           call stdlib_I64_dgemm( 'N', 'N', m, n, m, one, a, lda, rwork, m, zero,rwork( l ), m )
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           ! Local Scalars 
           logical(lk) :: lower, normaltransr, nisodd, notrans
           integer(ilp64) :: info, nrowa, j, nk, n1, n2
           complex(sp) :: calpha, cbeta
           ! Intrinsic Functions 
           ! Executable Statements 
           ! test the input parameters.
           ...
           if( .not.normaltransr .and. .not.stdlib_lsame( transr, 'C' ) ) then
              ...
              info = -5_ilp64
           else if( lda<max( 1_ilp64, nrowa ) ) then
              info = -8_ilp64
           end if
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'CHFRK ', -info )
              return
           end if
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_I64_cherk for example) and left in the general case.
           if( ( n==0_ilp64 ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp64 ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
                 c( j ) = czero
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_cherk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_cherk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_cgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_I64_cherk( 'L', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_cherk( 'U', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_cgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_cherk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_cherk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp64 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_cgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( n2, 1_ilp64 ), &
                                 lda, cbeta, c( 1_ilp64 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_I64_cherk( 'L', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_cherk( 'U', 'C', n2, k, alpha, a( 1_ilp64, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_cgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n2 ), &
                                 lda, cbeta, c( 1_ilp64 ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_I64_cherk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_cherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_cgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( n1+1, 1_ilp64 )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_I64_cherk( 'U', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_cherk( 'L', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_cgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n1+1 )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 'c', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_I64_cherk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_cherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_cgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), n2 )
                    else
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_I64_cherk( 'U', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_cherk( 'L', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_cgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_cherk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_cherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_cgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_I64_cherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_cherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_cgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_cherk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_cherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_cgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_I64_cherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_cherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_cgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 )&
                                 , lda, cbeta, c( 1_ilp64 ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_I64_cherk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_cherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_cgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_I64_cherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_cherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_cgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_I64_cherk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_cherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_cgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_I64_cherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_cherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_cgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), nk )
                    end if
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'ZHFRK ', -info )
              return
           end if
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_I64_zherk for example) and left in the general case.
           if( ( n==0_ilp64 ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp64 ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_zherk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_zherk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_zgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_I64_zherk( 'L', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_zherk( 'U', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_zgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_zherk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_zherk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp64 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_zgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( n2, 1_ilp64 ), &
                                 lda, cbeta, c( 1_ilp64 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_I64_zherk( 'L', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_zherk( 'U', 'C', n2, k, alpha, a( 1_ilp64, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_zgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n2 ), &
                                 lda, cbeta, c( 1_ilp64 ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_I64_zherk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_zherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_zgemm( 'N', 'C', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( n1+1, 1_ilp64 )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_I64_zherk( 'U', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_zherk( 'L', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_zgemm( 'C', 'N', n1, n2, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n1+1 )&
                                 , lda, cbeta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 'c', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_I64_zherk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_zherk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_zgemm( 'N', 'C', n2, n1, k, calpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), n2 )
                    else
                       ! n is odd, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_I64_zherk( 'U', 'C', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_zherk( 'L', 'C', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_zgemm( 'C', 'N', n2, n1, k, calpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_zherk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_zherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_zgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'c'
                       call stdlib_I64_zherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_zherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_zgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_zherk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_zherk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_zgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'c'
                       call stdlib_I64_zherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_zherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_zgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 )&
                                 , lda, cbeta, c( 1_ilp64 ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'n'
                       call stdlib_I64_zherk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_zherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_zgemm( 'N', 'C', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'l', and trans = 'c'
                       call stdlib_I64_zherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_zherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_zgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 )&
                                 , lda, cbeta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'n'
                       call stdlib_I64_zherk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_zherk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_zgemm( 'N', 'C', nk, nk, k, calpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), nk )
                    else
                       ! n is even, transr = 'c', uplo = 'u', and trans = 'c'
                       call stdlib_I64_zherk( 'U', 'C', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_zherk( 'L', 'C', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_zgemm( 'C', 'N', nk, nk, k, calpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 )&
                                 , lda, cbeta, c( 1_ilp64 ), nk )
                    end if
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           ! Local Scalars 
           logical(lk) :: lower, lside, misodd, nisodd, normaltransr, notrans
           integer(ilp64) :: m1, m2, n1, n2, k, info, i, j
           ! Intrinsic Functions 
           ! Executable Statements 
           ! test the input parameters.
           info = 0_ilp64
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'STFSM ', -info )
              return
           end if
           ! quick return when ( (n==0).or.(m==0) )
           if( ( m==0 ) .or. ( n==0 ) )return
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_strsm( 'L', 'L', 'N', diag, m1, n, alpha,a, m, b, ldb )
                                       
                          else
                             call stdlib_I64_strsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                             call stdlib_I64_sgemm( 'N', 'N', m2, n, m1, -one, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_strsm( 'L', 'U', 'T', diag, m2, n, one,a( m ), m, b( m1, &
                                       0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_strsm( 'L', 'L', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                          else
                             call stdlib_I64_strsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_sgemm( 'T', 'N', m1, n, m2, -one, a( m1 ),m, b( m1, 0_ilp64 ), &
                                       ldb, alpha, b, ldb )
                             call stdlib_I64_strsm( 'L', 'L', 'T', diag, m1, n, one,a( 0_ilp64 ), m, b, ldb &
                                       )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_I64_sgemm( 'T', 'N', m2, n, m1, -one, a( 0_ilp64 ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, m2, n, one,a( m1 ), m, b( m1, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m1, n, m2, -one, a( 0_ilp64 ), m,b( m1, 0_ilp64 ), ldb,&
                                     alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, m1, n, one,a( m2 ), m, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_strsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_strsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                             call stdlib_I64_sgemm( 'T', 'N', m2, n, m1, -one,a( m1*m1 ), m1, b, ldb, &
                                       alpha,b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_strsm( 'L', 'L', 'N', diag, m2, n, one,a( 1_ilp64 ), m1, b( m1,&
                                        0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_strsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_strsm( 'L', 'L', 'T', diag, m2, n, alpha,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_sgemm( 'N', 'N', m1, n, m2, -one,a( m1*m1 ), m1, b( m1, &
                                       0_ilp64 ), ldb,alpha, b, ldb )
                             call stdlib_I64_strsm( 'L', 'U', 'N', diag, m1, n, one,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m2, n, m1, -one, a( 0_ilp64 ), m2,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, m2, n, one,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'T', 'N', m1, n, m2, -one, a( 0_ilp64 ), m2,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, m1, n, one,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp64 ), m+1, b, ldb &
                                    )
                          call stdlib_I64_sgemm( 'N', 'N', k, n, k, -one, a( k+1 ),m+1, b, ldb, alpha,&
                                     b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, k, n, one,a( 0_ilp64 ), m+1, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp64 ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'T', 'N', k, n, k, -one, a( k+1 ),m+1, b( k, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, k, n, one,a( 1_ilp64 ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_I64_sgemm( 'T', 'N', k, n, k, -one, a( 0_ilp64 ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, k, n, one,a( k ), m+1, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', k, n, k, -one, a( 0_ilp64 ), m+1,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, k, n, one,a( k+1 ), m+1, b, ldb &
                                    )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 't', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, k, n, alpha,a( k ), k, b, ldb )
                                    
                          call stdlib_I64_sgemm( 'T', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, k, n, one,a( 0_ilp64 ), k, b( k, 0_ilp64 ), &
                                    ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, k, n, alpha,a( 0_ilp64 ), k, b( k, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_sgemm( 'N', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b( k, 0_ilp64 ),&
                                     ldb,alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, k, n, one,a( k ), k, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'L', 'U', 'T', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_I64_sgemm( 'N', 'N', k, n, k, -one, a( 0_ilp64 ), k, b,ldb, alpha, b( &
                                    k, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'L', 'L', 'N', diag, k, n, one,a( k*k ), k, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'L', 'L', 'T', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'T', 'N', k, n, k, -one, a( 0_ilp64 ), k,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_strsm( 'L', 'U', 'N', diag, k, n, one,a( k*( k+1 ) ), k, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, n1, one,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, n1, alpha,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( n1 ), n,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, n2, one,a( n ), n, b( 0_ilp64, n1 )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n, &
                                    alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, n2, one,a( n1 ), n, b( 0_ilp64, n1 &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), n,&
                                     alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, n1, one,a( n2 ), n, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, n1, one,a( 0_ilp64 ), n1, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp64 ), n1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( n1*n1 ),&
                                     n1, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, n2, one,a( 1_ilp64 ), n1, b( 0_ilp64, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n2,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, n2, one,a( n1*n2 ), n2, b( 0_ilp64,&
                                     n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, n1, one,a( n2*n2 ), n2, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, k, alpha,a( 0_ilp64 ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, k ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, k, one,a( 1_ilp64 ), n+1, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, k, alpha,a( 1_ilp64 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, k, one,a( 0_ilp64 ), n+1, b( 0_ilp64, k )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n+1, &
                                    alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, k, one,a( k ), n+1, b( 0_ilp64, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, k, alpha,a( k ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), n+1, &
                                    alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, k, one,a( k+1 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp64 ), k, b( 0_ilp64, k )&
                                    , ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, k ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, k, one,a( k ), k, b( 0_ilp64, 0_ilp64 ), &
                                    ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp64, k ), ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, k, one,a( 0_ilp64 ), k, b( 0_ilp64, k ), &
                                    ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_strsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_sgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, k ), ldb )
                          call stdlib_I64_strsm( 'R', 'L', 'T', diag, m, k, one,a( k*k ), k, b( 0_ilp64, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_strsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_sgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_strsm( 'R', 'U', 'T', diag, m, k, one,a( ( k+1 )*k ), k, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'DTFSM ', -info )
              return
           end if
           ! quick return when ( (n==0).or.(m==0) )
           if( ( m==0 ) .or. ( n==0 ) )return
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a, m, b, ldb )
                                       
                          else
                             call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                             call stdlib_I64_dgemm( 'N', 'N', m2, n, m1, -one, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, m2, n, one,a( m ), m, b( m1, &
                                       0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                          else
                             call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_dgemm( 'T', 'N', m1, n, m2, -one, a( m1 ),m, b( m1, 0_ilp64 ), &
                                       ldb, alpha, b, ldb )
                             call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, m1, n, one,a( 0_ilp64 ), m, b, ldb &
                                       )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_I64_dgemm( 'T', 'N', m2, n, m1, -one, a( 0_ilp64 ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, m2, n, one,a( m1 ), m, b( m1, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m1, n, m2, -one, a( 0_ilp64 ), m,b( m1, 0_ilp64 ), ldb,&
                                     alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, m1, n, one,a( m2 ), m, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                             call stdlib_I64_dgemm( 'T', 'N', m2, n, m1, -one,a( m1*m1 ), m1, b, ldb, &
                                       alpha,b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, m2, n, one,a( 1_ilp64 ), m1, b( m1,&
                                        0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, m2, n, alpha,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_dgemm( 'N', 'N', m1, n, m2, -one,a( m1*m1 ), m1, b( m1, &
                                       0_ilp64 ), ldb,alpha, b, ldb )
                             call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, m1, n, one,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m2, n, m1, -one, a( 0_ilp64 ), m2,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, m2, n, one,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'T', 'N', m1, n, m2, -one, a( 0_ilp64 ), m2,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, m1, n, one,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp64 ), m+1, b, ldb &
                                    )
                          call stdlib_I64_dgemm( 'N', 'N', k, n, k, -one, a( k+1 ),m+1, b, ldb, alpha,&
                                     b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, k, n, one,a( 0_ilp64 ), m+1, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp64 ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'T', 'N', k, n, k, -one, a( k+1 ),m+1, b( k, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, k, n, one,a( 1_ilp64 ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_I64_dgemm( 'T', 'N', k, n, k, -one, a( 0_ilp64 ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, k, n, one,a( k ), m+1, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', k, n, k, -one, a( 0_ilp64 ), m+1,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, k, n, one,a( k+1 ), m+1, b, ldb &
                                    )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 't', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, k, n, alpha,a( k ), k, b, ldb )
                                    
                          call stdlib_I64_dgemm( 'T', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, k, n, one,a( 0_ilp64 ), k, b( k, 0_ilp64 ), &
                                    ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, k, n, alpha,a( 0_ilp64 ), k, b( k, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_dgemm( 'N', 'N', k, n, k, -one,a( k*( k+1 ) ), k, b( k, 0_ilp64 ),&
                                     ldb,alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, k, n, one,a( k ), k, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'L', 'U', 'T', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_I64_dgemm( 'N', 'N', k, n, k, -one, a( 0_ilp64 ), k, b,ldb, alpha, b( &
                                    k, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'L', 'L', 'N', diag, k, n, one,a( k*k ), k, b( k, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='l', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'L', 'L', 'T', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'T', 'N', k, n, k, -one, a( 0_ilp64 ), k,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_dtrsm( 'L', 'U', 'N', diag, k, n, one,a( k*( k+1 ) ), k, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, n1, one,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, n1, alpha,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( n1 ), n,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, n2, one,a( n ), n, b( 0_ilp64, n1 )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n, &
                                    alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, n2, one,a( n1 ), n, b( 0_ilp64, n1 &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), n,&
                                     alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, n1, one,a( n2 ), n, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, n1, one,a( 0_ilp64 ), n1, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'l', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp64 ), n1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( n1*n1 ),&
                                     n1, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, n2, one,a( 1_ilp64 ), n1, b( 0_ilp64, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, n2, n1, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n2,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, n2, one,a( n1*n2 ), n2, b( 0_ilp64,&
                                     n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 't', uplo = 'u', and
                          ! trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, n1, n2, -one, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, n1, one,a( n2*n2 ), n2, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, k, alpha,a( 0_ilp64 ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, k ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, k, one,a( 1_ilp64 ), n+1, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, k, alpha,a( 1_ilp64 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, k, one,a( 0_ilp64 ), n+1, b( 0_ilp64, k )&
                                    , ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n+1, &
                                    alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, k, one,a( k ), n+1, b( 0_ilp64, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, k, alpha,a( k ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), n+1, &
                                    alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, k, one,a( k+1 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp64 ), k, b( 0_ilp64, k )&
                                    , ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, k ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, k, one,a( k ), k, b( 0_ilp64, 0_ilp64 ), &
                                    ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'l',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( ( k+1 )*k &
                                    ), k, alpha,b( 0_ilp64, k ), ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, k, one,a( 0_ilp64 ), k, b( 0_ilp64, k ), &
                                    ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 't', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_dtrsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_dgemm( 'N', 'T', m, k, k, -one, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, k ), ldb )
                          call stdlib_I64_dtrsm( 'R', 'L', 'T', diag, m, k, one,a( k*k ), k, b( 0_ilp64, k )&
                                    , ldb )
                       else
                          ! side  ='r', n is even, transr = 't', uplo = 'u',
                          ! and trans = 't'
                          call stdlib_I64_dtrsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_dgemm( 'N', 'N', m, k, k, -one, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_dtrsm( 'R', 'U', 'T', diag, m, k, one,a( ( k+1 )*k ), k, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'CTFSM ', -info )
              return
           end if
           ! quick return when ( (n==0).or.(m==0) )
           if( ( m==0 ) .or. ( n==0 ) )return
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, m1, n, alpha,a, m, b, ldb )
                                       
                          else
                             call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                             call stdlib_I64_cgemm( 'N', 'N', m2, n, m1, -cone, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m ), m, b( m1,&
                                        0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                          else
                             call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_cgemm( 'C', 'N', m1, n, m2, -cone, a( m1 ),m, b( m1, 0_ilp64 ),&
                                        ldb, alpha, b, ldb )
                             call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, m1, n, cone,a( 0_ilp64 ), m, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_I64_cgemm( 'C', 'N', m2, n, m1, -cone, a( 0_ilp64 ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m1, n, m2, -cone, a( 0_ilp64 ), m,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, m1, n, cone,a( m2 ), m, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                             call stdlib_I64_cgemm( 'C', 'N', m2, n, m1, -cone,a( m1*m1 ), m1, b, ldb,&
                                        alpha,b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, m2, n, cone,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_cgemm( 'N', 'N', m1, n, m2, -cone,a( m1*m1 ), m1, b( m1, &
                                       0_ilp64 ), ldb,alpha, b, ldb )
                             call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, m1, n, cone,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m2, n, m1, -cone, a( 0_ilp64 ), m2,b, ldb, alpha,&
                                     b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, m2, n, cone,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'C', 'N', m1, n, m2, -cone, a( 0_ilp64 ), m2,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, m1, n, cone,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp64 ), m+1, b, ldb &
                                    )
                          call stdlib_I64_cgemm( 'N', 'N', k, n, k, -cone, a( k+1 ),m+1, b, ldb, &
                                    alpha, b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, k, n, cone,a( 0_ilp64 ), m+1, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp64 ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'C', 'N', k, n, k, -cone, a( k+1 ),m+1, b( k, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, k, n, cone,a( 1_ilp64 ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_I64_cgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp64 ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, k, n, cone,a( k ), m+1, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp64 ), m+1,b( k, 0_ilp64 ), ldb,&
                                     alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, k, n, cone,a( k+1 ), m+1, b, &
                                    ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, k, n, alpha,a( k ), k, b, ldb )
                                    
                          call stdlib_I64_cgemm( 'C', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, k, n, cone,a( 0_ilp64 ), k, b( k, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, k, n, alpha,a( 0_ilp64 ), k, b( k, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_cgemm( 'N', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b( k, 0_ilp64 )&
                                    , ldb,alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, k, n, cone,a( k ), k, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'L', 'U', 'C', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_I64_cgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp64 ), k, b,ldb, alpha, b(&
                                     k, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'L', 'L', 'N', diag, k, n, cone,a( k*k ), k, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'L', 'L', 'C', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp64 ), k,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_ctrsm( 'L', 'U', 'N', diag, k, n, cone,a( k*( k+1 ) ), k, b,&
                                     ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, n1, cone,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n ), n, b( 0_ilp64, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, n1, cone,a( n2 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( n1*n1 &
                                    ), n1, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, n1, cone,a( 0_ilp64 ), n1, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp64 ), n1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, n2, cone,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, n2, cone,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, n1, cone,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, k, alpha,a( 0_ilp64 ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, k, cone,a( 1_ilp64 ), n+1, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, k, alpha,a( 1_ilp64 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, k, cone,a( 0_ilp64 ), n+1, b( 0_ilp64, k &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n+1,&
                                     alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, k, cone,a( k ), n+1, b( 0_ilp64, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, k, alpha,a( k ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), n+1,&
                                     alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, k, cone,a( k+1 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp64 ), k, b( 0_ilp64, k )&
                                    , ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, k, cone,a( k ), k, b( 0_ilp64, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp64, k ), ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, k, cone,a( 0_ilp64 ), k, b( 0_ilp64, k ),&
                                     ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ctrsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_cgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, k ), ldb )
                          call stdlib_I64_ctrsm( 'R', 'L', 'C', diag, m, k, cone,a( k*k ), k, b( 0_ilp64, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ctrsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_cgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ctrsm( 'R', 'U', 'C', diag, m, k, cone,a( ( k+1 )*k ), k, b(&
                                     0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'ZTFSM ', -info )
              return
           end if
           ! quick return when ( (n==0).or.(m==0) )
           if( ( m==0 ) .or. ( n==0 ) )return
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, m1, n, alpha,a, m, b, ldb )
                                       
                          else
                             call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                             call stdlib_I64_zgemm( 'N', 'N', m2, n, m1, -cone, a( m1 ),m, b, ldb, &
                                       alpha, b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m ), m, b( m1,&
                                        0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m, b, &
                                       ldb )
                          else
                             call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m ), m, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_zgemm( 'C', 'N', m1, n, m2, -cone, a( m1 ),m, b( m1, 0_ilp64 ),&
                                        ldb, alpha, b, ldb )
                             call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, m1, n, cone,a( 0_ilp64 ), m, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, m1, n, alpha,a( m2 ), m, b, ldb &
                                    )
                          call stdlib_I64_zgemm( 'C', 'N', m2, n, m1, -cone, a( 0_ilp64 ), m,b, ldb, alpha, &
                                    b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, m2, n, cone,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, m2, n, alpha,a( m1 ), m, b( m1, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m1, n, m2, -cone, a( 0_ilp64 ), m,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, m1, n, cone,a( m2 ), m, b, ldb )
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ...
                          ! trans = 'n'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                             call stdlib_I64_zgemm( 'C', 'N', m2, n, m1, -cone,a( m1*m1 ), m1, b, ldb,&
                                        alpha,b( m1, 0_ilp64 ), ldb )
                             call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, m2, n, cone,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                          end if
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          if( m==1_ilp64 ) then
                             call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, m1, n, alpha,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          else
                             call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( 1_ilp64 ), m1, b( &
                                       m1, 0_ilp64 ), ldb )
                             call stdlib_I64_zgemm( 'N', 'N', m1, n, m2, -cone,a( m1*m1 ), m1, b( m1, &
                                       0_ilp64 ), ldb,alpha, b, ldb )
                             call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, m1, n, cone,a( 0_ilp64 ), m1, b, &
                                       ldb )
                          end if
                       end if
                    else
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, m1, n, alpha,a( m2*m2 ), m2, b, &
                                    ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m2, n, m1, -cone, a( 0_ilp64 ), m2,b, ldb, alpha,&
                                     b( m1, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, m2, n, cone,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                       else
                          ! side  ='l', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, m2, n, alpha,a( m1*m2 ), m2, b( &
                                    m1, 0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'C', 'N', m1, n, m2, -cone, a( 0_ilp64 ), m2,b( m1, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, m1, n, cone,a( m2*m2 ), m2, b, &
                                    ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, k, n, alpha,a( 1_ilp64 ), m+1, b, ldb &
                                    )
                          call stdlib_I64_zgemm( 'N', 'N', k, n, k, -cone, a( k+1 ),m+1, b, ldb, &
                                    alpha, b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, k, n, cone,a( 0_ilp64 ), m+1, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, k, n, alpha,a( 0_ilp64 ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'C', 'N', k, n, k, -cone, a( k+1 ),m+1, b( k, 0_ilp64 ), &
                                    ldb, alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, k, n, cone,a( 1_ilp64 ), m+1, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, k, n, alpha,a( k+1 ), m+1, b, &
                                    ldb )
                          call stdlib_I64_zgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp64 ), m+1,b, ldb, alpha, &
                                    b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, k, n, cone,a( k ), m+1, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, k, n, alpha,a( k ), m+1, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp64 ), m+1,b( k, 0_ilp64 ), ldb,&
                                     alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, k, n, cone,a( k+1 ), m+1, b, &
                                    ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='l', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, k, n, alpha,a( k ), k, b, ldb )
                                    
                          call stdlib_I64_zgemm( 'C', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b, ldb, &
                                    alpha,b( k, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, k, n, cone,a( 0_ilp64 ), k, b( k, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, k, n, alpha,a( 0_ilp64 ), k, b( k, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_zgemm( 'N', 'N', k, n, k, -cone,a( k*( k+1 ) ), k, b( k, 0_ilp64 )&
                                    , ldb,alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, k, n, cone,a( k ), k, b, ldb )
                       ...
                       if( .not.notrans ) then
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'L', 'U', 'C', diag, k, n, alpha,a( k*( k+1 ) ), k, &
                                    b, ldb )
                          call stdlib_I64_zgemm( 'N', 'N', k, n, k, -cone, a( 0_ilp64 ), k, b,ldb, alpha, b(&
                                     k, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'L', 'L', 'N', diag, k, n, cone,a( k*k ), k, b( k, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='l', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'L', 'L', 'C', diag, k, n, alpha,a( k*k ), k, b( k, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'C', 'N', k, n, k, -cone, a( 0_ilp64 ), k,b( k, 0_ilp64 ), ldb, &
                                    alpha, b, ldb )
                          call stdlib_I64_ztrsm( 'L', 'U', 'N', diag, k, n, cone,a( k*( k+1 ) ), k, b,&
                                     ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, n1, cone,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( 0_ilp64 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( n1 ), &
                                    n, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n ), n, b( 0_ilp64, n1 &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, n1, alpha,a( n2 ), n, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n,&
                                     alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, n2, cone,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'n', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, n2, alpha,a( n1 ), n, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n, alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, n1, cone,a( n2 ), n, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( n1*n1 &
                                    ), n1, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, n1, cone,a( 0_ilp64 ), n1, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'l', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( 0_ilp64 ), n1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( n1*n1 )&
                                    , n1, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, n2, cone,a( 1_ilp64 ), n1, b( 0_ilp64, &
                                    n1 ), ldb )
                       end if
                    else
                       ! side  ='r', n is odd, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, n1, alpha,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, n2, n1, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, n1 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, n2, cone,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                       else
                          ! side  ='r', n is odd, transr = 'c', uplo = 'u', and
                          ! trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, n2, alpha,a( n1*n2 ), n2, b( &
                                    0_ilp64, n1 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, n1, n2, -cone, b( 0_ilp64, n1 ),ldb, a( 0_ilp64 ), &
                                    n2, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, n1, cone,a( n2*n2 ), n2, b( &
                                    0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
                 ...
                 if( normaltransr ) then
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, k, alpha,a( 0_ilp64 ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, k, cone,a( 1_ilp64 ), n+1, b( 0_ilp64, 0_ilp64 &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, k, alpha,a( 1_ilp64 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( k+1 ), n+&
                                    1_ilp64, alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, k, cone,a( 0_ilp64 ), n+1, b( 0_ilp64, k &
                                    ), ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'n', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, k, alpha,a( k+1 ), n+1, b( 0_ilp64,&
                                     0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), n+1,&
                                     alpha, b( 0_ilp64, k ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, k, cone,a( k ), n+1, b( 0_ilp64, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'n', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, k, alpha,a( k ), n+1, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), n+1,&
                                     alpha, b( 0_ilp64, 0_ilp64 ),ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, k, cone,a( k+1 ), n+1, b( 0_ilp64, &
                                    0_ilp64 ), ldb )
                       end if
                    end if
                 else
                    ...
                    if( lower ) then
                       ...
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, k, alpha,a( 0_ilp64 ), k, b( 0_ilp64, k )&
                                    , ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, k, cone,a( k ), k, b( 0_ilp64, 0_ilp64 ),&
                                     ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'l',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, k, alpha,a( k ), k, b( 0_ilp64, 0_ilp64 )&
                                    , ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( ( k+1 )&
                                    *k ), k, alpha,b( 0_ilp64, k ), ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, k, cone,a( 0_ilp64 ), k, b( 0_ilp64, k ),&
                                     ldb )
                       end if
                    else
                       ! side  ='r', n is even, transr = 'c', and uplo = 'u'
                       if( notrans ) then
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'n'
                          call stdlib_I64_ztrsm( 'R', 'U', 'N', diag, m, k, alpha,a( ( k+1 )*k ), k, &
                                    b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_zgemm( 'N', 'C', m, k, k, -cone, b( 0_ilp64, 0_ilp64 ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, k ), ldb )
                          call stdlib_I64_ztrsm( 'R', 'L', 'C', diag, m, k, cone,a( k*k ), k, b( 0_ilp64, k &
                                    ), ldb )
                       else
                          ! side  ='r', n is even, transr = 'c', uplo = 'u',
                          ! and trans = 'c'
                          call stdlib_I64_ztrsm( 'R', 'L', 'N', diag, m, k, alpha,a( k*k ), k, b( 0_ilp64, &
                                    k ), ldb )
                          call stdlib_I64_zgemm( 'N', 'N', m, k, k, -cone, b( 0_ilp64, k ),ldb, a( 0_ilp64 ), k, &
                                    alpha, b( 0_ilp64, 0_ilp64 ), ldb )
                          call stdlib_I64_ztrsm( 'R', 'U', 'C', diag, m, k, cone,a( ( k+1 )*k ), k, b(&
                                     0_ilp64, 0_ilp64 ), ldb )
                       end if
                    end if
                 end if
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'SSFRK ', -info )
              return
           end if
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_I64_ssyrk for example) and left in the general case.
           if( ( n==0_ilp64 ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp64 ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_ssyrk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_ssyrk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_sgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_I64_ssyrk( 'L', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_ssyrk( 'U', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_sgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_ssyrk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_ssyrk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp64 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_sgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( n2, 1_ilp64 ), &
                                 lda, beta, c( 1_ilp64 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_I64_ssyrk( 'L', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_ssyrk( 'U', 'T', n2, k, alpha, a( 1_ilp64, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_sgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n2 ), &
                                 lda, beta, c( 1_ilp64 ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_I64_ssyrk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_ssyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_sgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( n1+1, 1_ilp64 ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_I64_ssyrk( 'U', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_ssyrk( 'L', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_sgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n1+1 ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 't', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_I64_ssyrk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_ssyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_sgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), n2 )
                    else
                       ! n is odd, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_I64_ssyrk( 'U', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_ssyrk( 'L', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_sgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_ssyrk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_ssyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_sgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_I64_ssyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_ssyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_sgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_ssyrk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_ssyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_sgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_I64_ssyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_ssyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_sgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 ),&
                                  lda, beta, c( 1_ilp64 ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_I64_ssyrk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_ssyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_sgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_I64_ssyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_ssyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_sgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_I64_ssyrk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_ssyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_sgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_I64_ssyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_ssyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_sgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), nk )
                    end if
     ...
     !! matrix in the second case.
        ...
        ! =====================================================================
           ...
           if( info/=0_ilp64 ) then
              call stdlib_I64_xerbla( 'DSFRK ', -info )
              return
           end if
           ! quick return if possible.
           ! the quick return case: ((alpha==0).and.(beta/=zero)) is not
           ! done (it is in stdlib_I64_dsyrk for example) and left in the general case.
           if( ( n==0_ilp64 ) .or. ( ( ( alpha==zero ) .or. ( k==0_ilp64 ) ) .and.( beta==one ) ) )&
                     return
           if( ( alpha==zero ) .and. ( beta==zero ) ) then
              do j = 1, ( ( n*( n+1 ) ) / 2 )
           ...
           if( nisodd ) then
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_dsyrk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_dsyrk( 'U', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_dgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( n1+1 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_I64_dsyrk( 'L', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n )
                                 
                       call stdlib_I64_dsyrk( 'U', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( n+1 )&
                                 , n )
                       call stdlib_I64_dgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( n1+1 ), n )
                    end if
                 else
                    ! n is odd, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_dsyrk( 'L', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_dsyrk( 'U', 'N', n2, k, alpha, a( n2, 1_ilp64 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_dgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( n2, 1_ilp64 ), &
                                 lda, beta, c( 1_ilp64 ), n )
                    else
                       ! n is odd, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_I64_dsyrk( 'L', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2+1 ), &
                                 n )
                       call stdlib_I64_dsyrk( 'U', 'T', n2, k, alpha, a( 1_ilp64, n2 ), lda,beta, c( n1+1 ),&
                                  n )
                       call stdlib_I64_dgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n2 ), &
                                 lda, beta, c( 1_ilp64 ), n )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_I64_dsyrk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_dsyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_dgemm( 'N', 'T', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( n1+1, 1_ilp64 ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    else
                       ! n is odd, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_I64_dsyrk( 'U', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 1_ilp64 ), n1 &
                                 )
                       call stdlib_I64_dsyrk( 'L', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( 2_ilp64 ), &
                                 n1 )
                       call stdlib_I64_dgemm( 'T', 'N', n1, n2, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, n1+1 ),&
                                  lda, beta,c( n1*n1+1 ), n1 )
                    end if
                 else
                    ! n is odd, transr = 't', and uplo = 'u'
                    if( notrans ) then
                       ! n is odd, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_I64_dsyrk( 'U', 'N', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_dsyrk( 'L', 'N', n2, k, alpha, a( n1+1, 1_ilp64 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_dgemm( 'N', 'T', n2, n1, k, alpha, a( n1+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), n2 )
                    else
                       ! n is odd, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_I64_dsyrk( 'U', 'T', n1, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( n2*n2+1 &
                                 ), n2 )
                       call stdlib_I64_dsyrk( 'L', 'T', n2, k, alpha, a( 1_ilp64, n1+1 ), lda,beta, c( &
                                 n1*n2+1 ), n2 )
                       call stdlib_I64_dgemm( 'T', 'N', n2, n1, k, alpha, a( 1_ilp64, n1+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), n2 )
                    end if
              ...
              if( normaltransr ) then
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'l', and trans = 'n'
                       call stdlib_I64_dsyrk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_dsyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_dgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'l', and trans = 't'
                       call stdlib_I64_dsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( 2_ilp64 ), n+&
                                 1_ilp64 )
                       call stdlib_I64_dsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 n+1 )
                       call stdlib_I64_dgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( nk+2 ),n+1 )
                    end if
                 else
                    ! n is even, transr = 'n', and uplo = 'u'
                    if( notrans ) then
                       ! n is even, transr = 'n', uplo = 'u', and trans = 'n'
                       call stdlib_I64_dsyrk( 'L', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_dsyrk( 'U', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_dgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ),n+1 )
                    else
                       ! n is even, transr = 'n', uplo = 'u', and trans = 't'
                       call stdlib_I64_dsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+2 ), &
                                 n+1 )
                       call stdlib_I64_dsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( nk+1 &
                                 ), n+1 )
                       call stdlib_I64_dgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 ),&
                                  lda, beta, c( 1_ilp64 ),n+1 )
                    end if
                 end if
              else
                 ...
                 if( lower ) then
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'l', and trans = 'n'
                       call stdlib_I64_dsyrk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_dsyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_dgemm( 'N', 'T', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( nk+1, 1_ilp64 ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'l', and trans = 't'
                       call stdlib_I64_dsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk+1 ), &
                                 nk )
                       call stdlib_I64_dsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( 1_ilp64 ), &
                                 nk )
                       call stdlib_I64_dgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, 1_ilp64 ),lda, a( 1_ilp64, nk+1 ),&
                                  lda, beta,c( ( ( nk+1 )*nk )+1_ilp64 ), nk )
                    end if
                    ...
                    if( notrans ) then
                       ! n is even, transr = 't', uplo = 'u', and trans = 'n'
                       call stdlib_I64_dsyrk( 'U', 'N', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_dsyrk( 'L', 'N', nk, k, alpha, a( nk+1, 1_ilp64 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_dgemm( 'N', 'T', nk, nk, k, alpha, a( nk+1, 1_ilp64 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), nk )
                    else
                       ! n is even, transr = 't', uplo = 'u', and trans = 't'
                       call stdlib_I64_dsyrk( 'U', 'T', nk, k, alpha, a( 1_ilp64, 1_ilp64 ), lda,beta, c( nk*( nk+&
                                 1_ilp64 )+1_ilp64 ), nk )
                       call stdlib_I64_dsyrk( 'L', 'T', nk, k, alpha, a( 1_ilp64, nk+1 ), lda,beta, c( &
                                 nk*nk+1 ), nk )
                       call stdlib_I64_dgemm( 'T', 'N', nk, nk, k, alpha, a( 1_ilp64, nk+1 ),lda, a( 1_ilp64, 1_ilp64 ),&
                                  lda, beta, c( 1_ilp64 ), nk )
                    end if

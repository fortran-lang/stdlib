  ...
  contains
     ...
     ldx11, x12,ldx12, x21, ldx21, x22, ldx22, theta,u1, ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, &
        ...
        ! ===================================================================
           ...
           if( info == 0_ilp64 .and. min( p, m-p ) < min( q, m-q ) ) then
              ...
              call stdlib_I64_sorcsd( jobv1t, jobv2t, jobu1, jobu2, transt, signst, m,q, p, x11, &
              ldx11, x21, ldx21, x12, ldx12, x22,ldx22, theta, v1t, ldv1t, v2t, ldv2t, u1, ldu1,&
                        u2, ldu2, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp64 .and. m-q < q ) then
              ...
              call stdlib_I64_sorcsd( jobu2, jobu1, jobv2t, jobv1t, trans, signst, m,m-p, m-q, x22, &
              ldx22, x21, ldx21, x12, ldx12, x11,ldx11, theta, u2, ldu2, u1, ldu1, v2t, ldv2t, &
                        v1t,ldv1t, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp64 ) then
              iphi = 2_ilp64
              itaup1 = iphi + max( 1_ilp64, q - 1_ilp64 )
              itaup2 = itaup1 + max( 1_ilp64, p )
              itauq1 = itaup2 + max( 1_ilp64, m - p )
              itauq2 = itauq1 + max( 1_ilp64, q )
              iorgqr = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_sorgqr( m-q, m-q, m-q, dummy, max(1_ilp64,m-q), dummy, work, -1_ilp64,childinfo )
                        
              lorgqrworkopt = int( work(1_ilp64),KIND=ilp64)
              lorgqrworkmin = max( 1_ilp64, m - q )
              iorglq = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_sorglq( m-q, m-q, m-q, dummy, max(1_ilp64,m-q), dummy, work, -1_ilp64,childinfo )
                        
              lorglqworkopt = int( work(1_ilp64),KIND=ilp64)
              lorglqworkmin = max( 1_ilp64, m - q )
              iorbdb = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_sorbdb( trans, signs, m, p, q, x11, ldx11, x12, ldx12,x21, ldx21, x22, &
                        ldx22, dummy, dummy, dummy, dummy, dummy,dummy,work,-1_ilp64,childinfo )
              lorbdbworkopt = int( work(1_ilp64),KIND=ilp64)
              lorbdbworkmin = lorbdbworkopt
              ib11d = itauq2 + max( 1_ilp64, m - q )
              ...
              call stdlib_I64_sbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q,dummy, dummy, u1, &
              ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, dummy, dummy, dummy, dummy, dummy, dummy,&
                        dummy, dummy, work, -1_ilp64, childinfo )
              lbbcsdworkopt = int( work(1_ilp64),KIND=ilp64)
              lbbcsdworkmin = lbbcsdworkopt
              lworkopt = max( iorgqr + lorgqrworkopt, iorglq + lorglqworkopt,iorbdb + &
                        lorbdbworkopt, ibbcsd + lbbcsdworkopt ) - 1_ilp64
              lworkmin = max( iorgqr + lorgqrworkmin, iorglq + lorglqworkmin,iorbdb + &
                        lorbdbworkopt, ibbcsd + lbbcsdworkmin ) - 1_ilp64
              ...
              if( lwork < lworkmin .and. .not. lquery ) then
                 ...
                 lbbcsdwork = lwork - ibbcsd + 1_ilp64
              end if
           end if
           ! abort if any illegal arguments
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORCSD', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           if( colmajor ) then
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_sorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqrwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_sorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqrwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', q-1, q-1, x11(1_ilp64,2_ilp64), ldx11, v1t(2_ilp64,2_ilp64),ldv1t )
                 v1t(1_ilp64, 1_ilp64) = one
                 do j = 2, q
                    v1t(1_ilp64,j) = zero
                    v1t(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_sorglq( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorglq), &
                           lorglqwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', p, m-q, x12, ldx12, v2t, ldv2t )
                 call stdlib_I64_slacpy( 'U', m-p-q, m-p-q, x22(q+1,p+1), ldx22,v2t(p+1,p+1), ldv2t )
                           
                 call stdlib_I64_sorglq( m-q, m-q, m-q, v2t, ldv2t, work(itauq2),work(iorglq), &
                           lorglqwork, info )
              end if
           else
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', q, p, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_sorglq( p, p, q, u1, ldu1, work(itaup1), work(iorglq),lorglqwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', q, m-p, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_sorglq( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorglq), lorglqwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', q-1, q-1, x11(2_ilp64,1_ilp64), ldx11, v1t(2_ilp64,2_ilp64),ldv1t )
                 v1t(1_ilp64, 1_ilp64) = one
                 do j = 2, q
                    v1t(1_ilp64,j) = zero
                    v1t(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_sorgqr( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorgqr), &
                           lorgqrwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', m-q, p, x12, ldx12, v2t, ldv2t )
                 call stdlib_I64_slacpy( 'L', m-p-q, m-p-q, x22(p+1,q+1), ldx22,v2t(p+1,p+1), ldv2t )
                           
                 call stdlib_I64_sorgqr( m-q, m-q, m-q, v2t, ldv2t, work(itauq2),work(iorgqr), &
                           lorgqrwork, info )
              end if
           end if
           ! compute the csd of the matrix in bidiagonal-block form
           call stdlib_I64_sbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, theta,work(iphi), u1,&
            ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, work(ib11d), work(ib11e), work(ib12d),work(&
            ib12e), work(ib21d), work(ib21e), work(ib22d),work(ib22e), work(ibbcsd), lbbcsdwork, &
                      info )
           ! permute rows and columns to place identity submatrices in top-
           ...
           if( q > 0_ilp64 .and. wantu2 ) then
              ...
              if( colmajor ) then
                 call stdlib_I64_slapmt( .false., m-p, m-p, u2, ldu2, iwork )
              else
                 call stdlib_I64_slapmr( .false., m-p, m-p, u2, ldu2, iwork )
              end if
           end if
           if( m > 0_ilp64 .and. wantv2t ) then
              ...
              if( .not. colmajor ) then
                 call stdlib_I64_slapmt( .false., m-q, m-q, v2t, ldv2t, iwork )
              else
                 call stdlib_I64_slapmr( .false., m-q, m-q, v2t, ldv2t, iwork )
              end if
           end if
           return
           ! end stdlib_I64_sorcsd
     ...
     ldx11, x12,ldx12, x21, ldx21, x22, ldx22, theta,u1, ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, &
        ...
        ! ===================================================================
           ...
           if( info == 0_ilp64 .and. min( p, m-p ) < min( q, m-q ) ) then
              ...
              call stdlib_I64_dorcsd( jobv1t, jobv2t, jobu1, jobu2, transt, signst, m,q, p, x11, &
              ldx11, x21, ldx21, x12, ldx12, x22,ldx22, theta, v1t, ldv1t, v2t, ldv2t, u1, ldu1,&
                        u2, ldu2, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp64 .and. m-q < q ) then
              ...
              call stdlib_I64_dorcsd( jobu2, jobu1, jobv2t, jobv1t, trans, signst, m,m-p, m-q, x22, &
              ldx22, x21, ldx21, x12, ldx12, x11,ldx11, theta, u2, ldu2, u1, ldu1, v2t, ldv2t, &
                        v1t,ldv1t, work, lwork, iwork, info )
              return
           end if
           ...
           if( info == 0_ilp64 ) then
              ...
              itauq2 = itauq1 + max( 1_ilp64, q )
              iorgqr = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_dorgqr( m-q, m-q, m-q, u1, max(1_ilp64,m-q), u1, work, -1_ilp64,childinfo )
              lorgqrworkopt = int( work(1_ilp64),KIND=ilp64)
              lorgqrworkmin = max( 1_ilp64, m - q )
              iorglq = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_dorglq( m-q, m-q, m-q, u1, max(1_ilp64,m-q), u1, work, -1_ilp64,childinfo )
              lorglqworkopt = int( work(1_ilp64),KIND=ilp64)
              lorglqworkmin = max( 1_ilp64, m - q )
              iorbdb = itauq2 + max( 1_ilp64, m - q )
              call stdlib_I64_dorbdb( trans, signs, m, p, q, x11, ldx11, x12, ldx12,x21, ldx21, x22, &
                        ldx22, theta, v1t, u1, u2, v1t,v2t, work, -1_ilp64, childinfo )
              lorbdbworkopt = int( work(1_ilp64),KIND=ilp64)
              lorbdbworkmin = lorbdbworkopt
              ib11d = itauq2 + max( 1_ilp64, m - q )
              ib11e = ib11d + max( 1_ilp64, q )
              ...
              ib22e = ib22d + max( 1_ilp64, q )
              ibbcsd = ib22e + max( 1_ilp64, q - 1_ilp64 )
              call stdlib_I64_dbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q,theta, theta, u1, &
              ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, u1, u1, u1, u1, u1, u1, u1, u1, work, -1_ilp64,&
                        childinfo )
              lbbcsdworkopt = int( work(1_ilp64),KIND=ilp64)
              lbbcsdworkmin = lbbcsdworkopt
              lworkopt = max( iorgqr + lorgqrworkopt, iorglq + lorglqworkopt,iorbdb + &
           ...
           ! abort if any illegal arguments
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORCSD', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           if( colmajor ) then
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_dorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqrwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_dorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqrwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', q-1, q-1, x11(1_ilp64,2_ilp64), ldx11, v1t(2_ilp64,2_ilp64),ldv1t )
                 v1t(1_ilp64, 1_ilp64) = one
                 do j = 2, q
                    v1t(1_ilp64,j) = zero
                    v1t(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_dorglq( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorglq), &
                           lorglqwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', p, m-q, x12, ldx12, v2t, ldv2t )
                 if (m-p > q) then
                    call stdlib_I64_dlacpy( 'U', m-p-q, m-p-q, x22(q+1,p+1), ldx22,v2t(p+1,p+1), &
                              ldv2t )
                 end if
                 if (m > q) then
                    call stdlib_I64_dorglq( m-q, m-q, m-q, v2t, ldv2t, work(itauq2),work(iorglq), &
                              lorglqwork, info )
                 end if
              end if
           else
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', q, p, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_dorglq( p, p, q, u1, ldu1, work(itaup1), work(iorglq),lorglqwork, &
                           info)
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', q, m-p, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_dorglq( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorglq), lorglqwork,&
                            info )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', q-1, q-1, x11(2_ilp64,1_ilp64), ldx11, v1t(2_ilp64,2_ilp64),ldv1t )
                 v1t(1_ilp64, 1_ilp64) = one
                 do j = 2, q
                    v1t(1_ilp64,j) = zero
                    v1t(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_dorgqr( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorgqr), &
                           lorgqrwork, info )
              end if
              if( wantv2t .and. m-q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', m-q, p, x12, ldx12, v2t, ldv2t )
                 call stdlib_I64_dlacpy( 'L', m-p-q, m-p-q, x22(p+1,q+1), ldx22,v2t(p+1,p+1), ldv2t )
                           
                 call stdlib_I64_dorgqr( m-q, m-q, m-q, v2t, ldv2t, work(itauq2),work(iorgqr), &
                           lorgqrwork, info )
              end if
           end if
           ! compute the csd of the matrix in bidiagonal-block form
           call stdlib_I64_dbbcsd( jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, theta,work(iphi), u1,&
            ldu1, u2, ldu2, v1t, ldv1t, v2t,ldv2t, work(ib11d), work(ib11e), work(ib12d),work(&
            ib12e), work(ib21d), work(ib21e), work(ib22d),work(ib22e), work(ibbcsd), lbbcsdwork, &
                      info )
           ! permute rows and columns to place identity submatrices in top-
           ...
           if( q > 0_ilp64 .and. wantu2 ) then
              ...
              if( colmajor ) then
                 call stdlib_I64_dlapmt( .false., m-p, m-p, u2, ldu2, iwork )
              else
                 call stdlib_I64_dlapmr( .false., m-p, m-p, u2, ldu2, iwork )
              end if
           end if
           if( m > 0_ilp64 .and. wantv2t ) then
              do i = 1, p
              ...
              if( .not. colmajor ) then
                 call stdlib_I64_dlapmt( .false., m-q, m-q, v2t, ldv2t, iwork )
              else
                 call stdlib_I64_dlapmr( .false., m-q, m-q, v2t, ldv2t, iwork )
              end if
           end if
           return
           ! end stdlib_I64_dorcsd
     ...
     !! K2-by-K2 identity matrix, where K1 = MAX(Q+P-M,0), K2 = MAX(Q-P,0).
        ...
        ! =====================================================================
           ...
           logical(lk) :: lquery, wantu1, wantu2, wantv1t
           ! Local Arrays 
           real(sp) :: dum1(1_ilp64), dum2(1_ilp64,1_ilp64)
           ! Intrinsic Function 
           ! Executable Statements 
           ! test input arguments
           info = 0_ilp64
           ...
           ! | tauq1 (max(1,q))                        | b12d (r)    |
           ! |-----------------------------------------| b12e (r-1)  |
           ! | stdlib_I64_sorbdb work | stdlib_I64_sorgqr work | stdlib_I64_sorglq work | b21d (r)    |
           ! |             |             |             | b21e (r-1)  |
           ! |             |             |             | b22d (r)    |
           ! |             |             |             | b22e (r-1)  |
           ! |             |             |             | stdlib_I64_sbbcsd work |
           ! |-------------------------------------------------------|
           if( info == 0_ilp64 ) then
              iphi = 2_ilp64
              ...
              lorglqopt = 1_ilp64
              if( r == q ) then
                 call stdlib_I64_sorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, work, -1_ilp64,childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 endif
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( m-p, m-p, q, u2, ldu2, dum1, work(1_ilp64), -1_ilp64,childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_sorglq( q-1, q-1, q-1, v1t, ldv1t,dum1, work(1_ilp64), -1_ilp64, childinfo )
                              
                    lorglqmin = max( lorglqmin, q-1 )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_sbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,dum1, u1, &
                 ldu1, u2, ldu2, v1t, ldv1t, dum2,1_ilp64, dum1, dum1, dum1, dum1, dum1,dum1, dum1, &
                           dum1, work(1_ilp64), -1_ilp64, childinfo)
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else if( r == p ) then
                 call stdlib_I64_sorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, work(1_ilp64), -1_ilp64,childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( p-1, p-1, p-1, u1(2_ilp64,2_ilp64), ldu1, dum1,work(1_ilp64), -1_ilp64, childinfo &
                              )
                    lorgqrmin = max( lorgqrmin, p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 ...
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_sorglq( q, q, r, v1t, ldv1t, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_sbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,dum1, v1t, &
                 ldv1t, dum2, 1_ilp64, u1, ldu1, u2,ldu2, dum1, dum1, dum1, dum1, dum1,dum1, dum1, dum1,&
                            work(1_ilp64), -1_ilp64, childinfo)
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else if( r == m-p ) then
                 call stdlib_I64_sorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, work(1_ilp64), -1_ilp64,childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                 ...
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp64,2_ilp64), ldu2, dum1,work(1_ilp64), -1_ilp64, &
                              childinfo )
                    lorgqrmin = max( lorgqrmin, m-p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 ...
                 call stdlib_I64_sbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, dum1, &
                 dum2, 1_ilp64, v1t, ldv1t, u2, ldu2,u1, ldu1, dum1, dum1, dum1, dum1,dum1, dum1, dum1, &
                           dum1, work(1_ilp64), -1_ilp64,childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else
                 call stdlib_I64_sorbdb4( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, dum1,work(1_ilp64), -1_ilp64, childinfo )
                 lorbdb = m + int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( p, p, m-q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_sorgqr( m-p, m-p, m-q, u2, ldu2, dum1, work(1_ilp64),-1_ilp64, childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_sorglq( q, q, q, v1t, ldv1t, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_sbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, dum1, u2, &
                 ldu2, u1, ldu1, dum2, 1_ilp64,v1t, ldv1t, dum1, dum1, dum1, dum1,dum1, dum1, dum1, &
                           dum1, work(1_ilp64), -1_ilp64,childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              end if
              lworkmin = max( iorbdb+lorbdb-1,iorgqr+lorgqrmin-1,iorglq+lorglqmin-1,ibbcsd+lbbcsd-&
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORCSD2BY1', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           if( r == q ) then
              ! case 1: r = q
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_sorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_sorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_sorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 v1t(1_ilp64,1_ilp64) = one
                 ...
                 call stdlib_I64_slacpy( 'U', q-1, q-1, x21(1_ilp64,2_ilp64), ldx21, v1t(2_ilp64,2_ilp64),ldv1t )
                 call stdlib_I64_sorglq( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorglq), &
                           lorglq, childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_sbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,work(iphi), u1, &
              ldu1, u2, ldu2, v1t, ldv1t,dum2, 1_ilp64, work(ib11d), work(ib11e), work(ib12d),work(&
              ib12e), work(ib21d), work(ib21e),work(ib22d), work(ib22e), work(ibbcsd), lbbcsd,&
                        childinfo )
              ! permute rows and columns to place zero submatrices in
              ! preferred positions
              ...
              ! case 2: r = p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_sorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 u1(1_ilp64,1_ilp64) = one
                 do j = 2, p
                    u1(1_ilp64,j) = zero
                    u1(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_slacpy( 'L', p-1, p-1, x11(2_ilp64,1_ilp64), ldx11, u1(2_ilp64,2_ilp64), ldu1 )
                 call stdlib_I64_sorgqr( p-1, p-1, p-1, u1(2_ilp64,2_ilp64), ldu1, work(itaup1),work(iorgqr), &
                           lorgqr, childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
              ...
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', p, q, x11, ldx11, v1t, ldv1t )
                 call stdlib_I64_sorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_sbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,work(iphi), v1t, &
              ldv1t, dum1, 1_ilp64, u1, ldu1, u2,ldu2, work(ib11d), work(ib11e), work(ib12d),work(ib12e)&
              , work(ib21d), work(ib21e),work(ib22d), work(ib22e), work(ibbcsd), lbbcsd,childinfo &
                        )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              ...
              ! case 3: r = m-p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_sorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
              ...
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 u2(1_ilp64,1_ilp64) = one
                 do j = 2, m-p
                    u2(1_ilp64,j) = zero
                    u2(j,1_ilp64) = zero
                 end do
                 call stdlib_I64_slacpy( 'L', m-p-1, m-p-1, x21(2_ilp64,1_ilp64), ldx21, u2(2_ilp64,2_ilp64),ldu2 )
                 call stdlib_I64_sorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp64,2_ilp64), ldu2,work(itaup2), work(iorgqr)&
                           , lorgqr, childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', m-p, q, x21, ldx21, v1t, ldv1t )
                 call stdlib_I64_sorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_sbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, work(iphi), &
              dum1, 1_ilp64, v1t, ldv1t, u2,ldu2, u1, ldu1, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              if( q > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_I64_slapmt( .false., p, q, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_I64_slapmr( .false., q, q, v1t, ldv1t, iwork )
                 end if
              end if
           else
              ! case 4: r = m-q
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_sorbdb4( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
              , work(itaup2),work(itauq1), work(iorbdb), work(iorbdb+m),lorbdb-m, childinfo )
                        
              ! accumulate householder reflectors
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_scopy( m-p, work(iorbdb+p), 1_ilp64, u2, 1_ilp64 )
              end if
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_scopy( p, work(iorbdb), 1_ilp64, u1, 1_ilp64 )
                 do j = 2, p
                    u1(1_ilp64,j) = zero
                 end do
                 call stdlib_I64_slacpy( 'L', p-1, m-q-1, x11(2_ilp64,1_ilp64), ldx11, u1(2_ilp64,2_ilp64),ldu1 )
                 call stdlib_I64_sorgqr( p, p, m-q, u1, ldu1, work(itaup1),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 do j = 2, m-p
                 ...
                 call stdlib_I64_slacpy( 'L', m-p-1, m-q-1, x21(2_ilp64,1_ilp64), ldx21, u2(2_ilp64,2_ilp64),ldu2 )
                 call stdlib_I64_sorgqr( m-p, m-p, m-q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_slacpy( 'U', m-q, q, x21, ldx21, v1t, ldv1t )
                 call stdlib_I64_slacpy( 'U', p-(m-q), q-(m-q), x11(m-q+1,m-q+1), ldx11,v1t(m-q+1,m-q+&
                           1_ilp64), ldv1t )
                 call stdlib_I64_slacpy( 'U', -p+q, q-p, x21(m-q+1,p+1), ldx21,v1t(p+1,p+1), ldv1t )
                           
                 call stdlib_I64_sorglq( q, q, q, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_sbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, work(iphi), &
              u2, ldu2, u1, ldu1, dum1, 1_ilp64,v1t, ldv1t, work(ib11d), work(ib11e), work(ib12d),work(&
              ib12e), work(ib21d), work(ib21e),work(ib22d), work(ib22e), work(ibbcsd), lbbcsd,&
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              if( p > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_I64_slapmt( .false., p, p, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_I64_slapmr( .false., p, q, v1t, ldv1t, iwork )
                 end if
              end if
           end if
           return
     ...
     !! K2-by-K2 identity matrix, where K1 = MAX(Q+P-M,0), K2 = MAX(Q-P,0).
        ...
        ! =====================================================================
           ...
           logical(lk) :: lquery, wantu1, wantu2, wantv1t
           ! Local Arrays 
           real(dp) :: dum1(1_ilp64), dum2(1_ilp64,1_ilp64)
           ! Intrinsic Function 
           ! Executable Statements 
           ! test input arguments
           info = 0_ilp64
           ...
           ! | tauq1 (max(1,q))                        | b12d (r)    |
           ! |-----------------------------------------| b12e (r-1)  |
           ! | stdlib_I64_dorbdb work | stdlib_I64_dorgqr work | stdlib_I64_dorglq work | b21d (r)    |
           ! |             |             |             | b21e (r-1)  |
           ! |             |             |             | b22d (r)    |
           ! |             |             |             | b22e (r-1)  |
           ! |             |             |             | stdlib_I64_dbbcsd work |
           ! |-------------------------------------------------------|
           if( info == 0_ilp64 ) then
              iphi = 2_ilp64
              ib11d = iphi + max( 1_ilp64, r-1 )
              ...
              lorglqopt = 1_ilp64
              if( r == q ) then
                 call stdlib_I64_dorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1, work,-1_ilp64, childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 endif
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( m-p, m-p, q, u2, ldu2, dum1, work(1_ilp64),-1_ilp64, childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_dorglq( q-1, q-1, q-1, v1t, ldv1t,dum1, work(1_ilp64), -1_ilp64, childinfo )
                              
                    lorglqmin = max( lorglqmin, q-1 )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_dbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,dum1, u1, &
                 ldu1, u2, ldu2, v1t, ldv1t,dum2, 1_ilp64, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1,&
                            work(1_ilp64), -1_ilp64, childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else if( r == p ) then
                 call stdlib_I64_dorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,work(1_ilp64), -1_ilp64, childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( p-1, p-1, p-1, u1(2_ilp64,2_ilp64), ldu1, dum1,work(1_ilp64), -1_ilp64, childinfo &
                              )
                    lorgqrmin = max( lorgqrmin, p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 ...
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_dorglq( q, q, r, v1t, ldv1t, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_dbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,dum1, v1t, &
                 ldv1t, dum2, 1_ilp64, u1, ldu1,u2, ldu2, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1, &
                           work(1_ilp64), -1_ilp64, childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else if( r == m-p ) then
                 call stdlib_I64_dorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,work(1_ilp64), -1_ilp64, childinfo )
                 lorbdb = int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( p, p, q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                 ...
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp64,2_ilp64), ldu2,dum1, work(1_ilp64), -1_ilp64, &
                              childinfo )
                    lorgqrmin = max( lorgqrmin, m-p-1 )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 ...
                 call stdlib_I64_dbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, dum1, &
                 dum2, 1_ilp64, v1t, ldv1t, u2,ldu2, u1, ldu1, dum1, dum1, dum1,dum1, dum1, dum1, dum1,&
                           dum1, work(1_ilp64), -1_ilp64, childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              else
                 call stdlib_I64_dorbdb4( m, p, q, x11, ldx11, x21, ldx21, theta,dum1, dum1, dum1, &
                           dum1,dum1, work(1_ilp64), -1_ilp64, childinfo )
                 lorbdb = m + int( work(1_ilp64),KIND=ilp64)
                 if( wantu1 .and. p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( p, p, m-q, u1, ldu1, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorgqrmin = max( lorgqrmin, p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantu2 .and. m-p > 0_ilp64 ) then
                    call stdlib_I64_dorgqr( m-p, m-p, m-q, u2, ldu2, dum1, work(1_ilp64),-1_ilp64, childinfo )
                              
                    lorgqrmin = max( lorgqrmin, m-p )
                    lorgqropt = max( lorgqropt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 if( wantv1t .and. q > 0_ilp64 ) then
                    call stdlib_I64_dorglq( q, q, q, v1t, ldv1t, dum1, work(1_ilp64), -1_ilp64,childinfo )
                    lorglqmin = max( lorglqmin, q )
                    lorglqopt = max( lorglqopt, int( work(1_ilp64),KIND=ilp64) )
                 end if
                 call stdlib_I64_dbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, dum1, u2, &
                 ldu2, u1, ldu1, dum2,1_ilp64, v1t, ldv1t, dum1, dum1, dum1,dum1, dum1, dum1, dum1,dum1,&
                            work(1_ilp64), -1_ilp64, childinfo )
                 lbbcsd = int( work(1_ilp64),KIND=ilp64)
              end if
              lworkmin = max( iorbdb+lorbdb-1,iorgqr+lorgqrmin-1,iorglq+lorglqmin-1,ibbcsd+lbbcsd-&
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORCSD2BY1', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           if( r == q ) then
              ! case 1: r = q
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_dorbdb1( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
                 call stdlib_I64_dorgqr( p, p, q, u1, ldu1, work(itaup1), work(iorgqr),lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
                 call stdlib_I64_dorgqr( m-p, m-p, q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 v1t(1_ilp64,1_ilp64) = one
                 ...
                 call stdlib_I64_dlacpy( 'U', q-1, q-1, x21(1_ilp64,2_ilp64), ldx21, v1t(2_ilp64,2_ilp64),ldv1t )
                 call stdlib_I64_dorglq( q-1, q-1, q-1, v1t(2_ilp64,2_ilp64), ldv1t, work(itauq1),work(iorglq), &
                           lorglq, childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_dbbcsd( jobu1, jobu2, jobv1t, 'N', 'N', m, p, q, theta,work(iphi), u1, &
              ldu1, u2, ldu2, v1t, ldv1t,dum2, 1_ilp64, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place zero submatrices in
              ...
              ! case 2: r = p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_dorbdb2( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 u1(1_ilp64,1_ilp64) = one
                 ...
                 call stdlib_I64_dlacpy( 'L', p-1, p-1, x11(2_ilp64,1_ilp64), ldx11, u1(2_ilp64,2_ilp64), ldu1 )
                 call stdlib_I64_dorgqr( p-1, p-1, p-1, u1(2_ilp64,2_ilp64), ldu1, work(itaup1),work(iorgqr), &
                           lorgqr, childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', m-p, q, x21, ldx21, u2, ldu2 )
              ...
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', p, q, x11, ldx11, v1t, ldv1t )
                 call stdlib_I64_dorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_dbbcsd( jobv1t, 'N', jobu1, jobu2, 'T', m, q, p, theta,work(iphi), v1t, &
              ldv1t, dum2, 1_ilp64, u1, ldu1, u2,ldu2, work(ib11d), work(ib11e), work(ib12d),work(ib12e)&
              , work(ib21d), work(ib21e),work(ib22d), work(ib22e), work(ibbcsd), lbbcsd,childinfo &
                        )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              ...
              ! case 3: r = m-p
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_dorbdb3( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
                        , work(itaup2),work(itauq1), work(iorbdb), lorbdb, childinfo )
              ! accumulate householder reflectors
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'L', p, q, x11, ldx11, u1, ldu1 )
              ...
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 ...
                 call stdlib_I64_dlacpy( 'L', m-p-1, m-p-1, x21(2_ilp64,1_ilp64), ldx21, u2(2_ilp64,2_ilp64),ldu2 )
                 call stdlib_I64_dorgqr( m-p-1, m-p-1, m-p-1, u2(2_ilp64,2_ilp64), ldu2,work(itaup2), work(iorgqr)&
                           , lorgqr, childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', m-p, q, x21, ldx21, v1t, ldv1t )
                 call stdlib_I64_dorglq( q, q, r, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_dbbcsd( 'N', jobv1t, jobu2, jobu1, 'T', m, m-q, m-p,theta, work(iphi), &
              dum2, 1_ilp64, v1t, ldv1t, u2,ldu2, u1, ldu1, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              if( q > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_I64_dlapmt( .false., p, q, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_I64_dlapmr( .false., q, q, v1t, ldv1t, iwork )
                 end if
              end if
           else
              ! case 4: r = m-q
              ! simultaneously bidiagonalize x11 and x21
              call stdlib_I64_dorbdb4( m, p, q, x11, ldx11, x21, ldx21, theta,work(iphi), work(itaup1)&
              , work(itaup2),work(itauq1), work(iorbdb), work(iorbdb+m),lorbdb-m, childinfo )
                        
              ! accumulate householder reflectors
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 call stdlib_I64_dcopy( m-p, work(iorbdb+p), 1_ilp64, u2, 1_ilp64 )
              end if
              if( wantu1 .and. p > 0_ilp64 ) then
                 call stdlib_I64_dcopy( p, work(iorbdb), 1_ilp64, u1, 1_ilp64 )
                 do j = 2, p
                    u1(1_ilp64,j) = zero
                 end do
                 call stdlib_I64_dlacpy( 'L', p-1, m-q-1, x11(2_ilp64,1_ilp64), ldx11, u1(2_ilp64,2_ilp64),ldu1 )
                 call stdlib_I64_dorgqr( p, p, m-q, u1, ldu1, work(itaup1),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantu2 .and. m-p > 0_ilp64 ) then
                 do j = 2, m-p
                 ...
                 call stdlib_I64_dlacpy( 'L', m-p-1, m-q-1, x21(2_ilp64,1_ilp64), ldx21, u2(2_ilp64,2_ilp64),ldu2 )
                 call stdlib_I64_dorgqr( m-p, m-p, m-q, u2, ldu2, work(itaup2),work(iorgqr), lorgqr, &
                           childinfo )
              end if
              if( wantv1t .and. q > 0_ilp64 ) then
                 call stdlib_I64_dlacpy( 'U', m-q, q, x21, ldx21, v1t, ldv1t )
                 call stdlib_I64_dlacpy( 'U', p-(m-q), q-(m-q), x11(m-q+1,m-q+1), ldx11,v1t(m-q+1,m-q+&
                           1_ilp64), ldv1t )
                 call stdlib_I64_dlacpy( 'U', -p+q, q-p, x21(m-q+1,p+1), ldx21,v1t(p+1,p+1), ldv1t )
                           
                 call stdlib_I64_dorglq( q, q, q, v1t, ldv1t, work(itauq1),work(iorglq), lorglq, &
                           childinfo )
              end if
              ! simultaneously diagonalize x11 and x21.
              call stdlib_I64_dbbcsd( jobu2, jobu1, 'N', jobv1t, 'N', m, m-p, m-q,theta, work(iphi), &
              u2, ldu2, u1, ldu1, dum2,1_ilp64, v1t, ldv1t, work(ib11d), work(ib11e),work(ib12d), work(&
              ib12e), work(ib21d),work(ib21e), work(ib22d), work(ib22e),work(ibbcsd), lbbcsd, &
                        childinfo )
              ! permute rows and columns to place identity submatrices in
              ! preferred positions
              if( p > r ) then
                 ...
                 if( wantu1 ) then
                    call stdlib_I64_dlapmt( .false., p, p, u1, ldu1, iwork )
                 end if
                 if( wantv1t ) then
                    call stdlib_I64_dlapmr( .false., p, q, v1t, ldv1t, iwork )
                 end if
              end if
           end if
           return
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( colmajor ) then
              ...
              do i = 1, q
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_sscal( p-i+1, z1, x11(i,i), 1_ilp64 )
                 else
                    call stdlib_I64_sscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), 1_ilp64 )
                    call stdlib_I64_saxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i,i-1),1_ilp64, x11(i,i), 1_ilp64 )
                              
                 end if
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_sscal( m-p-i+1, z2, x21(i,i), 1_ilp64 )
                 else
                    call stdlib_I64_sscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), 1_ilp64 )
                    call stdlib_I64_saxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i,i-1),1_ilp64, x21(i,i), &
                              1_ilp64 )
                 end if
                 theta(i) = atan2( stdlib_I64_snrm2( m-p-i+1, x21(i,i), 1_ilp64 ),stdlib_I64_snrm2( p-i+1, x11(&
                           i,i), 1_ilp64 ) )
                 if( p > i ) then
                    call stdlib_I64_slarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp64, taup1(i) )
                 else if( p == i ) then
                    call stdlib_I64_slarfgp( p-i+1, x11(i,i), x11(i,i), 1_ilp64, taup1(i) )
                 end if
                 x11(i,i) = one
                 if ( m-p > i ) then
                    call stdlib_I64_slarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp64,taup2(i) )
                 else if ( m-p == i ) then
                    call stdlib_I64_slarfgp( m-p-i+1, x21(i,i), x21(i,i), 1_ilp64, taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_I64_slarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i),x11(i,i+1), ldx11, &
                              work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_slarf( 'L', p-i+1, m-q-i+1, x11(i,i), 1_ilp64, taup1(i),x12(i,i), ldx12,&
                               work )
                 end if
                 if ( q > i ) then
                    call stdlib_I64_slarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21,&
                               work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_slarf( 'L', m-p-i+1, m-q-i+1, x21(i,i), 1_ilp64, taup2(i),x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_I64_sscal( q-i, -z1*z3*sin(theta(i)), x11(i,i+1),ldx11 )
                    call stdlib_I64_saxpy( q-i, z2*z3*cos(theta(i)), x21(i,i+1), ldx21,x11(i,i+1), &
                              ldx11 )
                 end if
                 call stdlib_I64_sscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), ldx12 )
                 call stdlib_I64_saxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), ldx22,x12(i,i), ldx12 &
                           )
                 if( i < q )phi(i) = atan2( stdlib_I64_snrm2( q-i, x11(i,i+1), ldx11 ),stdlib_I64_snrm2( &
                           m-q-i+1, x12(i,i), ldx12 ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp64 ) then
                       call stdlib_I64_slarfgp( q-i, x11(i,i+1), x11(i,i+1), ldx11,tauq1(i) )
                    else
                       call stdlib_I64_slarfgp( q-i, x11(i,i+1), x11(i,i+2), ldx11,tauq1(i) )
                    end if
                    x11(i,i+1) = one
                 end if
                 if ( q+i-1 < m ) then
                    if ( m-q == i ) then
                       call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i,i), ldx12,tauq2(i) )
                    else
                       call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i,i+1), ldx12,tauq2(i) )
                                 
                    end if
                 end if
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_I64_slarf( 'R', p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x11(i+1,i+1), &
                              ldx11, work )
                    call stdlib_I64_slarf( 'R', m-p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 if ( p > i ) then
                    call stdlib_I64_slarf( 'R', p-i, m-q-i+1, x12(i,i), ldx12, tauq2(i),x12(i+1,i), &
                              ldx12, work )
                 end if
                 if ( m-p > i ) then
                    call stdlib_I64_slarf( 'R', m-p-i, m-q-i+1, x12(i,i), ldx12,tauq2(i), x22(i+1,i), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_I64_sscal( m-q-i+1, -z1*z4, x12(i,i), ldx12 )
                 if ( i >= m-q ) then
                    call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i,i), ldx12,tauq2(i) )
                 else
                    call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i,i+1), ldx12,tauq2(i) )
                 ...
                 if( m-p-q >= 1_ilp64 )call stdlib_I64_slarf( 'R', m-p-q, m-q-i+1, x12(i,i), ldx12,tauq2(i),&
                            x22(q+1,i), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 call stdlib_I64_sscal( m-p-q-i+1, z2*z4, x22(q+i,p+i), ldx22 )
                 if ( i == m-p-q ) then
                    call stdlib_I64_slarfgp( m-p-q-i+1, x22(q+i,p+i), x22(q+i,p+i),ldx22, tauq2(p+i) )
                              
                 else
                    call stdlib_I64_slarfgp( m-p-q-i+1, x22(q+i,p+i), x22(q+i,p+i+1),ldx22, tauq2(p+i)&
                               )
                 end if
                 x22(q+i,p+i) = one
                 if ( i < m-p-q ) then
                    call stdlib_I64_slarf( 'R', m-p-q-i, m-p-q-i+1, x22(q+i,p+i), ldx22,tauq2(p+i), &
                              x22(q+i+1,p+i), ldx22, work )
                 end if
              end do
           else
              ...
              do i = 1, q
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_sscal( p-i+1, z1, x11(i,i), ldx11 )
                 else
                    call stdlib_I64_sscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), ldx11 )
                    call stdlib_I64_saxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i-1,i),ldx12, x11(i,i),&
                               ldx11 )
                 end if
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_sscal( m-p-i+1, z2, x21(i,i), ldx21 )
                 else
                    call stdlib_I64_sscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), ldx21 )
                    call stdlib_I64_saxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i-1,i),ldx22, x21(i,&
                              i), ldx21 )
                 end if
                 theta(i) = atan2( stdlib_I64_snrm2( m-p-i+1, x21(i,i), ldx21 ),stdlib_I64_snrm2( p-i+1, &
                           x11(i,i), ldx11 ) )
                 call stdlib_I64_slarfgp( p-i+1, x11(i,i), x11(i,i+1), ldx11, taup1(i) )
                 x11(i,i) = one
                 if ( i == m-p ) then
                    call stdlib_I64_slarfgp( m-p-i+1, x21(i,i), x21(i,i), ldx21,taup2(i) )
                 else
                    call stdlib_I64_slarfgp( m-p-i+1, x21(i,i), x21(i,i+1), ldx21,taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_I64_slarf( 'R', q-i, p-i+1, x11(i,i), ldx11, taup1(i),x11(i+1,i), &
                              ldx11, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_slarf( 'R', m-q-i+1, p-i+1, x11(i,i), ldx11,taup1(i), x12(i,i), &
                              ldx12, work )
                 end if
                 if ( q > i ) then
                    call stdlib_I64_slarf( 'R', q-i, m-p-i+1, x21(i,i), ldx21, taup2(i),x21(i+1,i), &
                              ldx21, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_slarf( 'R', m-q-i+1, m-p-i+1, x21(i,i), ldx21,taup2(i), x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_I64_sscal( q-i, -z1*z3*sin(theta(i)), x11(i+1,i), 1_ilp64 )
                    call stdlib_I64_saxpy( q-i, z2*z3*cos(theta(i)), x21(i+1,i), 1_ilp64,x11(i+1,i), 1_ilp64 )
                              
                 end if
                 call stdlib_I64_sscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), 1_ilp64 )
                 call stdlib_I64_saxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), 1_ilp64,x12(i,i), 1_ilp64 )
                           
                 if( i < q )phi(i) = atan2( stdlib_I64_snrm2( q-i, x11(i+1,i), 1_ilp64 ),stdlib_I64_snrm2( m-q-&
                           i+1, x12(i,i), 1_ilp64 ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp64) then
                       call stdlib_I64_slarfgp( q-i, x11(i+1,i), x11(i+1,i), 1_ilp64,tauq1(i) )
                    else
                       call stdlib_I64_slarfgp( q-i, x11(i+1,i), x11(i+2,i), 1_ilp64,tauq1(i) )
                    end if
                    x11(i+1,i) = one
                 end if
                 if ( m-q > i ) then
                    call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp64,tauq2(i) )
                 else
                    call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i,i), 1_ilp64,tauq2(i) )
                 end if
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_I64_slarf( 'L', q-i, p-i, x11(i+1,i), 1_ilp64, tauq1(i),x11(i+1,i+1), ldx11,&
                               work )
                    call stdlib_I64_slarf( 'L', q-i, m-p-i, x11(i+1,i), 1_ilp64, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 call stdlib_I64_slarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp64, tauq2(i),x12(i,i+1), ldx12, &
                           work )
                 if ( m-p-i > 0_ilp64 ) then
                    call stdlib_I64_slarf( 'L', m-q-i+1, m-p-i, x12(i,i), 1_ilp64, tauq2(i),x22(i,i+1), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_I64_sscal( m-q-i+1, -z1*z4, x12(i,i), 1_ilp64 )
                 call stdlib_I64_slarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp64, tauq2(i) )
                 x12(i,i) = one
                 if ( p > i ) then
                    call stdlib_I64_slarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp64, tauq2(i),x12(i,i+1), ldx12,&
                 ...
                 if( m-p-q >= 1_ilp64 )call stdlib_I64_slarf( 'L', m-q-i+1, m-p-q, x12(i,i), 1_ilp64, tauq2(i),&
                           x22(i,q+1), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 call stdlib_I64_sscal( m-p-q-i+1, z2*z4, x22(p+i,q+i), 1_ilp64 )
                 if ( m-p-q == i ) then
                    call stdlib_I64_slarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i,q+i), 1_ilp64,tauq2(p+i) )
                              
                    x22(p+i,q+i) = one
                 else
                    call stdlib_I64_slarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i+1,q+i), 1_ilp64,tauq2(p+i) )
                              
                    x22(p+i,q+i) = one
                    call stdlib_I64_slarf( 'L', m-p-q-i+1, m-p-q-i, x22(p+i,q+i), 1_ilp64,tauq2(p+i), x22(p+&
                              i,q+i+1), ldx22, work )
                 end if
              end do
           end if
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( colmajor ) then
              ...
              do i = 1, q
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_dscal( p-i+1, z1, x11(i,i), 1_ilp64 )
                 else
                    call stdlib_I64_dscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), 1_ilp64 )
                    call stdlib_I64_daxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i,i-1),1_ilp64, x11(i,i), 1_ilp64 )
                              
                 end if
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_dscal( m-p-i+1, z2, x21(i,i), 1_ilp64 )
                 else
                    call stdlib_I64_dscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), 1_ilp64 )
                    call stdlib_I64_daxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i,i-1),1_ilp64, x21(i,i), &
                              1_ilp64 )
                 end if
                 theta(i) = atan2( stdlib_I64_dnrm2( m-p-i+1, x21(i,i), 1_ilp64 ),stdlib_I64_dnrm2( p-i+1, x11(&
                           i,i), 1_ilp64 ) )
                 if( p > i ) then
                    call stdlib_I64_dlarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp64, taup1(i) )
                 else if( p == i ) then
                    call stdlib_I64_dlarfgp( p-i+1, x11(i,i), x11(i,i), 1_ilp64, taup1(i) )
                 end if
                 x11(i,i) = one
                 if ( m-p > i ) then
                    call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp64,taup2(i) )
                 else if ( m-p == i ) then
                    call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i), x21(i,i), 1_ilp64, taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_I64_dlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i),x11(i,i+1), ldx11, &
                              work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_dlarf( 'L', p-i+1, m-q-i+1, x11(i,i), 1_ilp64, taup1(i),x12(i,i), ldx12,&
                               work )
                 end if
                 if ( q > i ) then
                    call stdlib_I64_dlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21,&
                               work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_dlarf( 'L', m-p-i+1, m-q-i+1, x21(i,i), 1_ilp64, taup2(i),x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_I64_dscal( q-i, -z1*z3*sin(theta(i)), x11(i,i+1),ldx11 )
                    call stdlib_I64_daxpy( q-i, z2*z3*cos(theta(i)), x21(i,i+1), ldx21,x11(i,i+1), &
                              ldx11 )
                 end if
                 call stdlib_I64_dscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), ldx12 )
                 call stdlib_I64_daxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), ldx22,x12(i,i), ldx12 &
                           )
                 if( i < q )phi(i) = atan2( stdlib_I64_dnrm2( q-i, x11(i,i+1), ldx11 ),stdlib_I64_dnrm2( &
                           m-q-i+1, x12(i,i), ldx12 ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp64 ) then
                       call stdlib_I64_dlarfgp( q-i, x11(i,i+1), x11(i,i+1), ldx11,tauq1(i) )
                    else
                       call stdlib_I64_dlarfgp( q-i, x11(i,i+1), x11(i,i+2), ldx11,tauq1(i) )
                    end if
                    x11(i,i+1) = one
                 end if
                 if ( q+i-1 < m ) then
                    if ( m-q == i ) then
                       call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i,i), ldx12,tauq2(i) )
                    else
                       call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i,i+1), ldx12,tauq2(i) )
                                 
                    end if
                 end if
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_I64_dlarf( 'R', p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x11(i+1,i+1), &
                              ldx11, work )
                    call stdlib_I64_dlarf( 'R', m-p-i, q-i, x11(i,i+1), ldx11, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 if ( p > i ) then
                    call stdlib_I64_dlarf( 'R', p-i, m-q-i+1, x12(i,i), ldx12, tauq2(i),x12(i+1,i), &
                              ldx12, work )
                 end if
                 if ( m-p > i ) then
                    call stdlib_I64_dlarf( 'R', m-p-i, m-q-i+1, x12(i,i), ldx12,tauq2(i), x22(i+1,i), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_I64_dscal( m-q-i+1, -z1*z4, x12(i,i), ldx12 )
                 if ( i >= m-q ) then
                    call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i,i), ldx12,tauq2(i) )
                 else
                    call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i,i+1), ldx12,tauq2(i) )
                 ...
                 if( m-p-q >= 1_ilp64 )call stdlib_I64_dlarf( 'R', m-p-q, m-q-i+1, x12(i,i), ldx12,tauq2(i),&
                            x22(q+1,i), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 call stdlib_I64_dscal( m-p-q-i+1, z2*z4, x22(q+i,p+i), ldx22 )
                 if ( i == m-p-q ) then
                    call stdlib_I64_dlarfgp( m-p-q-i+1, x22(q+i,p+i), x22(q+i,p+i),ldx22, tauq2(p+i) )
                              
                 else
                    call stdlib_I64_dlarfgp( m-p-q-i+1, x22(q+i,p+i), x22(q+i,p+i+1),ldx22, tauq2(p+i)&
                               )
                 end if
                 x22(q+i,p+i) = one
                 if ( i < m-p-q ) then
                    call stdlib_I64_dlarf( 'R', m-p-q-i, m-p-q-i+1, x22(q+i,p+i), ldx22,tauq2(p+i), &
                              x22(q+i+1,p+i), ldx22, work )
                 end if
              end do
           else
              ...
              do i = 1, q
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_dscal( p-i+1, z1, x11(i,i), ldx11 )
                 else
                    call stdlib_I64_dscal( p-i+1, z1*cos(phi(i-1)), x11(i,i), ldx11 )
                    call stdlib_I64_daxpy( p-i+1, -z1*z3*z4*sin(phi(i-1)), x12(i-1,i),ldx12, x11(i,i),&
                               ldx11 )
                 end if
                 if( i == 1_ilp64 ) then
                    call stdlib_I64_dscal( m-p-i+1, z2, x21(i,i), ldx21 )
                 else
                    call stdlib_I64_dscal( m-p-i+1, z2*cos(phi(i-1)), x21(i,i), ldx21 )
                    call stdlib_I64_daxpy( m-p-i+1, -z2*z3*z4*sin(phi(i-1)), x22(i-1,i),ldx22, x21(i,&
                              i), ldx21 )
                 end if
                 theta(i) = atan2( stdlib_I64_dnrm2( m-p-i+1, x21(i,i), ldx21 ),stdlib_I64_dnrm2( p-i+1, &
                           x11(i,i), ldx11 ) )
                 call stdlib_I64_dlarfgp( p-i+1, x11(i,i), x11(i,i+1), ldx11, taup1(i) )
                 x11(i,i) = one
                 if ( i == m-p ) then
                    call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i), x21(i,i), ldx21,taup2(i) )
                 else
                    call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i), x21(i,i+1), ldx21,taup2(i) )
                 end if
                 x21(i,i) = one
                 if ( q > i ) then
                    call stdlib_I64_dlarf( 'R', q-i, p-i+1, x11(i,i), ldx11, taup1(i),x11(i+1,i), &
                              ldx11, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_dlarf( 'R', m-q-i+1, p-i+1, x11(i,i), ldx11,taup1(i), x12(i,i), &
                              ldx12, work )
                 end if
                 if ( q > i ) then
                    call stdlib_I64_dlarf( 'R', q-i, m-p-i+1, x21(i,i), ldx21, taup2(i),x21(i+1,i), &
                              ldx21, work )
                 end if
                 if ( m-q+1 > i ) then
                    call stdlib_I64_dlarf( 'R', m-q-i+1, m-p-i+1, x21(i,i), ldx21,taup2(i), x22(i,i), &
                              ldx22, work )
                 end if
                 if( i < q ) then
                    call stdlib_I64_dscal( q-i, -z1*z3*sin(theta(i)), x11(i+1,i), 1_ilp64 )
                    call stdlib_I64_daxpy( q-i, z2*z3*cos(theta(i)), x21(i+1,i), 1_ilp64,x11(i+1,i), 1_ilp64 )
                              
                 end if
                 call stdlib_I64_dscal( m-q-i+1, -z1*z4*sin(theta(i)), x12(i,i), 1_ilp64 )
                 call stdlib_I64_daxpy( m-q-i+1, z2*z4*cos(theta(i)), x22(i,i), 1_ilp64,x12(i,i), 1_ilp64 )
                           
                 if( i < q )phi(i) = atan2( stdlib_I64_dnrm2( q-i, x11(i+1,i), 1_ilp64 ),stdlib_I64_dnrm2( m-q-&
                           i+1, x12(i,i), 1_ilp64 ) )
                 if( i < q ) then
                    if ( q-i == 1_ilp64) then
                       call stdlib_I64_dlarfgp( q-i, x11(i+1,i), x11(i+1,i), 1_ilp64,tauq1(i) )
                    else
                       call stdlib_I64_dlarfgp( q-i, x11(i+1,i), x11(i+2,i), 1_ilp64,tauq1(i) )
                    end if
                    x11(i+1,i) = one
                 end if
                 if ( m-q > i ) then
                    call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp64,tauq2(i) )
                 else
                    call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i,i), 1_ilp64,tauq2(i) )
                 end if
                 x12(i,i) = one
                 if( i < q ) then
                    call stdlib_I64_dlarf( 'L', q-i, p-i, x11(i+1,i), 1_ilp64, tauq1(i),x11(i+1,i+1), ldx11,&
                               work )
                    call stdlib_I64_dlarf( 'L', q-i, m-p-i, x11(i+1,i), 1_ilp64, tauq1(i),x21(i+1,i+1), &
                              ldx21, work )
                 end if
                 call stdlib_I64_dlarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp64, tauq2(i),x12(i,i+1), ldx12, &
                           work )
                 if ( m-p-i > 0_ilp64 ) then
                    call stdlib_I64_dlarf( 'L', m-q-i+1, m-p-i, x12(i,i), 1_ilp64, tauq2(i),x22(i,i+1), &
                              ldx22, work )
                 end if
              end do
              ! reduce columns q + 1, ..., p of x12, x22
              do i = q + 1, p
                 call stdlib_I64_dscal( m-q-i+1, -z1*z4, x12(i,i), 1_ilp64 )
                 call stdlib_I64_dlarfgp( m-q-i+1, x12(i,i), x12(i+1,i), 1_ilp64, tauq2(i) )
                 x12(i,i) = one
                 if ( p > i ) then
                    call stdlib_I64_dlarf( 'L', m-q-i+1, p-i, x12(i,i), 1_ilp64, tauq2(i),x12(i,i+1), ldx12,&
                 ...
                 if( m-p-q >= 1_ilp64 )call stdlib_I64_dlarf( 'L', m-q-i+1, m-p-q, x12(i,i), 1_ilp64, tauq2(i),&
                           x22(i,q+1), ldx22, work )
              end do
              ! reduce columns p + 1, ..., m - q of x12, x22
              do i = 1, m - p - q
                 call stdlib_I64_dscal( m-p-q-i+1, z2*z4, x22(p+i,q+i), 1_ilp64 )
                 if ( m-p-q == i ) then
                    call stdlib_I64_dlarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i,q+i), 1_ilp64,tauq2(p+i) )
                              
                 else
                    call stdlib_I64_dlarfgp( m-p-q-i+1, x22(p+i,q+i), x22(p+i+1,q+i), 1_ilp64,tauq2(p+i) )
                              
                    call stdlib_I64_dlarf( 'L', m-p-q-i+1, m-p-q-i, x22(p+i,q+i), 1_ilp64,tauq2(p+i), x22(p+&
                              i,q+i+1), ldx22, work )
                 end if
                 x22(p+i,q+i) = one
              end do
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB1', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, q
              ...
              x11(i,i) = one
              x21(i,i) = one
              call stdlib_I64_slarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i), x11(i,i+1),ldx11, work(&
                        ilarf) )
              call stdlib_I64_slarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21, work(&
                        ilarf) )
              if( i < q ) then
                 call stdlib_I64_srot( q-i, x11(i,i+1), ldx11, x21(i,i+1), ldx21, c, s )
                 call stdlib_I64_slarfgp( q-i, x21(i,i+1), x21(i,i+2), ldx21, tauq1(i) )
                 s = x21(i,i+1)
                 x21(i,i+1) = one
                 call stdlib_I64_slarf( 'R', p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x11(i+1,i+1), &
                           ldx11, work(ilarf) )
                 call stdlib_I64_slarf( 'R', m-p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x21(i+1,i+1), &
                           ldx21, work(ilarf) )
                 c = sqrt( stdlib_I64_snrm2( p-i, x11(i+1,i+1), 1_ilp64 )**2_ilp64+ stdlib_I64_snrm2( m-p-i, x21(i+1,&
                           i+1), 1_ilp64 )**2_ilp64 )
                 phi(i) = atan2( s, c )
                 call stdlib_I64_sorbdb5( p-i, m-p-i, q-i-1, x11(i+1,i+1), 1_ilp64,x21(i+1,i+1), 1_ilp64, x11(i+1,&
                           i+2), ldx11,x21(i+1,i+2), ldx21, work(iorbdb5), lorbdb5,childinfo )
              end if
           end do
           return
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB1', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, q
              ...
              x11(i,i) = one
              x21(i,i) = one
              call stdlib_I64_dlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i), x11(i,i+1),ldx11, work(&
                        ilarf) )
              call stdlib_I64_dlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21, work(&
                        ilarf) )
              if( i < q ) then
                 call stdlib_I64_drot( q-i, x11(i,i+1), ldx11, x21(i,i+1), ldx21, c, s )
                 call stdlib_I64_dlarfgp( q-i, x21(i,i+1), x21(i,i+2), ldx21, tauq1(i) )
                 s = x21(i,i+1)
                 x21(i,i+1) = one
                 call stdlib_I64_dlarf( 'R', p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x11(i+1,i+1), &
                           ldx11, work(ilarf) )
                 call stdlib_I64_dlarf( 'R', m-p-i, q-i, x21(i,i+1), ldx21, tauq1(i),x21(i+1,i+1), &
                           ldx21, work(ilarf) )
                 c = sqrt( stdlib_I64_dnrm2( p-i, x11(i+1,i+1), 1_ilp64 )**2_ilp64+ stdlib_I64_dnrm2( m-p-i, x21(i+1,&
                           i+1), 1_ilp64 )**2_ilp64 )
                 phi(i) = atan2( s, c )
                 call stdlib_I64_dorbdb5( p-i, m-p-i, q-i-1, x11(i+1,i+1), 1_ilp64,x21(i+1,i+1), 1_ilp64, x11(i+1,&
                           i+2), ldx11,x21(i+1,i+2), ldx21, work(iorbdb5), lorbdb5,childinfo )
              end if
           end do
           return
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB2', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, p
              if( i > 1_ilp64 ) then
                 call stdlib_I64_srot( q-i+1, x11(i,i), ldx11, x21(i-1,i), ldx21, c, s )
              end if
              call stdlib_I64_slarfgp( q-i+1, x11(i,i), x11(i,i+1), ldx11, tauq1(i) )
              c = x11(i,i)
              x11(i,i) = one
              call stdlib_I64_slarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_slarf( 'R', m-p-i+1, q-i+1, x11(i,i), ldx11, tauq1(i),x21(i,i), ldx21, &
                        work(ilarf) )
              s = sqrt( stdlib_I64_snrm2( p-i, x11(i+1,i), 1_ilp64 )**2_ilp64+ stdlib_I64_snrm2( m-p-i+1, x21(i,i), 1_ilp64 &
                        )**2_ilp64 )
              theta(i) = atan2( s, c )
              call stdlib_I64_sorbdb5( p-i, m-p-i+1, q-i, x11(i+1,i), 1_ilp64, x21(i,i), 1_ilp64,x11(i+1,i+1), &
                        ldx11, x21(i,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_I64_sscal( p-i, negone, x11(i+1,i), 1_ilp64 )
              call stdlib_I64_slarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp64, taup2(i) )
              if( i < p ) then
                 call stdlib_I64_slarfgp( p-i, x11(i+1,i), x11(i+2,i), 1_ilp64, taup1(i) )
                 phi(i) = atan2( x11(i+1,i), x21(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x11(i+1,i) = one
                 call stdlib_I64_slarf( 'L', p-i, q-i, x11(i+1,i), 1_ilp64, taup1(i),x11(i+1,i+1), ldx11, &
                           work(ilarf) )
              end if
              x21(i,i) = one
              call stdlib_I64_slarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21, work(&
     ...
     !! angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB2', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, p
              if( i > 1_ilp64 ) then
                 call stdlib_I64_drot( q-i+1, x11(i,i), ldx11, x21(i-1,i), ldx21, c, s )
              end if
              call stdlib_I64_dlarfgp( q-i+1, x11(i,i), x11(i,i+1), ldx11, tauq1(i) )
              c = x11(i,i)
              x11(i,i) = one
              call stdlib_I64_dlarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_dlarf( 'R', m-p-i+1, q-i+1, x11(i,i), ldx11, tauq1(i),x21(i,i), ldx21, &
                        work(ilarf) )
              s = sqrt( stdlib_I64_dnrm2( p-i, x11(i+1,i), 1_ilp64 )**2_ilp64+ stdlib_I64_dnrm2( m-p-i+1, x21(i,i), 1_ilp64 &
                        )**2_ilp64 )
              theta(i) = atan2( s, c )
              call stdlib_I64_dorbdb5( p-i, m-p-i+1, q-i, x11(i+1,i), 1_ilp64, x21(i,i), 1_ilp64,x11(i+1,i+1), &
                        ldx11, x21(i,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_I64_dscal( p-i, negone, x11(i+1,i), 1_ilp64 )
              call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i), x21(i+1,i), 1_ilp64, taup2(i) )
              if( i < p ) then
                 call stdlib_I64_dlarfgp( p-i, x11(i+1,i), x11(i+2,i), 1_ilp64, taup1(i) )
                 phi(i) = atan2( x11(i+1,i), x21(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x11(i+1,i) = one
                 call stdlib_I64_dlarf( 'L', p-i, q-i, x11(i+1,i), 1_ilp64, taup1(i),x11(i+1,i+1), ldx11, &
                           work(ilarf) )
              end if
              x21(i,i) = one
              call stdlib_I64_dlarf( 'L', m-p-i+1, q-i, x21(i,i), 1_ilp64, taup2(i),x21(i,i+1), ldx21, work(&
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB3', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, m-p
              if( i > 1_ilp64 ) then
                 call stdlib_I64_srot( q-i+1, x11(i-1,i), ldx11, x21(i,i), ldx11, c, s )
              end if
              call stdlib_I64_slarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              s = x21(i,i)
              x21(i,i) = one
              call stdlib_I64_slarf( 'R', p-i+1, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_slarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              c = sqrt( stdlib_I64_snrm2( p-i+1, x11(i,i), 1_ilp64 )**2_ilp64+ stdlib_I64_snrm2( m-p-i, x21(i+1,i), 1_ilp64 &
                        )**2_ilp64 )
              theta(i) = atan2( s, c )
              call stdlib_I64_sorbdb5( p-i+1, m-p-i, q-i, x11(i,i), 1_ilp64, x21(i+1,i), 1_ilp64,x11(i,i+1), &
                        ldx11, x21(i+1,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_I64_slarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp64, taup1(i) )
              if( i < m-p ) then
                 call stdlib_I64_slarfgp( m-p-i, x21(i+1,i), x21(i+2,i), 1_ilp64, taup2(i) )
                 phi(i) = atan2( x21(i+1,i), x11(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x21(i+1,i) = one
                 call stdlib_I64_slarf( 'L', m-p-i, q-i, x21(i+1,i), 1_ilp64, taup2(i),x21(i+1,i+1), ldx21, &
                           work(ilarf) )
              end if
              x11(i,i) = one
              call stdlib_I64_slarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i), x11(i,i+1),ldx11, work(&
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB3', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, m-p
              if( i > 1_ilp64 ) then
                 call stdlib_I64_drot( q-i+1, x11(i-1,i), ldx11, x21(i,i), ldx11, c, s )
              end if
              call stdlib_I64_dlarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              s = x21(i,i)
              x21(i,i) = one
              call stdlib_I64_dlarf( 'R', p-i+1, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_dlarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              c = sqrt( stdlib_I64_dnrm2( p-i+1, x11(i,i), 1_ilp64 )**2_ilp64+ stdlib_I64_dnrm2( m-p-i, x21(i+1,i), 1_ilp64 &
                        )**2_ilp64 )
              theta(i) = atan2( s, c )
              call stdlib_I64_dorbdb5( p-i+1, m-p-i, q-i, x11(i,i), 1_ilp64, x21(i+1,i), 1_ilp64,x11(i,i+1), &
                        ldx11, x21(i+1,i+1), ldx21,work(iorbdb5), lorbdb5, childinfo )
              call stdlib_I64_dlarfgp( p-i+1, x11(i,i), x11(i+1,i), 1_ilp64, taup1(i) )
              if( i < m-p ) then
                 call stdlib_I64_dlarfgp( m-p-i, x21(i+1,i), x21(i+2,i), 1_ilp64, taup2(i) )
                 phi(i) = atan2( x21(i+1,i), x11(i,i) )
                 c = cos( phi(i) )
                 s = sin( phi(i) )
                 x21(i+1,i) = one
                 call stdlib_I64_dlarf( 'L', m-p-i, q-i, x21(i+1,i), 1_ilp64, taup2(i),x21(i+1,i+1), ldx21, &
                           work(ilarf) )
              end if
              x11(i,i) = one
              call stdlib_I64_dlarf( 'L', p-i+1, q-i, x11(i,i), 1_ilp64, taup1(i), x11(i,i+1),ldx11, work(&
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB4', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, m-q
              if( i == 1_ilp64 ) then
                 ...
                 call stdlib_I64_sorbdb5( p, m-p, q, phantom(1_ilp64), 1_ilp64, phantom(p+1), 1_ilp64,x11, ldx11, x21, &
                           ldx21, work(iorbdb5),lorbdb5, childinfo )
                 call stdlib_I64_sscal( p, negone, phantom(1_ilp64), 1_ilp64 )
                 call stdlib_I64_slarfgp( p, phantom(1_ilp64), phantom(2_ilp64), 1_ilp64, taup1(1_ilp64) )
                 call stdlib_I64_slarfgp( m-p, phantom(p+1), phantom(p+2), 1_ilp64, taup2(1_ilp64) )
                 theta(i) = atan2( phantom(1_ilp64), phantom(p+1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 phantom(1_ilp64) = one
                 phantom(p+1) = one
                 call stdlib_I64_slarf( 'L', p, q, phantom(1_ilp64), 1_ilp64, taup1(1_ilp64), x11, ldx11,work(ilarf) )
                           
                 call stdlib_I64_slarf( 'L', m-p, q, phantom(p+1), 1_ilp64, taup2(1_ilp64), x21,ldx21, work(ilarf)&
                            )
              else
                 call stdlib_I64_sorbdb5( p-i+1, m-p-i+1, q-i+1, x11(i,i-1), 1_ilp64,x21(i,i-1), 1_ilp64, x11(i,i)&
                           , ldx11, x21(i,i),ldx21, work(iorbdb5), lorbdb5, childinfo )
                 call stdlib_I64_sscal( p-i+1, negone, x11(i,i-1), 1_ilp64 )
                 call stdlib_I64_slarfgp( p-i+1, x11(i,i-1), x11(i+1,i-1), 1_ilp64, taup1(i) )
                 call stdlib_I64_slarfgp( m-p-i+1, x21(i,i-1), x21(i+1,i-1), 1_ilp64,taup2(i) )
                 theta(i) = atan2( x11(i,i-1), x21(i,i-1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 x11(i,i-1) = one
                 x21(i,i-1) = one
                 call stdlib_I64_slarf( 'L', p-i+1, q-i+1, x11(i,i-1), 1_ilp64, taup1(i),x11(i,i), ldx11, &
                           work(ilarf) )
                 call stdlib_I64_slarf( 'L', m-p-i+1, q-i+1, x21(i,i-1), 1_ilp64, taup2(i),x21(i,i), ldx21, &
                           work(ilarf) )
              end if
              call stdlib_I64_srot( q-i+1, x11(i,i), ldx11, x21(i,i), ldx21, s, -c )
              call stdlib_I64_slarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              c = x21(i,i)
              x21(i,i) = one
              call stdlib_I64_slarf( 'R', p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_slarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              if( i < m-q ) then
                 s = sqrt( stdlib_I64_snrm2( p-i, x11(i+1,i), 1_ilp64 )**2_ilp64+ stdlib_I64_snrm2( m-p-i, x21(i+1,i),&
                            1_ilp64 )**2_ilp64 )
                 phi(i) = atan2( s, c )
              end if
           end do
           ...
           do i = m - q + 1, p
              ...
              call stdlib_I64_slarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_slarf( 'R', q-p, q-i+1, x11(i,i), ldx11, tauq1(i),x21(m-q+1,i), ldx21, &
                        work(ilarf) )
           end do
           ! reduce the bottom-right portion of x21 to [ 0 i ]
           do i = p + 1, q
              call stdlib_I64_slarfgp( q-i+1, x21(m-q+i-p,i), x21(m-q+i-p,i+1), ldx21,tauq1(i) )
                        
              x21(m-q+i-p,i) = one
              call stdlib_I64_slarf( 'R', q-i, q-i+1, x21(m-q+i-p,i), ldx21, tauq1(i),x21(m-q+i-p+1,i)&
                        , ldx21, work(ilarf) )
           end do
           return
     ...
     !! implicitly by angles THETA, PHI.
        ...
        ! ====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB4', -info )
              return
           else if( lquery ) then
              return
           end if
           ...
           do i = 1, m-q
              if( i == 1_ilp64 ) then
                 ...
                 call stdlib_I64_dorbdb5( p, m-p, q, phantom(1_ilp64), 1_ilp64, phantom(p+1), 1_ilp64,x11, ldx11, x21, &
                           ldx21, work(iorbdb5),lorbdb5, childinfo )
                 call stdlib_I64_dscal( p, negone, phantom(1_ilp64), 1_ilp64 )
                 call stdlib_I64_dlarfgp( p, phantom(1_ilp64), phantom(2_ilp64), 1_ilp64, taup1(1_ilp64) )
                 call stdlib_I64_dlarfgp( m-p, phantom(p+1), phantom(p+2), 1_ilp64, taup2(1_ilp64) )
                 theta(i) = atan2( phantom(1_ilp64), phantom(p+1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 phantom(1_ilp64) = one
                 phantom(p+1) = one
                 call stdlib_I64_dlarf( 'L', p, q, phantom(1_ilp64), 1_ilp64, taup1(1_ilp64), x11, ldx11,work(ilarf) )
                           
                 call stdlib_I64_dlarf( 'L', m-p, q, phantom(p+1), 1_ilp64, taup2(1_ilp64), x21,ldx21, work(ilarf)&
                            )
              else
                 call stdlib_I64_dorbdb5( p-i+1, m-p-i+1, q-i+1, x11(i,i-1), 1_ilp64,x21(i,i-1), 1_ilp64, x11(i,i)&
                           , ldx11, x21(i,i),ldx21, work(iorbdb5), lorbdb5, childinfo )
                 call stdlib_I64_dscal( p-i+1, negone, x11(i,i-1), 1_ilp64 )
                 call stdlib_I64_dlarfgp( p-i+1, x11(i,i-1), x11(i+1,i-1), 1_ilp64, taup1(i) )
                 call stdlib_I64_dlarfgp( m-p-i+1, x21(i,i-1), x21(i+1,i-1), 1_ilp64,taup2(i) )
                 theta(i) = atan2( x11(i,i-1), x21(i,i-1) )
                 c = cos( theta(i) )
                 s = sin( theta(i) )
                 x11(i,i-1) = one
                 x21(i,i-1) = one
                 call stdlib_I64_dlarf( 'L', p-i+1, q-i+1, x11(i,i-1), 1_ilp64, taup1(i),x11(i,i), ldx11, &
                           work(ilarf) )
                 call stdlib_I64_dlarf( 'L', m-p-i+1, q-i+1, x21(i,i-1), 1_ilp64, taup2(i),x21(i,i), ldx21, &
                           work(ilarf) )
              end if
              call stdlib_I64_drot( q-i+1, x11(i,i), ldx11, x21(i,i), ldx21, s, -c )
              call stdlib_I64_dlarfgp( q-i+1, x21(i,i), x21(i,i+1), ldx21, tauq1(i) )
              c = x21(i,i)
              x21(i,i) = one
              call stdlib_I64_dlarf( 'R', p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_dlarf( 'R', m-p-i, q-i+1, x21(i,i), ldx21, tauq1(i),x21(i+1,i), ldx21, &
                        work(ilarf) )
              if( i < m-q ) then
                 s = sqrt( stdlib_I64_dnrm2( p-i, x11(i+1,i), 1_ilp64 )**2_ilp64+ stdlib_I64_dnrm2( m-p-i, x21(i+1,i),&
                            1_ilp64 )**2_ilp64 )
                 phi(i) = atan2( s, c )
              end if
           end do
           ...
           do i = m - q + 1, p
              ...
              call stdlib_I64_dlarf( 'R', p-i, q-i+1, x11(i,i), ldx11, tauq1(i),x11(i+1,i), ldx11, &
                        work(ilarf) )
              call stdlib_I64_dlarf( 'R', q-p, q-i+1, x11(i,i), ldx11, tauq1(i),x21(m-q+1,i), ldx21, &
                        work(ilarf) )
           end do
           ! reduce the bottom-right portion of x21 to [ 0 i ]
           do i = p + 1, q
              call stdlib_I64_dlarfgp( q-i+1, x21(m-q+i-p,i), x21(m-q+i-p,i+1), ldx21,tauq1(i) )
                        
              x21(m-q+i-p,i) = one
              call stdlib_I64_dlarf( 'R', q-i, q-i+1, x21(m-q+i-p,i), ldx21, tauq1(i),x21(m-q+i-p+1,i)&
                        , ldx21, work(ilarf) )
           end do
           return
     ...
     !! way.
        ...
        ! =====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB5', -info )
              return
           end if
           ! project x onto the orthogonal complement of q
           call stdlib_I64_sorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2, ldq2,work, lwork, &
                     childinfo )
           ! if the projection is nonzero, then return
           if( stdlib_I64_snrm2(m1,x1,incx1) /= zero.or. stdlib_I64_snrm2(m2,x2,incx2) /= zero ) &
                     then
              return
           end if
           ! project each standard basis vector e_1,...,e_m1 in turn, stopping
           ...
           do i = 1, m1
              ...
              call stdlib_I64_sorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2,ldq2, work, &
                        lwork, childinfo )
              if( stdlib_I64_snrm2(m1,x1,incx1) /= zero.or. stdlib_I64_snrm2(m2,x2,incx2) /= zero ) &
                        then
                 return
     ...
     !! way.
        ...
        ! =====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB5', -info )
              return
           end if
           ! project x onto the orthogonal complement of q
           call stdlib_I64_dorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2, ldq2,work, lwork, &
                     childinfo )
           ! if the projection is nonzero, then return
           if( stdlib_I64_dnrm2(m1,x1,incx1) /= zero.or. stdlib_I64_dnrm2(m2,x2,incx2) /= zero ) &
                     then
              return
           end if
           ! project each standard basis vector e_1,...,e_m1 in turn, stopping
           ...
           do i = 1, m1
              ...
              call stdlib_I64_dorbdb6( m1, m2, n, x1, incx1, x2, incx2, q1, ldq1, q2,ldq2, work, &
                        lwork, childinfo )
              if( stdlib_I64_dnrm2(m1,x1,incx1) /= zero.or. stdlib_I64_dnrm2(m2,x2,incx2) /= zero ) &
                        then
                 return
     ...
     !! criterion, then the zero vector is returned.
        ...
        ! =====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'SORBDB6', -info )
              return
           end if
           ! first, project x onto the orthogonal complement of q's column
           ! space
           scl1 = zero
           ssq1 = one
           call stdlib_I64_slassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero
           ssq2 = one
           call stdlib_I64_slassq( m2, x2, incx2, scl2, ssq2 )
           ...
           if( m1 == 0_ilp64 ) then
              ...
              call stdlib_I64_sgemv( 'C', m1, n, one, q1, ldq1, x1, incx1, zero, work,1_ilp64 )
           end if
           call stdlib_I64_sgemv( 'C', m2, n, one, q2, ldq2, x2, incx2, one, work, 1_ilp64 )
           call stdlib_I64_sgemv( 'N', m1, n, negone, q1, ldq1, work, 1_ilp64, one, x1,incx1 )
           call stdlib_I64_sgemv( 'N', m2, n, negone, q2, ldq2, work, 1_ilp64, one, x2,incx2 )
           scl1 = zero
           ssq1 = one
           call stdlib_I64_slassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero
     ...
     !! criterion, then the zero vector is returned.
        ...
        ! =====================================================================
           ...
           if( info /= 0_ilp64 ) then
              call stdlib_I64_xerbla( 'DORBDB6', -info )
              return
           end if
           ! first, project x onto the orthogonal complement of q's column
           ! space
           scl1 = zero
           ssq1 = one
           call stdlib_I64_dlassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero
           ssq2 = one
           call stdlib_I64_dlassq( m2, x2, incx2, scl2, ssq2 )
           normsq1 = scl1**2_ilp64*ssq1 + scl2**2_ilp64*ssq2
           if( m1 == 0_ilp64 ) then
              do i = 1, n
                 work(i) = zero
              ...
              call stdlib_I64_dgemv( 'C', m1, n, one, q1, ldq1, x1, incx1, zero, work,1_ilp64 )
           end if
           call stdlib_I64_dgemv( 'C', m2, n, one, q2, ldq2, x2, incx2, one, work, 1_ilp64 )
           call stdlib_I64_dgemv( 'N', m1, n, negone, q1, ldq1, work, 1_ilp64, one, x1,incx1 )
           call stdlib_I64_dgemv( 'N', m2, n, negone, q2, ldq2, work, 1_ilp64, one, x2,incx2 )
           scl1 = zero
           ssq1 = one
           call stdlib_I64_dlassq( m1, x1, incx1, scl1, ssq1 )
           scl2 = zero

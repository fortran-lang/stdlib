module stdlib_linalg_blas_c
     ...
     public :: stdlib_ctrsm
     public :: stdlib_ctrsv
     public :: stdlib_I64_caxpy
     public :: stdlib_I64_ccopy
     public :: stdlib_I64_cdotc
     public :: stdlib_I64_cdotu
     public :: stdlib_I64_cgbmv
     public :: stdlib_I64_cgemm
     public :: stdlib_I64_cgemv
     public :: stdlib_I64_cgerc
     public :: stdlib_I64_cgeru
     public :: stdlib_I64_chbmv
     public :: stdlib_I64_chemm
     public :: stdlib_I64_chemv
     public :: stdlib_I64_cher
     public :: stdlib_I64_cher2
     public :: stdlib_I64_cher2k
     public :: stdlib_I64_cherk
     public :: stdlib_I64_chpmv
     public :: stdlib_I64_chpr
     public :: stdlib_I64_chpr2
     public :: stdlib_I64_crotg
     public :: stdlib_I64_cscal
     public :: stdlib_I64_csrot
     public :: stdlib_I64_csscal
     public :: stdlib_I64_cswap
     public :: stdlib_I64_csymm
     public :: stdlib_I64_csyr2k
     public :: stdlib_I64_csyrk
     public :: stdlib_I64_ctbmv
     public :: stdlib_I64_ctbsv
     public :: stdlib_I64_ctpmv
     public :: stdlib_I64_ctpsv
     public :: stdlib_I64_ctrmm
     public :: stdlib_I64_ctrmv
     public :: stdlib_I64_ctrsm
     public :: stdlib_I64_ctrsv
     ...
     pure subroutine stdlib_I64_caxpy(n,ca,cx,incx,cy,incy)
     !! CAXPY constant times a vector plus a vector.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_ccopy(n,cx,incx,cy,incy)
     !! CCOPY copies a vector x to a vector y.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure complex(sp) function stdlib_I64_cdotc(n,cx,incx,cy,incy)
     !! CDOTC forms the dot product of two complex vectors
     !! CDOTC = X^H * Y
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure complex(sp) function stdlib_I64_cdotu(n,cx,incx,cy,incy)
     !! CDOTU forms the dot product of two complex vectors
     !! CDOTU = X^T * Y
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_cgbmv(trans,m,n,kl,ku,alpha,a,lda,x,incx,beta,y,incy)
     !! CGBMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,   or
     !! y := alpha*A**H*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     ...
     pure subroutine stdlib_I64_cgemm(transa,transb,m,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! CGEMM performs one of the matrix-matrix operations
     !! C := alpha*op( A )*op( B ) + beta*C,
     !! where  op( X ) is one of
     !! op( X ) = X   or   op( X ) = X**T   or   op( X ) = X**H,
     ...
     pure subroutine stdlib_I64_cgemv(trans,m,n,alpha,a,lda,x,incx,beta,y,incy)
     !! CGEMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,   or
     !! y := alpha*A**H*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     ...
     pure subroutine stdlib_I64_cgerc(m,n,alpha,x,incx,y,incy,a,lda)
     !! CGERC performs the rank 1 operation
     !! A := alpha*x*y**H + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure subroutine stdlib_I64_cgeru(m,n,alpha,x,incx,y,incy,a,lda)
     !! CGERU performs the rank 1 operation
     !! A := alpha*x*y**T + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure subroutine stdlib_I64_chbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
     !! CHBMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian band matrix, with k super-diagonals.
     ...
     pure subroutine stdlib_I64_chemm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! CHEMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     pure subroutine stdlib_I64_chemv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
     !! CHEMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_cher(uplo,n,alpha,x,incx,a,lda)
     !! CHER performs the hermitian rank 1 operation
     !! A := alpha*x*x**H + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_cher2(uplo,n,alpha,x,incx,y,incy,a,lda)
     !! CHER2 performs the hermitian rank 2 operation
     !! A := alpha*x*y**H + conjg( alpha )*y*x**H + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an n
     !! by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_cher2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! CHER2K performs one of the hermitian rank 2k operations
     !! C := alpha*A*B**H + conjg( alpha )*B*A**H + beta*C,
     !! or
     !! C := alpha*A**H*B + conjg( alpha )*B**H*A + beta*C,
     ...
     pure subroutine stdlib_I64_cherk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! CHERK performs one of the hermitian rank k operations
     !! C := alpha*A*A**H + beta*C,
     !! or
     !! C := alpha*A**H*A + beta*C,
     ...
     pure subroutine stdlib_I64_chpmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
     !! CHPMV performs the matrix-vector operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_chpr(uplo,n,alpha,x,incx,ap)
     !! CHPR performs the hermitian rank 1 operation
     !! A := alpha*x*x**H + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_chpr2(uplo,n,alpha,x,incx,y,incy,ap)
     !! CHPR2 performs the hermitian rank 2 operation
     !! A := alpha*x*y**H + conjg( alpha )*y*x**H + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an
     !! n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_crotg( a, b, c, s )
     !! The computation uses the formulas
     !! |x| = sqrt( Re(x)**2 + Im(x)**2 )
     !! sgn(x) = x / |x|  if x /= 0
     !! = 1        if x  = 0
     ...
     pure subroutine stdlib_I64_cscal(n,ca,cx,incx)
     !! CSCAL scales a vector by a constant.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_csrot( n, cx, incx, cy, incy, c, s )
     !! CSROT applies a plane rotation, where the cos and sin (c and s) are real
     !! and the vectors cx and cy are complex.
     !! jack dongarra, linpack, 3/11/78.
        ! -- reference blas level1 routine --
     ...
     pure subroutine stdlib_I64_csscal(n,sa,cx,incx)
     !! CSSCAL scales a complex vector by a real constant.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_cswap(n,cx,incx,cy,incy)
     !! CSWAP interchanges two vectors.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_csymm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! CSYMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     !! C are m by n matrices.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('CSYMM ',info)
               return
           end if
           ! quick return if possible.
           if ((m==0) .or. (n==0) .or.((alpha==czero).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_csyr2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! CSYR2K performs one of the symmetric rank 2k operations
     !! C := alpha*A*B**T + alpha*B*A**T + beta*C,
     !! or
     !! C := alpha*A**T*B + alpha*B**T*A + beta*C,
     ...
     !! matrices in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('CSYR2K',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==czero).or.(k==0)).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_csyrk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! CSYRK performs one of the symmetric rank k operations
     !! C := alpha*A*A**T + beta*C,
     !! or
     !! C := alpha*A**T*A + beta*C,
     ...
     !! in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('CSYRK ',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==czero).or.(k==0)).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_ctbmv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! CTBMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular band matrix, with ( k + 1 ) diagonals.
     ...
     pure subroutine stdlib_I64_ctbsv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! CTBSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular band matrix, with ( k + 1 )
     ...
     pure subroutine stdlib_I64_ctpmv(uplo,trans,diag,n,ap,x,incx)
     !! CTPMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_ctpsv(uplo,trans,diag,n,ap,x,incx)
     !! CTPSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_ctrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! CTRMM performs one of the matrix-matrix operations
     !! B := alpha*op( A )*B,   or   B := alpha*B*op( A )
     !! where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !! op( A ) = A   or   op( A ) = A**T   or   op( A ) = A**H.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('CTRMM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_ctrmv(uplo,trans,diag,n,a,lda,x,incx)
     !! CTRMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix.
     ...
     pure subroutine stdlib_I64_ctrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! CTRSM solves one of the matrix equations
     !! op( A )*X = alpha*B,   or   X*op( A ) = alpha*B,
     !! where alpha is a scalar, X and B are m by n matrices, A is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('CTRSM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_ctrsv(uplo,trans,diag,n,a,lda,x,incx)
     !! CTRSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix.

          ...
          case(1)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j2, j3, j4, j5, j6, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j2, j3, j4, j5, j6, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(2)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j3, j4, j5, j6, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j3, j4, j5, j6, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(3)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j2, j4, j5, j6, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j2, j4, j5, j6, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(4)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j2, j3, j5, j6, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j2, j3, j5, j6, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(5)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j2, j3, j4, j6, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j2, j3, j4, j6, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(6)
            ! Loop over every dimension of the array except "dim"
              ...
              do j7 = 1, size(x, 7)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j2, j3, j4, j5, j7) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j2, j3, j4, j5, j7) = val
                end if
              end do
              end do
              end do
          ...
          case(7)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
                ...
                if (mod(n, 2) == 0) then
                    val1 = minval(x_tmp(c+1:n))
                    res(j1, j2, j3, j4, j5, j6) = &
                        (real(val, kind=dp) + real(val1, kind=dp)) / 2._dp
                else
                    res(j1, j2, j3, j4, j5, j6) = val
                end if
              end do
              end do
              end do
        ...
        select case(dim)
          case(1)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(:, j2, j3, j4, j5, j6, j7), &
                              mask(:, j2, j3, j4, j5, j6, j7))
          ...
          case(2)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(j1, :, j3, j4, j5, j6, j7), &
                              mask(j1, :, j3, j4, j5, j6, j7))
          ...
          case(3)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(j1, j2, :, j4, j5, j6, j7), &
                              mask(j1, j2, :, j4, j5, j6, j7))
          ...
          case(4)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(j1, j2, j3, :, j5, j6, j7), &
                              mask(j1, j2, j3, :, j5, j6, j7))
          ...
          case(5)
            ! Loop over every dimension of the array except "dim"
              ...
              do j6 = 1, size(x, 6)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(j1, j2, j3, j4, :, j6, j7), &
                              mask(j1, j2, j3, j4, :, j6, j7))
          ...
          case(6)
            ! Loop over every dimension of the array except "dim"
              ...
              do j5 = 1, size(x, 5)
              do j7 = 1, size(x, 7)
                x_tmp = pack(x(j1, j2, j3, j4, j5, :, j7), &
                              mask(j1, j2, j3, j4, j5, :, j7))
          ...
          case(7)
            ! Loop over every dimension of the array except "dim"
              ...
              do j5 = 1, size(x, 5)
              do j6 = 1, size(x, 6)
                x_tmp = pack(x(j1, j2, j3, j4, j5, j6, :), &
                              mask(j1, j2, j3, j4, j5, j6, :))

  ...
  contains
     ...
     !! uses unrolled loops for increment equal to one.
        ...
        ! =====================================================================
           ! Local Scalars 
           real(sp) :: stemp
           integer(ilp64) :: i, m, mp1, nincx
           ! Intrinsic Functions 
           intrinsic :: abs,mod
           stdlib_I64_sasum = zero
           stemp = zero
           if (n<=0 .or. incx<=0) return
           if (incx==1) then
              ! code for increment equal to 1
     ...
     !! defined in a similar way using INCY.
        ...
        ! =====================================================================
           ! Local Scalars 
           integer(ilp64) :: i, kx, ky, ns
           ! Intrinsic Functions 
           intrinsic :: real
           stdlib_I64_dsdot = zero
           if (n<=0) return
           if (incx==incy .and. incx>0) then
           ! code for equal, positive, non-unit increments.
              ns = n*incx
              do i = 1,ns,incx
                 stdlib_I64_dsdot = stdlib_I64_dsdot + real(sx(i),KIND=dp)*real(sy(i),KIND=dp)
              end do
           else
           ! code for unequal or nonpositive increments.
              kx = 1
              ...
              if (incy<0) ky = 1 + (1-n)*incy
              do i = 1,n
                 stdlib_I64_dsdot = stdlib_I64_dsdot + real(sx(kx),KIND=dp)*real(sy(ky),KIND=dp)
                 kx = kx + incx
                 ky = ky + incy
              end do
           end if
     ...
     !! CDOTC = X^H * Y
        ...
        ! =====================================================================
           ...
           intrinsic :: conjg
           ctemp = (0.0_sp,0.0_sp)
           stdlib_I64_cdotc = (0.0_sp,0.0_sp)
           if (n<=0) return
           if (incx==1 .and. incy==1) then
              ! code for both increments equal to 1
              do i = 1,n
     ...
     !! ZDOTC = X^H * Y
        ...
        ! =====================================================================
           ...
           intrinsic :: conjg
           ztemp = (0.0_dp,0.0_dp)
           stdlib_I64_zdotc = (0.0_dp,0.0_dp)
           if (n<=0) return
           if (incx==1 .and. incy==1) then
              ! code for both increments equal to 1
              do i = 1,n
     ...
     !! CDOTU = X^T * Y
        ...
        ! =====================================================================
           ...
           integer(ilp64) :: i, ix, iy
           ctemp = (0.0_sp,0.0_sp)
           stdlib_I64_cdotu = (0.0_sp,0.0_sp)
           if (n<=0) return
           if (incx==1 .and. incy==1) then
              ! code for both increments equal to 1
              do i = 1,n
     ...
     !! ZDOTU = X^T * Y
        ...
        ! =====================================================================
           ...
           integer(ilp64) :: i, ix, iy
           ztemp = (0.0_dp,0.0_dp)
           stdlib_I64_zdotu = (0.0_dp,0.0_dp)
           if (n<=0) return
           if (incx==1 .and. incy==1) then
              ! code for both increments equal to 1
              do i = 1,n
     ...
     logical(lk) :: notbig
        ...
        stdlib_I64_snrm2 = scl*sqrt( sumsq )
        return
     ...
     logical(lk) :: notbig
        ...
        stdlib_I64_dnrm2 = scl*sqrt( sumsq )
        return
     ...
     logical(lk) :: notbig
        ...
        stdlib_I64_scnrm2 = scl*sqrt( sumsq )
        return
     ...
     !! DZNRM2 := sqrt( x**H*x )
        ...
        stdlib_I64_dznrm2 = scl*sqrt( sumsq )
        return

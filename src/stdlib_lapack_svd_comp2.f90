  ...
  contains
     ...
     !! This is an auxiliary routine called by SGEBRD
        ...
        ! =====================================================================
           ...
           if( m>=n ) then
              ...
              loop_10: do i = 1, nb
                 ! update a(i:m,i)
                 call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i+1, i-1, -one, a( i, 1_ilp64 ),lda, y( i, 1_ilp64 ), &
                           ldy, one, a( i, i ), 1_ilp64 )
                 call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i+1, i-1, -one, x( i, 1_ilp64 ),ldx, a( 1_ilp64, i ), 1_ilp64,&
                            one, a( i, i ), 1_ilp64 )
                 ! generate reflection q(i) to annihilate a(i+1:m,i)
                 ...
                 if( i<n ) then
                    a( i, i ) = one
                    ! compute y(i+1:n,i)
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i+1, n-i, one, a( i, i+1 ),lda, a( i, i ), &
                              1_ilp64, zero, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i+1, i-1, one, a( i, 1_ilp64 ), lda,a( i, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', n-i, i-1, -one, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i ),&
                               1_ilp64, one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i+1, i-1, one, x( i, 1_ilp64 ), ldx,a( i, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', i-1, n-i, -one, a( 1_ilp64, i+1 ),lda, y( 1_ilp64, i ), 1_ilp64,&
                               one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                    ! update a(i,i+1:n)
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', n-i, i, -one, y( i+1, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                              lda, one, a( i, i+1 ), lda )
                    call stdlib_I64_sgemv( 'TRANSPOSE', i-1, n-i, -one, a( 1_ilp64, i+1 ),lda, x( i, 1_ilp64 ), &
                              ldx, one, a( i, i+1 ), lda )
                    ! generate reflection p(i) to annihilate a(i,i+2:n)
                    ...
                    a( i, i+1 ) = one
                    ! compute x(i+1:m,i)
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, n-i, one, a( i+1, i+1 ),lda, a( i, i+&
                              1_ilp64 ), lda, zero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', n-i, i, one, y( i+1, 1_ilp64 ), ldy,a( i, i+1 ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i, -one, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ), &
                              1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', i-1, n-i, one, a( 1_ilp64, i+1 ),lda, a( i, i+1 )&
                              , lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i-1, -one, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                 end if
              end do loop_10
           else
              ! reduce to lower bidiagonal form
              loop_20: do i = 1, nb
                 ! update a(i,i:n)
                 call stdlib_I64_sgemv( 'NO TRANSPOSE', n-i+1, i-1, -one, y( i, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                           lda, one, a( i, i ), lda )
                 call stdlib_I64_sgemv( 'TRANSPOSE', i-1, n-i+1, -one, a( 1_ilp64, i ), lda,x( i, 1_ilp64 ), ldx, &
                           one, a( i, i ), lda )
                 ! generate reflection p(i) to annihilate a(i,i+1:n)
                 ...
                 if( i<m ) then
                    a( i, i ) = one
                    ! compute x(i+1:m,i)
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, n-i+1, one, a( i+1, i ),lda, a( i, i )&
                              , lda, zero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', n-i+1, i-1, one, y( i, 1_ilp64 ), ldy,a( i, i ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i-1, -one, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', i-1, n-i+1, one, a( 1_ilp64, i ),lda, a( i, i ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i-1, -one, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    ! update a(i+1:m,i)
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i-1, -one, a( i+1, 1_ilp64 ),lda, y( i, 1_ilp64 ),&
                               ldy, one, a( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', m-i, i, -one, x( i+1, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                              1_ilp64, one, a( i+1, i ), 1_ilp64 )
                    ! generate reflection q(i) to annihilate a(i+2:m,i)
                    ...
                    a( i+1, i ) = one
                    ! compute y(i+1:n,i)
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i, n-i, one, a( i+1, i+1 ),lda, a( i+1, i ),&
                               1_ilp64, zero, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i, i-1, one, a( i+1, 1_ilp64 ), lda,a( i+1, i ), &
                              1_ilp64, zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'NO TRANSPOSE', n-i, i-1, -one, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i ),&
                               1_ilp64, one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', m-i, i, one, x( i+1, 1_ilp64 ), ldx,a( i+1, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_sgemv( 'TRANSPOSE', i, n-i, -one, a( 1_ilp64, i+1 ), lda,y( 1_ilp64, i ), 1_ilp64, &
                              one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_sscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                 end if
              end do loop_20
     ...
     !! This is an auxiliary routine called by DGEBRD
        ...
        ! =====================================================================
           ...
           if( m>=n ) then
              ...
              loop_10: do i = 1, nb
                 ! update a(i:m,i)
                 call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i+1, i-1, -one, a( i, 1_ilp64 ),lda, y( i, 1_ilp64 ), &
                           ldy, one, a( i, i ), 1_ilp64 )
                 call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i+1, i-1, -one, x( i, 1_ilp64 ),ldx, a( 1_ilp64, i ), 1_ilp64,&
                            one, a( i, i ), 1_ilp64 )
                 ! generate reflection q(i) to annihilate a(i+1:m,i)
                 ...
                 if( i<n ) then
                    a( i, i ) = one
                    ! compute y(i+1:n,i)
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i+1, n-i, one, a( i, i+1 ),lda, a( i, i ), &
                              1_ilp64, zero, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i+1, i-1, one, a( i, 1_ilp64 ), lda,a( i, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', n-i, i-1, -one, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i ),&
                               1_ilp64, one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i+1, i-1, one, x( i, 1_ilp64 ), ldx,a( i, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', i-1, n-i, -one, a( 1_ilp64, i+1 ),lda, y( 1_ilp64, i ), 1_ilp64,&
                               one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                    ! update a(i,i+1:n)
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', n-i, i, -one, y( i+1, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                              lda, one, a( i, i+1 ), lda )
                    call stdlib_I64_dgemv( 'TRANSPOSE', i-1, n-i, -one, a( 1_ilp64, i+1 ),lda, x( i, 1_ilp64 ), &
                              ldx, one, a( i, i+1 ), lda )
                    ! generate reflection p(i) to annihilate a(i,i+2:n)
                    ...
                    a( i, i+1 ) = one
                    ! compute x(i+1:m,i)
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, n-i, one, a( i+1, i+1 ),lda, a( i, i+&
                              1_ilp64 ), lda, zero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', n-i, i, one, y( i+1, 1_ilp64 ), ldy,a( i, i+1 ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i, -one, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ), &
                              1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', i-1, n-i, one, a( 1_ilp64, i+1 ),lda, a( i, i+1 )&
                              , lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i-1, -one, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                 end if
              end do loop_10
           else
              ! reduce to lower bidiagonal form
              loop_20: do i = 1, nb
                 ! update a(i,i:n)
                 call stdlib_I64_dgemv( 'NO TRANSPOSE', n-i+1, i-1, -one, y( i, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                           lda, one, a( i, i ), lda )
                 call stdlib_I64_dgemv( 'TRANSPOSE', i-1, n-i+1, -one, a( 1_ilp64, i ), lda,x( i, 1_ilp64 ), ldx, &
                           one, a( i, i ), lda )
                 ! generate reflection p(i) to annihilate a(i,i+1:n)
                 ...
                 if( i<m ) then
                    a( i, i ) = one
                    ! compute x(i+1:m,i)
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, n-i+1, one, a( i+1, i ),lda, a( i, i )&
                              , lda, zero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', n-i+1, i-1, one, y( i, 1_ilp64 ), ldy,a( i, i ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i-1, -one, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', i-1, n-i+1, one, a( 1_ilp64, i ),lda, a( i, i ), &
                              lda, zero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i-1, -one, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i ),&
                               1_ilp64, one, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    ! update a(i+1:m,i)
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i-1, -one, a( i+1, 1_ilp64 ),lda, y( i, 1_ilp64 ),&
                               ldy, one, a( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', m-i, i, -one, x( i+1, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                              1_ilp64, one, a( i+1, i ), 1_ilp64 )
                    ! generate reflection q(i) to annihilate a(i+2:m,i)
                    ...
                    a( i+1, i ) = one
                    ! compute y(i+1:n,i)
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i, n-i, one, a( i+1, i+1 ),lda, a( i+1, i ),&
                               1_ilp64, zero, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i, i-1, one, a( i+1, 1_ilp64 ), lda,a( i+1, i ), &
                              1_ilp64, zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'NO TRANSPOSE', n-i, i-1, -one, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i ),&
                               1_ilp64, one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', m-i, i, one, x( i+1, 1_ilp64 ), ldx,a( i+1, i ), 1_ilp64, &
                              zero, y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_dgemv( 'TRANSPOSE', i, n-i, -one, a( 1_ilp64, i+1 ), lda,y( 1_ilp64, i ), 1_ilp64, &
                              one, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_dscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                 end if
              end do loop_20
     ...
     !! This is an auxiliary routine called by CGEBRD
        ...
        ! =====================================================================
           ...
           if( m>=n ) then
              ...
              loop_10: do i = 1, nb
                 ! update a(i:m,i)
                 call stdlib_I64_clacgv( i-1, y( i, 1_ilp64 ), ldy )
                 call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i+1, i-1, -cone, a( i, 1_ilp64 ),lda, y( i, 1_ilp64 ), &
                           ldy, cone, a( i, i ), 1_ilp64 )
                 call stdlib_I64_clacgv( i-1, y( i, 1_ilp64 ), ldy )
                 call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i+1, i-1, -cone, x( i, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                           1_ilp64, cone, a( i, i ), 1_ilp64 )
                 ! generate reflection q(i) to annihilate a(i+1:m,i)
                 alpha = a( i, i )
                 ...
                 if( i<n ) then
                    a( i, i ) = cone
                    ! compute y(i+1:n,i)
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i+1, n-i, cone,a( i, i+1 ), lda, &
                              a( i, i ), 1_ilp64, czero,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i+1, i-1, cone,a( i, 1_ilp64 ), lda, a( &
                              i, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', n-i, i-1, -cone, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i )&
                              , 1_ilp64, cone, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i+1, i-1, cone,x( i, 1_ilp64 ), ldx, a( &
                              i, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', i-1, n-i, -cone,a( 1_ilp64, i+1 ), lda, y(&
                               1_ilp64, i ), 1_ilp64, cone,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                    ! update a(i,i+1:n)
                    call stdlib_I64_clacgv( n-i, a( i, i+1 ), lda )
                    call stdlib_I64_clacgv( i, a( i, 1_ilp64 ), lda )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', n-i, i, -cone, y( i+1, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                              lda, cone, a( i, i+1 ), lda )
                    call stdlib_I64_clacgv( i, a( i, 1_ilp64 ), lda )
                    call stdlib_I64_clacgv( i-1, x( i, 1_ilp64 ), ldx )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', i-1, n-i, -cone,a( 1_ilp64, i+1 ), lda, x(&
                               i, 1_ilp64 ), ldx, cone,a( i, i+1 ), lda )
                    call stdlib_I64_clacgv( i-1, x( i, 1_ilp64 ), ldx )
                    ! generate reflection p(i) to annihilate a(i,i+2:n)
                    alpha = a( i, i+1 )
                    ...
                    a( i, i+1 ) = cone
                    ! compute x(i+1:m,i)
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, n-i, cone, a( i+1, i+1 ),lda, a( i, i+&
                              1_ilp64 ), lda, czero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', n-i, i, cone,y( i+1, 1_ilp64 ), ldy, a( i,&
                               i+1 ), lda, czero,x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i, -cone, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ), &
                              1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', i-1, n-i, cone, a( 1_ilp64, i+1 ),lda, a( i, i+1 &
                              ), lda, czero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i-1, -cone, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_clacgv( n-i, a( i, i+1 ), lda )
                 end if
              end do loop_10
           else
              ...
              loop_20: do i = 1, nb
                 ...
                 call stdlib_I64_clacgv( i-1, a( i, 1_ilp64 ), lda )
                 call stdlib_I64_cgemv( 'NO TRANSPOSE', n-i+1, i-1, -cone, y( i, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                           lda, cone, a( i, i ), lda )
                 call stdlib_I64_clacgv( i-1, a( i, 1_ilp64 ), lda )
                 call stdlib_I64_clacgv( i-1, x( i, 1_ilp64 ), ldx )
                 call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', i-1, n-i+1, -cone,a( 1_ilp64, i ), lda, x( i,&
                            1_ilp64 ), ldx, cone, a( i, i ),lda )
                 call stdlib_I64_clacgv( i-1, x( i, 1_ilp64 ), ldx )
                 ! generate reflection p(i) to annihilate a(i,i+1:n)
                 alpha = a( i, i )
                 ...
                 if( i<m ) then
                    a( i, i ) = cone
                    ! compute x(i+1:m,i)
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, n-i+1, cone, a( i+1, i ),lda, a( i, i &
                              ), lda, czero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', n-i+1, i-1, cone,y( i, 1_ilp64 ), ldy, a( &
                              i, i ), lda, czero,x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i-1, -cone, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', i-1, n-i+1, cone, a( 1_ilp64, i ),lda, a( i, i ),&
                               lda, czero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i-1, -cone, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    ...
                    ! update a(i+1:m,i)
                    call stdlib_I64_clacgv( i-1, y( i, 1_ilp64 ), ldy )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i-1, -cone, a( i+1, 1_ilp64 ),lda, y( i, 1_ilp64 )&
                              , ldy, cone, a( i+1, i ), 1_ilp64 )
                    call stdlib_I64_clacgv( i-1, y( i, 1_ilp64 ), ldy )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', m-i, i, -cone, x( i+1, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                              1_ilp64, cone, a( i+1, i ), 1_ilp64 )
                    ! generate reflection q(i) to annihilate a(i+2:m,i)
                    alpha = a( i+1, i )
                    ...
                    a( i+1, i ) = cone
                    ! compute y(i+1:n,i)
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i, n-i, cone,a( i+1, i+1 ), lda, &
                              a( i+1, i ), 1_ilp64, czero,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i, i-1, cone,a( i+1, 1_ilp64 ), lda, a( &
                              i+1, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'NO TRANSPOSE', n-i, i-1, -cone, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i )&
                              , 1_ilp64, cone, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', m-i, i, cone,x( i+1, 1_ilp64 ), ldx, a( i+&
                              1_ilp64, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_cgemv( 'CONJUGATE TRANSPOSE', i, n-i, -cone,a( 1_ilp64, i+1 ), lda, y( &
                              1_ilp64, i ), 1_ilp64, cone,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_cscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                 else
                    call stdlib_I64_clacgv( n-i+1, a( i, i ), lda )
     ...
     !! This is an auxiliary routine called by ZGEBRD
        ...
        ! =====================================================================
           ...
           if( m>=n ) then
              ...
              loop_10: do i = 1, nb
                 ! update a(i:m,i)
                 call stdlib_I64_zlacgv( i-1, y( i, 1_ilp64 ), ldy )
                 call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i+1, i-1, -cone, a( i, 1_ilp64 ),lda, y( i, 1_ilp64 ), &
                           ldy, cone, a( i, i ), 1_ilp64 )
                 call stdlib_I64_zlacgv( i-1, y( i, 1_ilp64 ), ldy )
                 call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i+1, i-1, -cone, x( i, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                           1_ilp64, cone, a( i, i ), 1_ilp64 )
                 ! generate reflection q(i) to annihilate a(i+1:m,i)
                 alpha = a( i, i )
                 ...
                 if( i<n ) then
                    a( i, i ) = cone
                    ! compute y(i+1:n,i)
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i+1, n-i, cone,a( i, i+1 ), lda, &
                              a( i, i ), 1_ilp64, czero,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i+1, i-1, cone,a( i, 1_ilp64 ), lda, a( &
                              i, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', n-i, i-1, -cone, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i )&
                              , 1_ilp64, cone, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i+1, i-1, cone,x( i, 1_ilp64 ), ldx, a( &
                              i, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', i-1, n-i, -cone,a( 1_ilp64, i+1 ), lda, y(&
                               1_ilp64, i ), 1_ilp64, cone,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                    ! update a(i,i+1:n)
                    call stdlib_I64_zlacgv( n-i, a( i, i+1 ), lda )
                    call stdlib_I64_zlacgv( i, a( i, 1_ilp64 ), lda )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', n-i, i, -cone, y( i+1, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                              lda, cone, a( i, i+1 ), lda )
                    call stdlib_I64_zlacgv( i, a( i, 1_ilp64 ), lda )
                    call stdlib_I64_zlacgv( i-1, x( i, 1_ilp64 ), ldx )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', i-1, n-i, -cone,a( 1_ilp64, i+1 ), lda, x(&
                               i, 1_ilp64 ), ldx, cone,a( i, i+1 ), lda )
                    call stdlib_I64_zlacgv( i-1, x( i, 1_ilp64 ), ldx )
                    ! generate reflection p(i) to annihilate a(i,i+2:n)
                    alpha = a( i, i+1 )
                    ...
                    a( i, i+1 ) = cone
                    ! compute x(i+1:m,i)
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, n-i, cone, a( i+1, i+1 ),lda, a( i, i+&
                              1_ilp64 ), lda, czero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', n-i, i, cone,y( i+1, 1_ilp64 ), ldy, a( i,&
                               i+1 ), lda, czero,x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i, -cone, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i ), &
                              1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', i-1, n-i, cone, a( 1_ilp64, i+1 ),lda, a( i, i+1 &
                              ), lda, czero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i-1, -cone, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zlacgv( n-i, a( i, i+1 ), lda )
                 end if
              end do loop_10
           else
              ...
              loop_20: do i = 1, nb
                 ...
                 call stdlib_I64_zlacgv( i-1, a( i, 1_ilp64 ), lda )
                 call stdlib_I64_zgemv( 'NO TRANSPOSE', n-i+1, i-1, -cone, y( i, 1_ilp64 ),ldy, a( i, 1_ilp64 ), &
                           lda, cone, a( i, i ), lda )
                 call stdlib_I64_zlacgv( i-1, a( i, 1_ilp64 ), lda )
                 call stdlib_I64_zlacgv( i-1, x( i, 1_ilp64 ), ldx )
                 call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', i-1, n-i+1, -cone,a( 1_ilp64, i ), lda, x( i,&
                            1_ilp64 ), ldx, cone, a( i, i ),lda )
                 call stdlib_I64_zlacgv( i-1, x( i, 1_ilp64 ), ldx )
                 ! generate reflection p(i) to annihilate a(i,i+1:n)
                 alpha = a( i, i )
                 ...
                 if( i<m ) then
                    a( i, i ) = cone
                    ! compute x(i+1:m,i)
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, n-i+1, cone, a( i+1, i ),lda, a( i, i &
                              ), lda, czero, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', n-i+1, i-1, cone,y( i, 1_ilp64 ), ldy, a( &
                              i, i ), lda, czero,x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i-1, -cone, a( i+1, 1_ilp64 ),lda, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', i-1, n-i+1, cone, a( 1_ilp64, i ),lda, a( i, i ),&
                               lda, czero, x( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i-1, -cone, x( i+1, 1_ilp64 ),ldx, x( 1_ilp64, i )&
                              , 1_ilp64, cone, x( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zscal( m-i, taup( i ), x( i+1, i ), 1_ilp64 )
                    ...
                    ! update a(i+1:m,i)
                    call stdlib_I64_zlacgv( i-1, y( i, 1_ilp64 ), ldy )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i-1, -cone, a( i+1, 1_ilp64 ),lda, y( i, 1_ilp64 )&
                              , ldy, cone, a( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zlacgv( i-1, y( i, 1_ilp64 ), ldy )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', m-i, i, -cone, x( i+1, 1_ilp64 ),ldx, a( 1_ilp64, i ), &
                              1_ilp64, cone, a( i+1, i ), 1_ilp64 )
                    ! generate reflection q(i) to annihilate a(i+2:m,i)
                    alpha = a( i+1, i )
                    ...
                    a( i+1, i ) = cone
                    ! compute y(i+1:n,i)
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i, n-i, cone,a( i+1, i+1 ), lda, &
                              a( i+1, i ), 1_ilp64, czero,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i, i-1, cone,a( i+1, 1_ilp64 ), lda, a( &
                              i+1, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'NO TRANSPOSE', n-i, i-1, -cone, y( i+1, 1_ilp64 ),ldy, y( 1_ilp64, i )&
                              , 1_ilp64, cone, y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', m-i, i, cone,x( i+1, 1_ilp64 ), ldx, a( i+&
                              1_ilp64, i ), 1_ilp64, czero,y( 1_ilp64, i ), 1_ilp64 )
                    call stdlib_I64_zgemv( 'CONJUGATE TRANSPOSE', i, n-i, -cone,a( 1_ilp64, i+1 ), lda, y( &
                              1_ilp64, i ), 1_ilp64, cone,y( i+1, i ), 1_ilp64 )
                    call stdlib_I64_zscal( n-i, tauq( i ), y( i+1, i ), 1_ilp64 )
                 else
                    call stdlib_I64_zlacgv( n-i+1, a( i, i ), lda )
        ...
        ! ====================================================================
           ...
           if( fhmn==zero ) then
              ...
              if( fhmx==zero ) then
                 ...
                 ssmax = max( fhmx, ga )*sqrt( one+( min( fhmx, ga ) / max( fhmx, ga ) )**2_ilp64 )
              ...
              if( ga<fhmx ) then
                 ...
                 if( au==zero ) then
                    ...
                    as = one + fhmn / fhmx
                    at = ( fhmx-fhmn ) / fhmx
                    c = one / ( sqrt( one+( as*au )**2_ilp64 )+sqrt( one+( at*au )**2_ilp64 ) )
                    ssmin = ( fhmn*c )*au
                    ssmin = ssmin + ssmin
                    ssmax = ga / ( c+c )
                 end if
     ...
     !! [-SNL  CSL ] [  0   H  ] [ SNR  CSR ]     [  0    SSMIN ].
       ...
       ! =====================================================================
           ...
           if( ga==zero ) then
              ...
              if( ga>fa ) then
                 pmax = 2_ilp64
                 if( ( fa / ga )<stdlib_I64_slamch( 'EPS' ) ) then
                    ! case of very large ga
                    gasmal = .false.
                    ssmax = ga
                    if( ha>one ) then
           ...
           ! correct signs of ssmax and ssmin
           if( pmax==1_ilp64 )tsign = sign( one, csr )*sign( one, csl )*sign( one, f )
           if( pmax==2_ilp64 )tsign = sign( one, snr )*sign( one, csl )*sign( one, g )
           if( pmax==3_ilp64 )tsign = sign( one, snr )*sign( one, snl )*sign( one, h )
           ssmax = sign( ssmax, tsign )
           ssmin = sign( ssmin, tsign*sign( one, f )*sign( one, h ) )
           return
     ...
     !! [-SNL  CSL ] [  0   H  ] [ SNR  CSR ]     [  0    SSMIN ].
       ...
       ! =====================================================================
           ...
           if( ga==zero ) then
              ...
              if( ga>fa ) then
                 pmax = 2_ilp64
                 if( ( fa / ga )<stdlib_I64_dlamch( 'EPS' ) ) then
                    ! case of very large ga
                    gasmal = .false.
                    ssmax = ga
                    if( ha>one ) then
     ...
     !! rotation is by PI/2.
        ...
        ! ===================================================================
           ...
           ! generate the rotation.
           ! call stdlib_I64_slartgp( z, w, cs, sn, r ) might seem more natural;
           ! reordering the arguments ensures that if z = 0 then the rotation
           ! is by pi/2.
           call stdlib_I64_slartgp( w, z, sn, cs, r )
           return
           ! end stdlib_I64_slartgs
     ...
     !! rotation is by PI/2.
        ...
        ! ===================================================================
           ...
           ! generate the rotation.
           ! call stdlib_I64_dlartgp( z, w, cs, sn, r ) might seem more natural;
           ! reordering the arguments ensures that if z = 0 then the rotation
           ! is by pi/2.
           call stdlib_I64_dlartgp( w, z, sn, cs, r )
           return
           ! end stdlib_I64_dlartgs
        ...
        ! =====================================================================
           ...
           if( upper ) then
              ...
              ! the svd of real 2-by-2 triangular c
               ! ( csl -snl )*( a b )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( 0 d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_slasv2( a, b, d, s1, s2, snr, csr, snl, csl )
              if( abs( csl )>=abs( snl ) .or. abs( csr )>=abs( snr ) )then
                 ! compute the (1,1) and (1,2) elements of u**t *a and v**t *b,
                 ! and (1,2) element of |u|**t *|a| and |v|**t *|b|.
                 ua11r = csl*a1
                 ...
                 if( ( abs( ua11r )+abs( ua12 ) )/=zero ) then
                    if( aua12 / ( abs( ua11r )+abs( ua12 ) )<=avb12 /( abs( vb11r )+abs( vb12 ) ) &
                       ...
                       call stdlib_I64_slartg( -ua11r, ua12, csq, snq, r )
                    else
                       call stdlib_I64_slartg( -vb11r, vb12, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_slartg( -vb11r, vb12, csq, snq, r )
                 end if
                 ...
                 if( ( abs( ua21 )+abs( ua22 ) )/=zero ) then
                    if( aua22 / ( abs( ua21 )+abs( ua22 ) )<=avb22 /( abs( vb21 )+abs( vb22 ) ) ) &
                              then
                       call stdlib_I64_slartg( -ua21, ua22, csq, snq, r )
                    else
                       call stdlib_I64_slartg( -vb21, vb22, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_slartg( -vb21, vb22, csq, snq, r )
                 end if
              ...
              ! the svd of real 2-by-2 triangular c
               ! ( csl -snl )*( a 0 )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( c d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_slasv2( a, c, d, s1, s2, snr, csr, snl, csl )
              if( abs( csr )>=abs( snr ) .or. abs( csl )>=abs( snl ) )then
                 ! compute the (2,1) and (2,2) elements of u**t *a and v**t *b,
                 ! and (2,1) element of |u|**t *|a| and |v|**t *|b|.
                 ua21 = -snr*a1 + csr*a2
                 ...
                 if( ( abs( ua21 )+abs( ua22r ) )/=zero ) then
                    if( aua21 / ( abs( ua21 )+abs( ua22r ) )<=avb21 /( abs( vb21 )+abs( vb22r ) ) &
                       ...
                       call stdlib_I64_slartg( ua22r, ua21, csq, snq, r )
                    else
                       call stdlib_I64_slartg( vb22r, vb21, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_slartg( vb22r, vb21, csq, snq, r )
                 end if
                 ...
                 if( ( abs( ua11 )+abs( ua12 ) )/=zero ) then
                    if( aua11 / ( abs( ua11 )+abs( ua12 ) )<=avb11 /( abs( vb11 )+abs( vb12 ) ) ) &
                              then
                       call stdlib_I64_slartg( ua12, ua11, csq, snq, r )
                    else
                       call stdlib_I64_slartg( vb12, vb11, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_slartg( vb12, vb11, csq, snq, r )
                 end if
        ...
        ! =====================================================================
           ...
           if( upper ) then
              ...
              ! the svd of real 2-by-2 triangular c
               ! ( csl -snl )*( a b )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( 0 d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_dlasv2( a, b, d, s1, s2, snr, csr, snl, csl )
              if( abs( csl )>=abs( snl ) .or. abs( csr )>=abs( snr ) )then
                 ! compute the (1,1) and (1,2) elements of u**t *a and v**t *b,
                 ! and (1,2) element of |u|**t *|a| and |v|**t *|b|.
                 ua11r = csl*a1
                 ...
                 if( ( abs( ua11r )+abs( ua12 ) )/=zero ) then
                    if( aua12 / ( abs( ua11r )+abs( ua12 ) )<=avb12 /( abs( vb11r )+abs( vb12 ) ) &
                       ...
                       call stdlib_I64_dlartg( -ua11r, ua12, csq, snq, r )
                    else
                       call stdlib_I64_dlartg( -vb11r, vb12, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_dlartg( -vb11r, vb12, csq, snq, r )
                 end if
                 ...
                 if( ( abs( ua21 )+abs( ua22 ) )/=zero ) then
                    if( aua22 / ( abs( ua21 )+abs( ua22 ) )<=avb22 /( abs( vb21 )+abs( vb22 ) ) ) &
                              then
                       call stdlib_I64_dlartg( -ua21, ua22, csq, snq, r )
                    else
                       call stdlib_I64_dlartg( -vb21, vb22, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_dlartg( -vb21, vb22, csq, snq, r )
                 end if
              ...
              ! the svd of real 2-by-2 triangular c
               ! ( csl -snl )*( a 0 )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( c d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_dlasv2( a, c, d, s1, s2, snr, csr, snl, csl )
              if( abs( csr )>=abs( snr ) .or. abs( csl )>=abs( snl ) )then
                 ! compute the (2,1) and (2,2) elements of u**t *a and v**t *b,
                 ! and (2,1) element of |u|**t *|a| and |v|**t *|b|.
                 ua21 = -snr*a1 + csr*a2
                 ...
                 if( ( abs( ua21 )+abs( ua22r ) )/=zero ) then
                    if( aua21 / ( abs( ua21 )+abs( ua22r ) )<=avb21 /( abs( vb21 )+abs( vb22r ) ) &
                       ...
                       call stdlib_I64_dlartg( ua22r, ua21, csq, snq, r )
                    else
                       call stdlib_I64_dlartg( vb22r, vb21, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_dlartg( vb22r, vb21, csq, snq, r )
                 end if
                 ...
                 if( ( abs( ua11 )+abs( ua12 ) )/=zero ) then
                    if( aua11 / ( abs( ua11 )+abs( ua12 ) )<=avb11 /( abs( vb11 )+abs( vb12 ) ) ) &
                              then
                       call stdlib_I64_dlartg( ua12, ua11, csq, snq, r )
                    else
                       call stdlib_I64_dlartg( vb12, vb11, csq, snq, r )
                    end if
                 else
                    call stdlib_I64_dlartg( vb12, vb11, csq, snq, r )
                 end if
        ...
        ! =====================================================================
           ...
           if( upper ) then
              ...
              ! the svd of real 2 by 2 triangular c
               ! ( csl -snl )*( a b )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( 0 d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_slasv2( a, fb, d, s1, s2, snr, csr, snl, csl )
              if( abs( csl )>=abs( snl ) .or. abs( csr )>=abs( snr ) )then
                 ! compute the (1,1) and (1,2) elements of u**h *a and v**h *b,
                 ! and (1,2) element of |u|**h *|a| and |v|**h *|b|.
                 ua11r = csl*a1
                 ...
                 ! zero (1,2) elements of u**h *a and v**h *b
                 if( ( abs( ua11r )+abs1( ua12 ) )==zero ) then
                    call stdlib_I64_clartg( -cmplx( vb11r,KIND=sp), conjg( vb12 ), csq, snq,r )
                              
                 else if( ( abs( vb11r )+abs1( vb12 ) )==zero ) then
                    call stdlib_I64_clartg( -cmplx( ua11r,KIND=sp), conjg( ua12 ), csq, snq,r )
                 ...
                 ! zero (2,2) elements of u**h *a and v**h *b, and then swap.
                 if( ( abs1( ua21 )+abs1( ua22 ) )==zero ) then
                    call stdlib_I64_clartg( -conjg( vb21 ), conjg( vb22 ), csq, snq, r )
                 else if( ( abs1( vb21 )+abs( vb22 ) )==zero ) then
                    call stdlib_I64_clartg( -conjg( ua21 ), conjg( ua22 ), csq, snq, r )
                 else if( aua22 / ( abs1( ua21 )+abs1( ua22 ) )<=avb22 /( abs1( vb21 )+abs1( vb22 &
                           ) ) ) then
                    call stdlib_I64_clartg( -conjg( ua21 ), conjg( ua22 ), csq, snq, r )
                 else
              ...
              ! the svd of real 2 by 2 triangular c
               ! ( csl -snl )*( a 0 )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( c d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_slasv2( a, fc, d, s1, s2, snr, csr, snl, csl )
              if( abs( csr )>=abs( snr ) .or. abs( csl )>=abs( snl ) )then
                 ! compute the (2,1) and (2,2) elements of u**h *a and v**h *b,
                 ! and (2,1) element of |u|**h *|a| and |v|**h *|b|.
                 ua21 = -d1*snr*a1 + csr*a2
                 ...
                 ! zero (2,1) elements of u**h *a and v**h *b.
                 if( ( abs1( ua21 )+abs( ua22r ) )==zero ) then
                    call stdlib_I64_clartg( cmplx( vb22r,KIND=sp), vb21, csq, snq, r )
                 else if( ( abs1( vb21 )+abs( vb22r ) )==zero ) then
                    call stdlib_I64_clartg( cmplx( ua22r,KIND=sp), ua21, csq, snq, r )
                 else if( aua21 / ( abs1( ua21 )+abs( ua22r ) )<=avb21 /( abs1( vb21 )+abs( vb22r &
                           ) ) ) then
                    call stdlib_I64_clartg( cmplx( ua22r,KIND=sp), ua21, csq, snq, r )
                 else
                 ...
                 ! zero (1,1) elements of u**h *a and v**h *b, and then swap.
                 if( ( abs1( ua11 )+abs1( ua12 ) )==zero ) then
                    call stdlib_I64_clartg( vb12, vb11, csq, snq, r )
                 else if( ( abs1( vb11 )+abs1( vb12 ) )==zero ) then
                    call stdlib_I64_clartg( ua12, ua11, csq, snq, r )
                 else if( aua11 / ( abs1( ua11 )+abs1( ua12 ) )<=avb11 /( abs1( vb11 )+abs1( vb12 &
                           ) ) ) then
                    call stdlib_I64_clartg( ua12, ua11, csq, snq, r )
                 else
        ...
        ! =====================================================================
           ...
           if( upper ) then
              ...
              ! the svd of real 2 by 2 triangular c
               ! ( csl -snl )*( a b )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( 0 d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_dlasv2( a, fb, d, s1, s2, snr, csr, snl, csl )
              if( abs( csl )>=abs( snl ) .or. abs( csr )>=abs( snr ) )then
                 ! compute the (1,1) and (1,2) elements of u**h *a and v**h *b,
                 ! and (1,2) element of |u|**h *|a| and |v|**h *|b|.
                 ua11r = csl*a1
                 ...
                 ! zero (1,2) elements of u**h *a and v**h *b
                 if( ( abs( ua11r )+abs1( ua12 ) )==zero ) then
                    call stdlib_I64_zlartg( -cmplx( vb11r,KIND=dp), conjg( vb12 ), csq, snq,r )
                              
                 else if( ( abs( vb11r )+abs1( vb12 ) )==zero ) then
                    call stdlib_I64_zlartg( -cmplx( ua11r,KIND=dp), conjg( ua12 ), csq, snq,r )
                 ...
                 ! zero (2,2) elements of u**h *a and v**h *b, and then swap.
                 if( ( abs1( ua21 )+abs1( ua22 ) )==zero ) then
                    call stdlib_I64_zlartg( -conjg( vb21 ), conjg( vb22 ), csq, snq,r )
                 else if( ( abs1( vb21 )+abs( vb22 ) )==zero ) then
                    call stdlib_I64_zlartg( -conjg( ua21 ), conjg( ua22 ), csq, snq,r )
                 else if( aua22 / ( abs1( ua21 )+abs1( ua22 ) )<=avb22 /( abs1( vb21 )+abs1( vb22 &
                           ) ) ) then
                    call stdlib_I64_zlartg( -conjg( ua21 ), conjg( ua22 ), csq, snq,r )
                 else
              ...
              ! the svd of real 2 by 2 triangular c
               ! ( csl -snl )*( a 0 )*(  csr  snr ) = ( r 0 )
               ! ( snl  csl ) ( c d ) ( -snr  csr )   ( 0 t )
              call stdlib_I64_dlasv2( a, fc, d, s1, s2, snr, csr, snl, csl )
              if( abs( csr )>=abs( snr ) .or. abs( csl )>=abs( snl ) )then
                 ! compute the (2,1) and (2,2) elements of u**h *a and v**h *b,
                 ! and (2,1) element of |u|**h *|a| and |v|**h *|b|.
                 ua21 = -d1*snr*a1 + csr*a2
                 ...
                 ! zero (2,1) elements of u**h *a and v**h *b.
                 if( ( abs1( ua21 )+abs( ua22r ) )==zero ) then
                    call stdlib_I64_zlartg( cmplx( vb22r,KIND=dp), vb21, csq, snq, r )
                 else if( ( abs1( vb21 )+abs( vb22r ) )==zero ) then
                    call stdlib_I64_zlartg( cmplx( ua22r,KIND=dp), ua21, csq, snq, r )
                 else if( aua21 / ( abs1( ua21 )+abs( ua22r ) )<=avb21 /( abs1( vb21 )+abs( vb22r &
                           ) ) ) then
                    call stdlib_I64_zlartg( cmplx( ua22r,KIND=dp), ua21, csq, snq, r )
                 else
                 ...
                 ! zero (1,1) elements of u**h *a and v**h *b, and then swap.
                 if( ( abs1( ua11 )+abs1( ua12 ) )==zero ) then
                    call stdlib_I64_zlartg( vb12, vb11, csq, snq, r )
                 else if( ( abs1( vb11 )+abs1( vb12 ) )==zero ) then
                    call stdlib_I64_zlartg( ua12, ua11, csq, snq, r )
                 else if( aua11 / ( abs1( ua11 )+abs1( ua12 ) )<=avb11 /( abs1( vb11 )+abs1( vb12 &
                           ) ) ) then
                    call stdlib_I64_zlartg( ua12, ua11, csq, snq, r )
                 else
     ...
     !! as the measurement of the linear dependency of the vectors X and Y.
        ...
        ! =====================================================================
           ...
           ! compute the qr factorization of the n-by-2 matrix ( x y )
           call stdlib_I64_slarfg( n, x( 1_ilp64 ), x( 1_ilp64+incx ), incx, tau )
           a11 = x( 1_ilp64 )
           x( 1_ilp64 ) = one
           c = -tau*stdlib_I64_sdot( n, x, incx, y, incy )
           call stdlib_I64_saxpy( n, c, x, incx, y, incy )
           call stdlib_I64_slarfg( n-1, y( 1_ilp64+incy ), y( 1_ilp64+2*incy ), incy, tau )
           a12 = y( 1_ilp64 )
           a22 = y( 1_ilp64+incy )
           ! compute the svd of 2-by-2 upper triangular matrix.
           call stdlib_I64_slas2( a11, a12, a22, ssmin, ssmax )
           return
     ...
     !! as the measurement of the linear dependency of the vectors X and Y.
        ...
        ! =====================================================================
           ...
           ! compute the qr factorization of the n-by-2 matrix ( x y )
           call stdlib_I64_dlarfg( n, x( 1_ilp64 ), x( 1_ilp64+incx ), incx, tau )
           a11 = x( 1_ilp64 )
           x( 1_ilp64 ) = one
           c = -tau*stdlib_I64_ddot( n, x, incx, y, incy )
           call stdlib_I64_daxpy( n, c, x, incx, y, incy )
           call stdlib_I64_dlarfg( n-1, y( 1_ilp64+incy ), y( 1_ilp64+2*incy ), incy, tau )
           a12 = y( 1_ilp64 )
           a22 = y( 1_ilp64+incy )
           ! compute the svd of 2-by-2 upper triangular matrix.
           call stdlib_I64_dlas2( a11, a12, a22, ssmin, ssmax )
           return
     ...
     !! as the measurement of the linear dependency of the vectors X and Y.
        ...
        ! =====================================================================
           ...
           ! compute the qr factorization of the n-by-2 matrix ( x y )
           call stdlib_I64_clarfg( n, x( 1_ilp64 ), x( 1_ilp64+incx ), incx, tau )
           a11 = x( 1_ilp64 )
           x( 1_ilp64 ) = cone
           c = -conjg( tau )*stdlib_I64_cdotc( n, x, incx, y, incy )
           call stdlib_I64_caxpy( n, c, x, incx, y, incy )
           call stdlib_I64_clarfg( n-1, y( 1_ilp64+incy ), y( 1_ilp64+2*incy ), incy, tau )
           a12 = y( 1_ilp64 )
           a22 = y( 1_ilp64+incy )
           ! compute the svd of 2-by-2 upper triangular matrix.
           call stdlib_I64_slas2( abs( a11 ), abs( a12 ), abs( a22 ), ssmin, ssmax )
           return
     ...
     !! as the measurement of the linear dependency of the vectors X and Y.
        ...
        ! =====================================================================
           ...
           ! compute the qr factorization of the n-by-2 matrix ( x y )
           call stdlib_I64_zlarfg( n, x( 1_ilp64 ), x( 1_ilp64+incx ), incx, tau )
           a11 = x( 1_ilp64 )
           x( 1_ilp64 ) = cone
           c = -conjg( tau )*stdlib_I64_zdotc( n, x, incx, y, incy )
           call stdlib_I64_zaxpy( n, c, x, incx, y, incy )
           call stdlib_I64_zlarfg( n-1, y( 1_ilp64+incy ), y( 1_ilp64+2*incy ), incy, tau )
           a12 = y( 1_ilp64 )
           a22 = y( 1_ilp64+incy )
           ! compute the svd of 2-by-2 upper triangular matrix.
           call stdlib_I64_dlas2( abs( a11 ), abs( a12 ), abs( a22 ), ssmin, ssmax )
           return

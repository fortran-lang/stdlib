...
contains
    ...
    pure module subroutine stdlib_I64_glagtm_sp(trans, n, nrhs, alpha, dl, d, du, x, ldx, beta, b, ldb)
        ...
        if(trans == 'N') then
            do j = 1, nrhs
                if(n == 1_ilp64) then
                    temp = d(1_ilp64) * x(1_ilp64, j)
                    b(1_ilp64, j) = b(1_ilp64, j) + alpha * temp
                else
                    temp = d(1_ilp64) * x(1_ilp64, j) + du(1_ilp64) * x(2_ilp64, j)
                    b(1_ilp64, j) = b(1_ilp64, j) + alpha * temp
                    do i = 2, n - 1
                        temp = dl(i - 1) * x(i - 1, j) + d(i) * x(i, j) + du(i) * x(i + 1, j)
                        b(i, j) = b(i, j) + alpha * temp
            ...
            do j = 1, nrhs
                if(n == 1_ilp64) then
                    ...
                    temp = d(1_ilp64) * x(1_ilp64, j) + dl(1_ilp64) * x(2_ilp64, j)
                    b(1_ilp64, j) = b(1_ilp64, j) + alpha * temp
                    do i = 2, n - 1
                        temp = du(i - 1) * x(i - 1, j) + d(i) * x(i, j) + dl(i) * x(i + 1, j)
                        b(i, j) = b(i, j) + alpha * temp
    ...
    pure module subroutine stdlib_I64_glagtm_csp(trans, n, nrhs, alpha, dl, d, du, x, ldx, beta, b, ldb)
        ...
        if(trans == 'N') then
            ...
            do j = 1, nrhs
                if(n == 1_ilp64) then
                    temp = conjg(d(1_ilp64)) * x(1_ilp64, j)
                    b(1_ilp64, j) = b(1_ilp64, j) + alpha * temp
                else
                    temp = conjg(d(1_ilp64)) * x(1_ilp64, j) + conjg(dl(1_ilp64)) * x(2_ilp64, j)
                    b(1_ilp64, j) = b(1_ilp64, j) + alpha * temp
                    do i = 2, n - 1
                        temp = conjg(du(i - 1)) * x(i - 1, j) + conjg(d(i)) * x(i, j) + conjg(dl(i)) * x(i + 1, j)
                        b(i, j) = b(i, j) + alpha * temp

  ...
  contains
       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              do j = 1, n
                 do i = 1, m
                    temp = abs( a( i, j ) )
                    if( value<temp .or. stdlib_I64_sisnan( temp ) ) value = temp
                 end do
              end do
           else if( ( stdlib_lsame( norm, 'O' ) ) .or. ( norm=='1' ) ) then
              ! find norm1(a).
              ...
              do j = 1, n
                 ...
                 if( value<sum .or. stdlib_I64_sisnan( sum ) ) value = sum
              end do
           else if( stdlib_lsame( norm, 'I' ) ) then
              ! find normi(a).
              do i = 1, m
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_slassq( m, a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slange = value
           return
       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              do j = 1, n
                 do i = 1, m
                    temp = abs( a( i, j ) )
                    if( value<temp .or. stdlib_I64_disnan( temp ) ) value = temp
                 end do
              end do
           else if( ( stdlib_lsame( norm, 'O' ) ) .or. ( norm=='1' ) ) then
              ! find norm1(a).
              ...
              do j = 1, n
                 ...
                 if( value<sum .or. stdlib_I64_disnan( sum ) ) value = sum
              end do
           else if( stdlib_lsame( norm, 'I' ) ) then
              ! find normi(a).
              do i = 1, m
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_dlassq( m, a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlange = value
           return
     ...
     !! complex matrix A.
       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_classq( m, a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clange = value
           return
     ...
     !! complex matrix A.
       ...
       ! =====================================================================
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_zlassq( m, a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlange = value
           return
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              do j = 1, n
                 l = max( 1_ilp64, j-ku )
                 k = ku + 1_ilp64 - j + l
                 call stdlib_I64_slassq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slangb = value
           return
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              do j = 1, n
                 l = max( 1_ilp64, j-ku )
                 k = ku + 1_ilp64 - j + l
                 call stdlib_I64_dlassq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlangb = value
           return
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              do j = 1, n
                 l = max( 1_ilp64, j-ku )
                 k = ku + 1_ilp64 - j + l
                 call stdlib_I64_classq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clangb = value
           return
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              do j = 1, n
                 l = max( 1_ilp64, j-ku )
                 k = ku + 1_ilp64 - j + l
                 call stdlib_I64_zlassq( min( n, j+kl )-l+1, ab( k, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlangb = value
           return
     ...
     !! real tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              anorm = abs( d( n ) )
              do i = 1, n - 1
                 if( anorm<abs( dl( i ) ) .or. stdlib_I64_sisnan( abs( dl( i ) ) ) )anorm = abs(dl(i))
                           
                 if( anorm<abs( d( i ) ) .or. stdlib_I64_sisnan( abs( d( i ) ) ) )anorm = abs(d(i))
                           
                 if( anorm<abs( du( i ) ) .or. stdlib_I64_sisnan (abs( du( i ) ) ) )anorm = abs(du(i))
              ...
              if( n==1_ilp64 ) then
                 ...
                 anorm = abs( d( 1_ilp64 ) )+abs( dl( 1_ilp64 ) )
                 temp = abs( d( n ) )+abs( du( n-1 ) )
                 if( anorm < temp .or. stdlib_I64_sisnan( temp ) ) anorm = temp
                 do i = 2, n - 1
                    temp = abs( d( i ) )+abs( dl( i ) )+abs( du( i-1 ) )
                    if( anorm < temp .or. stdlib_I64_sisnan( temp ) ) anorm = temp
                 end do
              ...
              if( n==1_ilp64 ) then
                 ...
                 anorm = abs( d( 1_ilp64 ) )+abs( du( 1_ilp64 ) )
                 temp = abs( d( n ) )+abs( dl( n-1 ) )
                 if( anorm < temp .or. stdlib_I64_sisnan( temp ) ) anorm = temp
                 do i = 2, n - 1
                    temp = abs( d( i ) )+abs( du( i ) )+abs( dl( i-1 ) )
              ...
              scale = zero
              sum = one
              call stdlib_I64_slassq( n, d, 1_ilp64, scale, sum )
              if( n>1_ilp64 ) then
                 call stdlib_I64_slassq( n-1, dl, 1_ilp64, scale, sum )
                 call stdlib_I64_slassq( n-1, du, 1_ilp64, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_slangt = anorm
           return
     ...
     !! real tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              anorm = abs( d( n ) )
              do i = 1, n - 1
                 if( anorm<abs( dl( i ) ) .or. stdlib_I64_disnan( abs( dl( i ) ) ) )anorm = abs(dl(i))
                           
                 if( anorm<abs( d( i ) ) .or. stdlib_I64_disnan( abs( d( i ) ) ) )anorm = abs(d(i))
                           
                 if( anorm<abs( du( i ) ) .or. stdlib_I64_disnan (abs( du( i ) ) ) )anorm = abs(du(i))
              ...
              if( n==1_ilp64 ) then
                 ...
                 anorm = abs( d( 1_ilp64 ) )+abs( dl( 1_ilp64 ) )
                 temp = abs( d( n ) )+abs( du( n-1 ) )
                 if( anorm < temp .or. stdlib_I64_disnan( temp ) ) anorm = temp
                 do i = 2, n - 1
                    temp = abs( d( i ) )+abs( dl( i ) )+abs( du( i-1 ) )
                    if( anorm < temp .or. stdlib_I64_disnan( temp ) ) anorm = temp
                 end do
              ...
              scale = zero
              sum = one
              call stdlib_I64_dlassq( n, d, 1_ilp64, scale, sum )
              if( n>1_ilp64 ) then
                 call stdlib_I64_dlassq( n-1, dl, 1_ilp64, scale, sum )
                 call stdlib_I64_dlassq( n-1, du, 1_ilp64, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_dlangt = anorm
           return
     ...
     !! complex tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              scale = zero
              sum = one
              call stdlib_I64_classq( n, d, 1_ilp64, scale, sum )
              if( n>1_ilp64 ) then
                 call stdlib_I64_classq( n-1, dl, 1_ilp64, scale, sum )
                 call stdlib_I64_classq( n-1, du, 1_ilp64, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_clangt = anorm
           return
     ...
     !! complex tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              scale = zero
              sum = one
              call stdlib_I64_zlassq( n, d, 1_ilp64, scale, sum )
              if( n>1_ilp64 ) then
                 call stdlib_I64_zlassq( n-1, dl, 1_ilp64, scale, sum )
                 call stdlib_I64_zlassq( n-1, du, 1_ilp64, scale, sum )
              end if
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_zlangt = anorm
           return
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_slassq( min( n, j+1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slanhs = value
           return
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_dlassq( min( n, j+1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlanhs = value
           return
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_classq( min( n, j+1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clanhs = value
           return
     ...
     !! Hessenberg matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              sum = one
              do j = 1, n
                 call stdlib_I64_zlassq( min( n, j+1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
              end do
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlanhs = value
           return
     ...
     !! complex Hermitian matrix A in RFP format.
        ...
        ! =====================================================================
           ...
           ! Local Scalars 
           integer(ilp64) :: i, j, ifm, ilu, noe, n1, k, l, lda
           real(sp) :: scale, s, value, aa, temp
           ! Intrinsic Functions 
           ! Executable Statements 
           if( n==0_ilp64 ) then
              stdlib_I64_clanhf = zero
              return
           else if( n==1_ilp64 ) then
              stdlib_I64_clanhf = abs(real(a(0_ilp64),KIND=sp))
              return
           end if
           ! set noe = 1 if n is odd. if n is even set noe=0
           noe = 1_ilp64
           if( mod( n, 2_ilp64 )==0_ilp64 )noe = 0_ilp64
           ! set ifm = 0 when form='c' or 'c' and 1 otherwise
           ifm = 1_ilp64
           if( stdlib_lsame( transr, 'C' ) )ifm = 0_ilp64
           ! set ilu = 0 when uplo='u or 'u' and 1 otherwise
           ilu = 1_ilp64
           if( stdlib_lsame( uplo, 'U' ) )ilu = 0_ilp64
           ! set lda = (n+1)/2 when ifm = 0
           ! set lda = n when ifm = 1 and noe = 1
           ! set lda = n+1 when ifm = 1 and noe = 0
           if( ifm==1_ilp64 ) then
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==1_ilp64 ) then
                       ...
                       j = k - 1_ilp64
                       ! -> u(j,j) is at a(0,j)
                       temp = abs( real( a( 0_ilp64+j*lda ),KIND=sp) )
                       if( value < temp .or. stdlib_I64_sisnan( temp ) )value = temp
                       do i = 1, k - 1
                          temp = abs( a( i+j*lda ) )
                          if( value < temp .or. stdlib_I64_sisnan( temp ) )value = temp
              ...
              if( ifm==1_ilp64 ) then
                 ...
                 if( noe==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ...
                       ! j=n1=k-1 is special
                       s = abs( real( a( 0_ilp64+j*lda ),KIND=sp) )
                       ! a(k-1,k-1)
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
                          ! a(k-1,i+n1)
                    ...
                    if( ilu==0_ilp64 ) then
                       ...
                       ! j=k
                       aa = abs( real( a( 0_ilp64+j*lda ),KIND=sp) )
                       ! a(k,k)
                       s = aa
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_I64_classq( k-j-2, a( k+j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_classq( k+j-1, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       do i = 0, k - 2
                          ...
                          if( aa/=zero ) then
                             if( scale<aa ) then
                                s = one + s*( scale / aa )**2_ilp64
                                scale = aa
                             else
                                s = s + ( aa / scale )**2_ilp64
                             end if
                          end if
                          aa = real( a( l+1 ),KIND=sp)
                          ! u(i,i)
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_classq( n-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 1, k - 2
                          call stdlib_I64_classq( j, a( 0_ilp64+( 1_ilp64+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       aa = real( a( 0_ilp64 ),KIND=sp)
                       ! l(0,0) at a(0,0)
                       if( aa/=zero ) then
                          if( scale<aa ) then
                             s = one + s*( scale / aa )**2_ilp64
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**h is upper
                       do j = 1, k - 2
                          call stdlib_I64_classq( j, a( 0_ilp64+( k+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_classq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_classq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp64,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_I64_classq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_I64_classq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_I64_classq( k-j-2, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_I64_classq( k-j-1, a( k+j+2+j*lda ), 1_ilp64, scale, s )
                       ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_classq( k+j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_classq( n-j-1, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_I64_classq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**h is upper
                       do j = 1, k - 1
                          call stdlib_I64_classq( j, a( 0_ilp64+( k+1+j )*lda ), 1_ilp64, scale, s )
                       ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_classq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_classq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp64, scale,s )
                       ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_I64_classq( j, a( 0_ilp64+( j+1 )*lda ), 1_ilp64, scale, s )
                       ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_I64_classq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_classq( k-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                       ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
     ...
     !! complex Hermitian matrix A in RFP format.
        ...
        ! =====================================================================
           ...
           ! Executable Statements 
           if( n==0_ilp64 ) then
              stdlib_I64_zlanhf = zero
              return
           else if( n==1_ilp64 ) then
              stdlib_I64_zlanhf = abs(real(a(0_ilp64),KIND=dp))
              return
           end if
           ! set noe = 1 if n is odd. if n is even set noe=0
           noe = 1_ilp64
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==1_ilp64 ) then
                       ...
                       j = k - 1_ilp64
                       ! -> u(j,j) is at a(0,j)
                       temp = abs( real( a( 0_ilp64+j*lda ),KIND=dp) )
                       if( value < temp .or. stdlib_I64_disnan( temp ) )value = temp
                       do i = 1, k - 1
                          temp = abs( a( i+j*lda ) )
                          if( value < temp .or. stdlib_I64_disnan( temp ) )value = temp
              ...
              if( ifm==1_ilp64 ) then
                 ...
                 if( noe==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ...
                       ! j=n1=k-1 is special
                       s = abs( real( a( 0_ilp64+j*lda ),KIND=dp) )
                       ! a(k-1,k-1)
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
                          ! a(k-1,i+n1)
                    ...
                    if( ilu==0_ilp64 ) then
                       ...
                       ! j=k
                       aa = abs( real( a( 0_ilp64+j*lda ),KIND=dp) )
                       ! a(k,k)
                       s = aa
                       do i = 1, k - 1
                          aa = abs( a( i+j*lda ) )
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_I64_zlassq( k-j-2, a( k+j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_zlassq( k+j-1, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_zlassq( n-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 1, k - 2
                          call stdlib_I64_zlassq( j, a( 0_ilp64+( 1_ilp64+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       aa = real( a( 0_ilp64 ),KIND=dp)
                       ! l(0,0) at a(0,0)
                       if( aa/=zero ) then
                          if( scale<aa ) then
                             s = one + s*( scale / aa )**2_ilp64
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**h is upper
                       do j = 1, k - 2
                          call stdlib_I64_zlassq( j, a( 0_ilp64+( k+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_zlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_zlassq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp64,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_I64_zlassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_I64_zlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_I64_zlassq( k-j-2, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_I64_zlassq( k-j-1, a( k+j+2+j*lda ), 1_ilp64, scale, s )
                       ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_zlassq( k+j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_zlassq( n-j-1, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_I64_zlassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**h is upper
                       do j = 1, k - 1
                          call stdlib_I64_zlassq( j, a( 0_ilp64+( k+1+j )*lda ), 1_ilp64, scale, s )
                       ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_zlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_zlassq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp64, scale,s )
                       ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       ...
                       ! a**h is lower
                       do j = 1, k - 1
                          call stdlib_I64_zlassq( j, a( 0_ilp64+( j+1 )*lda ), 1_ilp64, scale, s )
                       ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_I64_zlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_zlassq( k-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                       ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
     ...
     !! real symmetric matrix A in RFP format.
        ...
        ! =====================================================================
           ...
           ! Executable Statements 
           if( n==0_ilp64 ) then
              stdlib_I64_slansf = zero
              return
           else if( n==1_ilp64 ) then
              stdlib_I64_slansf = abs( a(0_ilp64) )
              return
           end if
           ! set noe = 1 if n is odd. if n is even set noe=0
           noe = 1_ilp64
           ...
           ! set ifm = 0 when form='t or 't' and 1 otherwise
           ifm = 1_ilp64
           if( stdlib_lsame( transr, 'T' ) )ifm = 0_ilp64
           ! set ilu = 0 when uplo='u or 'u' and 1 otherwise
           ilu = 1_ilp64
           if( stdlib_lsame( uplo, 'U' ) )ilu = 0_ilp64
           ! set lda = (n+1)/2 when ifm = 0
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_I64_slassq( k-j-2, a( k+j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_slassq( k+j-1, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k-1, a( k ), lda+1, scale, s )
                       ! tri l at a(k,0)
                       call stdlib_I64_slassq( k, a( k-1 ), lda+1, scale, s )
                       ! tri u at a(k-1,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_slassq( n-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_slassq( j, a( 0_ilp64+( 1_ilp64+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri l at a(0,0)
                       call stdlib_I64_slassq( k-1, a( 0_ilp64+lda ), lda+1, scale, s )
                       ! tri u at a(0,1)
                    end if
                 else
                    ! a is xpose
                    if( ilu==0_ilp64 ) then
                       ! a**t is upper
                       do j = 1, k - 2
                          call stdlib_I64_slassq( j, a( 0_ilp64+( k+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_slassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_slassq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp64,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k-1, a( 0_ilp64+k*lda ), lda+1, scale, s )
                       ! tri u at a(0,k)
                       call stdlib_I64_slassq( k, a( 0_ilp64+( k-1 )*lda ), lda+1, scale, s )
                       ! tri l at a(0,k-1)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_I64_slassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_I64_slassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_I64_slassq( k-j-2, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                       call stdlib_I64_slassq( k-1, a( 1_ilp64 ), lda+1, scale, s )
                       ! tri l at a(1,0)
                    end if
                 end if
              else
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_I64_slassq( k-j-1, a( k+j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_slassq( k+j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( k+1 ), lda+1, scale, s )
                       ! tri l at a(k+1,0)
                       call stdlib_I64_slassq( k, a( k ), lda+1, scale, s )
                       ! tri u at a(k,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_slassq( n-j-1, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_I64_slassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( 1_ilp64 ), lda+1, scale, s )
                       ! tri l at a(1,0)
                       call stdlib_I64_slassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**t is upper
                       do j = 1, k - 1
                          call stdlib_I64_slassq( j, a( 0_ilp64+( k+1+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_slassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_slassq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp64, scale,s )
                          ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( 0_ilp64+( k+1 )*lda ), lda+1, scale, s )
                       ! tri u at a(0,k+1)
                       call stdlib_I64_slassq( k, a( 0_ilp64+k*lda ), lda+1, scale, s )
                       ! tri l at a(0,k)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_I64_slassq( j, a( 0_ilp64+( j+1 )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_I64_slassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_slassq( k-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_slassq( k, a( lda ), lda+1, scale, s )
                       ! tri l at a(0,1)
                       call stdlib_I64_slassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
     ...
     !! real symmetric matrix A in RFP format.
        ...
        ! =====================================================================
           ...
           ! Executable Statements 
           if( n==0_ilp64 ) then
              stdlib_I64_dlansf = zero
              return
           else if( n==1_ilp64 ) then
              stdlib_I64_dlansf = abs( a(0_ilp64) )
              return
           end if
           ! set noe = 1 if n is odd. if n is even set noe=0
           noe = 1_ilp64
              ...
              if( noe==1_ilp64 ) then
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 3
                          call stdlib_I64_dlassq( k-j-2, a( k+j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_dlassq( k+j-1, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k-1, a( k ), lda+1, scale, s )
                       ! tri l at a(k,0)
                       call stdlib_I64_dlassq( k, a( k-1 ), lda+1, scale, s )
                       ! tri u at a(k-1,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_dlassq( n-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( j, a( 0_ilp64+( 1_ilp64+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri l at a(0,0)
                       call stdlib_I64_dlassq( k-1, a( 0_ilp64+lda ), lda+1, scale, s )
                       ! tri u at a(0,1)
                    end if
                 else
                    ! a is xpose
                    if( ilu==0_ilp64 ) then
                       ! a**t is upper
                       do j = 1, k - 2
                          call stdlib_I64_dlassq( j, a( 0_ilp64+( k+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! k by k-1 rect. at a(0,0)
                       end do
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( k-j-1, a( j+1+( j+k-1 )*lda ), 1_ilp64,scale, s )
                          ! l at a(0,k-1)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k-1, a( 0_ilp64+k*lda ), lda+1, scale, s )
                       ! tri u at a(0,k)
                       call stdlib_I64_dlassq( k, a( 0_ilp64+( k-1 )*lda ), lda+1, scale, s )
                       ! tri l at a(0,k-1)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_I64_dlassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! u at a(0,0)
                       end do
                       do j = k, n - 1
                          call stdlib_I64_dlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 3
                          call stdlib_I64_dlassq( k-j-2, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(1,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                       call stdlib_I64_dlassq( k-1, a( 1_ilp64 ), lda+1, scale, s )
                       ! tri l at a(1,0)
                    end if
                 end if
              else
                 ...
                 if( ifm==1_ilp64 ) then
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a is upper
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( k-j-1, a( k+j+2+j*lda ), 1_ilp64, scale, s )
                          ! l at a(k+1,0)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_dlassq( k+j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                          ! trap u at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( k+1 ), lda+1, scale, s )
                       ! tri l at a(k+1,0)
                       call stdlib_I64_dlassq( k, a( k ), lda+1, scale, s )
                       ! tri u at a(k,0)
                    else
                       ! ilu=1
                       do j = 0, k - 1
                          call stdlib_I64_dlassq( n-j-1, a( j+2+j*lda ), 1_ilp64, scale, s )
                          ! trap l at a(1,0)
                       end do
                       do j = 1, k - 1
                          call stdlib_I64_dlassq( j, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( 1_ilp64 ), lda+1, scale, s )
                       ! tri l at a(1,0)
                       call stdlib_I64_dlassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
                    ...
                    if( ilu==0_ilp64 ) then
                       ! a**t is upper
                       do j = 1, k - 1
                          call stdlib_I64_dlassq( j, a( 0_ilp64+( k+1+j )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,k+1)
                       end do
                       do j = 0, k - 1
                          call stdlib_I64_dlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( k-j-1, a( j+1+( j+k )*lda ), 1_ilp64, scale,s )
                          ! l at a(0,k)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( 0_ilp64+( k+1 )*lda ), lda+1, scale, s )
                       ! tri u at a(0,k+1)
                       call stdlib_I64_dlassq( k, a( 0_ilp64+k*lda ), lda+1, scale, s )
                       ! tri l at a(0,k)
                    else
                       ! a**t is lower
                       do j = 1, k - 1
                          call stdlib_I64_dlassq( j, a( 0_ilp64+( j+1 )*lda ), 1_ilp64, scale, s )
                          ! u at a(0,1)
                       end do
                       do j = k + 1, n
                          call stdlib_I64_dlassq( k, a( 0_ilp64+j*lda ), 1_ilp64, scale, s )
                       ...
                       do j = 0, k - 2
                          call stdlib_I64_dlassq( k-j-1, a( j+1+j*lda ), 1_ilp64, scale, s )
                          ! l at a(0,0)
                       end do
                       s = s + s
                       ! double s for the off diagonal elements
                       call stdlib_I64_dlassq( k, a( lda ), lda+1, scale, s )
                       ! tri l at a(0,1)
                       call stdlib_I64_dlassq( k, a( 0_ilp64 ), lda+1, scale, s )
                       ! tri u at a(0,0)
                    end if
     ...
     !! complex hermitian matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_classq( j-1, ap( k ), 1_ilp64, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_classq( n-j, ap( k ), 1_ilp64, scale, sum )
                    k = k + n - j + 1_ilp64
                 end do
              end if
              sum = 2_ilp64*sum
              ...
              do i = 1, n
                 if( real( ap( k ),KIND=sp)/=zero ) then
                    absa = abs( real( ap( k ),KIND=sp) )
                    if( scale<absa ) then
                       sum = one + sum*( scale / absa )**2_ilp64
                       scale = absa
                    else
                       sum = sum + ( absa / scale )**2_ilp64
                    end if
                 end if
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    k = k + i + 1_ilp64
     ...
     !! complex hermitian matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_zlassq( j-1, ap( k ), 1_ilp64, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_zlassq( n-j, ap( k ), 1_ilp64, scale, sum )
                    k = k + n - j + 1_ilp64
                 end do
              end if
              sum = 2_ilp64*sum
     ...
     !! real symmetric matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_slassq( j-1, ap( k ), 1_ilp64, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_slassq( n-j, ap( k ), 1_ilp64, scale, sum )
                    k = k + n - j + 1_ilp64
                 end do
              end if
              sum = 2_ilp64*sum
     ...
     !! real symmetric matrix A,  supplied in packed form.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_dlassq( j-1, ap( k ), 1_ilp64, scale, sum )
                    k = k + j
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_dlassq( n-j, ap( k ), 1_ilp64, scale, sum )
                    k = k + n - j + 1_ilp64
                 end do
              end if
              sum = 2_ilp64*sum
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = abs( real( ab( 1_ilp64, j ),KIND=sp) )
                    if( value < sum .or. stdlib_I64_sisnan( sum ) ) value = sum
                    do i = 2, min( n+1-j, k+1 )
                       sum = abs( ab( i, j ) )
                       if( value < sum .or. stdlib_I64_sisnan( sum ) ) value = sum
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = work( j ) + abs( real( ab( 1_ilp64, j ),KIND=sp) )
                    l = 1_ilp64 - j
                    do i = j + 1, min( n, j+k )
                       absa = abs( ab( l+i, j ) )
                       sum = sum + absa
              ...
              if( k>0_ilp64 ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_I64_classq( min( j-1, k ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                                 
                    end do
                    l = k + 1_ilp64
                 else
                    do j = 1, n - 1
                       call stdlib_I64_classq( min( n-j, k ), ab( 2_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                    l = 1_ilp64
                 end if
                 sum = 2_ilp64*sum
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = abs( real( ab( 1_ilp64, j ),KIND=dp) )
                    if( value < sum .or. stdlib_I64_disnan( sum ) ) value = sum
                    do i = 2, min( n+1-j, k+1 )
                       sum = abs( ab( i, j ) )
                       if( value < sum .or. stdlib_I64_disnan( sum ) ) value = sum
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 ...
                 do j = 1, n
                    sum = work( j ) + abs( real( ab( 1_ilp64, j ),KIND=dp) )
                    l = 1_ilp64 - j
                    do i = j + 1, min( n, j+k )
                       absa = abs( ab( l+i, j ) )
                       sum = sum + absa
              ...
              if( k>0_ilp64 ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_I64_zlassq( min( j-1, k ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                                 
                    end do
                    l = k + 1_ilp64
                 else
                    do j = 1, n - 1
                       call stdlib_I64_zlassq( min( n-j, k ), ab( 2_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                    l = 1_ilp64
                 end if
                 sum = 2_ilp64*sum
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( k>0_ilp64 ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_I64_slassq( min( j-1, k ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                                 
                    end do
                    l = k + 1_ilp64
                 else
                    do j = 1, n - 1
                       call stdlib_I64_slassq( min( n-j, k ), ab( 2_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                    l = 1_ilp64
                 end if
                 sum = 2_ilp64*sum
              ...
              call stdlib_I64_slassq( n, ab( l, 1_ilp64 ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slansb = value
           return
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( k>0_ilp64 ) then
                 if( stdlib_lsame( uplo, 'U' ) ) then
                    do j = 2, n
                       call stdlib_I64_dlassq( min( j-1, k ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                                 
                    end do
                    l = k + 1_ilp64
                 else
                    do j = 1, n - 1
                       call stdlib_I64_dlassq( min( n-j, k ), ab( 2_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                    l = 1_ilp64
                 end if
                 sum = 2_ilp64*sum
              ...
              call stdlib_I64_dlassq( n, ab( l, 1_ilp64 ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlansb = value
           return
     ...
     !! n by n symmetric band matrix A,  with k super-diagonals.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              call stdlib_I64_classq( n, ab( l, 1_ilp64 ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clansb = value
           return
     ...
     !! n by n symmetric band matrix A,  with k super-diagonals.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              call stdlib_I64_zlassq( n, ab( l, 1_ilp64 ), ldab, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlansb = value
           return
     ...
     !! complex Hermitian tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              do i = 1, n - 1
                 sum = abs( d( i ) )
                 if( anorm < sum .or. stdlib_I64_sisnan( sum ) ) anorm = sum
                 sum = abs( e( i ) )
                 if( anorm < sum .or. stdlib_I64_sisnan( sum ) ) anorm = sum
              end do
           else if( stdlib_lsame( norm, 'O' ) .or. norm=='1' .or.stdlib_lsame( norm, 'I' ) ) &
              ...
              if( n==1_ilp64 ) then
                 ...
                 anorm = abs( d( 1_ilp64 ) )+abs( e( 1_ilp64 ) )
                 sum = abs( e( n-1 ) )+abs( d( n ) )
                 if( anorm < sum .or. stdlib_I64_sisnan( sum ) ) anorm = sum
                 do i = 2, n - 1
                    sum = abs( d( i ) )+abs( e( i ) )+abs( e( i-1 ) )
              ...
              sum = one
              if( n>1_ilp64 ) then
                 call stdlib_I64_classq( n-1, e, 1_ilp64, scale, sum )
                 sum = 2_ilp64*sum
              end if
              call stdlib_I64_slassq( n, d, 1_ilp64, scale, sum )
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_clanht = anorm
           return
     ...
     !! complex Hermitian tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              do i = 1, n - 1
                 sum =  abs( d( i ) )
                 if( anorm < sum .or. stdlib_I64_disnan( sum ) ) anorm = sum
                 sum = abs( e( i ) )
                 if( anorm < sum .or. stdlib_I64_disnan( sum ) ) anorm = sum
              end do
           else if( stdlib_lsame( norm, 'O' ) .or. norm=='1' .or.stdlib_lsame( norm, 'I' ) ) &
              ...
              sum = one
              if( n>1_ilp64 ) then
                 call stdlib_I64_zlassq( n-1, e, 1_ilp64, scale, sum )
                 sum = 2_ilp64*sum
              end if
              call stdlib_I64_dlassq( n, d, 1_ilp64, scale, sum )
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_zlanht = anorm
           return
     ...
     !! real symmetric tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              sum = one
              if( n>1_ilp64 ) then
                 call stdlib_I64_slassq( n-1, e, 1_ilp64, scale, sum )
                 sum = 2_ilp64*sum
              end if
              call stdlib_I64_slassq( n, d, 1_ilp64, scale, sum )
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_slanst = anorm
           return
     ...
     !! real symmetric tridiagonal matrix A.
        ...
        ! =====================================================================
           ...
           if( n<=0_ilp64 ) then
              ...
              sum = one
              if( n>1_ilp64 ) then
                 call stdlib_I64_dlassq( n-1, e, 1_ilp64, scale, sum )
                 sum = 2_ilp64*sum
              end if
              call stdlib_I64_dlassq( n, d, 1_ilp64, scale, sum )
              anorm = scale*sqrt( sum )
           end if
           stdlib_I64_dlanst = anorm
           return
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_I64_slassq( min( m, j-1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_slassq( min( m, j ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_I64_slassq( m-j, a( min( m, j+1 ), j ), 1_ilp64, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_slassq( m-j+1, a( j, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slantr = value
           return
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_I64_dlassq( min( m, j-1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_dlassq( min( m, j ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_I64_dlassq( m-j, a( min( m, j+1 ), j ), 1_ilp64, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_dlassq( m-j+1, a( j, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlantr = value
           return
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_I64_classq( min( m, j-1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_classq( min( m, j ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_I64_classq( m-j, a( min( m, j+1 ), j ), 1_ilp64, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_classq( m-j+1, a( j, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clantr = value
           return
           ...
           if( min( m, n )==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 2, n
                       call stdlib_I64_zlassq( min( m, j-1 ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_zlassq( min( m, j ), a( 1_ilp64, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = min( m, n )
                    do j = 1, n
                       call stdlib_I64_zlassq( m-j, a( min( m, j+1 ), j ), 1_ilp64, scale,sum )
                    end do
                 else
                    scale = zero
                    sum = one
                    do j = 1, n
                       call stdlib_I64_zlassq( m-j+1, a( j, j ), 1_ilp64, scale, sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlantr = value
           return
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_slassq( j, ap( k ), 1_ilp64, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_slassq( n-j+1, ap( k ), 1_ilp64, scale, sum )
                       k = k + n - j + 1_ilp64
                    end do
                 end if
              end if
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_dlassq( j, ap( k ), 1_ilp64, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_dlassq( n-j+1, ap( k ), 1_ilp64, scale, sum )
                       k = k + n - j + 1_ilp64
                    end do
                 end if
              end if
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_classq( j, ap( k ), 1_ilp64, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_classq( n-j+1, ap( k ), 1_ilp64, scale, sum )
                       k = k + n - j + 1_ilp64
                    end do
                 end if
              end if
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_zlassq( j, ap( k ), 1_ilp64, scale, sum )
                       k = k + j
                    end do
                 end if
              else
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    k = 1_ilp64
                    do j = 1, n
                       call stdlib_I64_zlassq( n-j+1, ap( k ), 1_ilp64, scale, sum )
                       k = k + n - j + 1_ilp64
                    end do
                 end if
              end if
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp64 ) then
                       do j = 2, n
                          call stdlib_I64_slassq( min( j-1, k ),ab( max( k+2-j, 1_ilp64 ), j ), 1_ilp64, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_slassq( min( j, k+1 ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_slassq( min( n-j+1, k+1 ), ab( 1_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slantb = value
           return
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp64 ) then
                       do j = 2, n
                          call stdlib_I64_dlassq( min( j-1, k ),ab( max( k+2-j, 1_ilp64 ), j ), 1_ilp64, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_dlassq( min( j, k+1 ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_dlassq( min( n-j+1, k+1 ), ab( 1_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlantb = value
           return
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp64 ) then
                       do j = 2, n
                          call stdlib_I64_classq( min( j-1, k ),ab( max( k+2-j, 1_ilp64 ), j ), 1_ilp64, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_classq( min( j, k+1 ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_classq( min( n-j+1, k+1 ), ab( 1_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clantb = value
           return
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    if( k>0_ilp64 ) then
                       do j = 2, n
                          call stdlib_I64_zlassq( min( j-1, k ),ab( max( k+2-j, 1_ilp64 ), j ), 1_ilp64, scale,&
                                    sum )
                       end do
                    end if
                 else
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_zlassq( min( j, k+1 ), ab( max( k+2-j, 1_ilp64 ), j ),1_ilp64, scale, sum )
                 ...
                 if( stdlib_lsame( diag, 'U' ) ) then
                    ...
                    sum = one
                    do j = 1, n
                       call stdlib_I64_zlassq( min( n-j+1, k+1 ), ab( 1_ilp64, j ), 1_ilp64, scale,sum )
                    end do
                 end if
              end if
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlantb = value
           return
     ...
     !! real symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_slassq( j-1, a( 1_ilp64, j ), 1_ilp64, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_slassq( n-j, a( j+1, j ), 1_ilp64, scale, sum )
                 end do
              end if
              sum = 2_ilp64*sum
              call stdlib_I64_slassq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_slansy = value
           return
     ...
     !! real symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_dlassq( j-1, a( 1_ilp64, j ), 1_ilp64, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_dlassq( n-j, a( j+1, j ), 1_ilp64, scale, sum )
                 end do
              end if
              sum = 2_ilp64*sum
              call stdlib_I64_dlassq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_dlansy = value
           return
     ...
     !! complex symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_classq( j-1, a( 1_ilp64, j ), 1_ilp64, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_classq( n-j, a( j+1, j ), 1_ilp64, scale, sum )
                 end do
              end if
              sum = 2_ilp64*sum
              call stdlib_I64_classq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_clansy = value
           return
     ...
     !! complex symmetric matrix A.
       ...
       ! =====================================================================
           ...
           if( n==0_ilp64 ) then
              ...
              if( stdlib_lsame( uplo, 'U' ) ) then
                 do j = 2, n
                    call stdlib_I64_zlassq( j-1, a( 1_ilp64, j ), 1_ilp64, scale, sum )
                 end do
              else
                 do j = 1, n - 1
                    call stdlib_I64_zlassq( n-j, a( j+1, j ), 1_ilp64, scale, sum )
                 end do
              end if
              sum = 2_ilp64*sum
              call stdlib_I64_zlassq( n, a, lda+1, scale, sum )
              value = scale*sqrt( sum )
           end if
           stdlib_I64_zlansy = value
           return

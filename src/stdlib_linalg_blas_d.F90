module stdlib_linalg_blas_d
     ...
     public :: stdlib_I64_dasum
     public :: stdlib_I64_daxpy
     public :: stdlib_I64_dcopy
     public :: stdlib_I64_ddot
     public :: stdlib_I64_dgbmv
     public :: stdlib_I64_dgemm
     public :: stdlib_I64_dgemv
     public :: stdlib_I64_dger
     public :: stdlib_I64_dnrm2
     public :: stdlib_I64_drot
     public :: stdlib_I64_drotg
     public :: stdlib_I64_drotm
     public :: stdlib_I64_drotmg
     public :: stdlib_I64_dsbmv
     public :: stdlib_I64_dscal
     public :: stdlib_I64_dsdot
     public :: stdlib_I64_dspmv
     public :: stdlib_I64_dspr
     public :: stdlib_I64_dspr2
     public :: stdlib_I64_dswap
     public :: stdlib_I64_dsymm
     public :: stdlib_I64_dsymv
     public :: stdlib_I64_dsyr
     public :: stdlib_I64_dsyr2
     public :: stdlib_I64_dsyr2k
     public :: stdlib_I64_dsyrk
     public :: stdlib_I64_dtbmv
     public :: stdlib_I64_dtbsv
     public :: stdlib_I64_dtpmv
     public :: stdlib_I64_dtpsv
     public :: stdlib_I64_dtrmm
     public :: stdlib_I64_dtrmv
     public :: stdlib_I64_dtrsm
     public :: stdlib_I64_dtrsv
     public :: stdlib_I64_dzasum
     public :: stdlib_I64_dznrm2
     ...
     pure real(dp) function stdlib_I64_dasum(n,dx,incx)
     !! DASUM takes the sum of the absolute values.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_daxpy(n,da,dx,incx,dy,incy)
     !! DAXPY constant times a vector plus a vector.
     !! uses unrolled loops for increments equal to one.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_dcopy(n,dx,incx,dy,incy)
     !! DCOPY copies a vector, x, to a vector, y.
     !! uses unrolled loops for increments equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure real(dp) function stdlib_I64_ddot(n,dx,incx,dy,incy)
     !! DDOT forms the dot product of two vectors.
     !! uses unrolled loops for increments equal to one.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_dgbmv(trans,m,n,kl,ku,alpha,a,lda,x,incx,beta,y,incy)
     !! DGBMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     !! m by n band matrix, with kl sub-diagonals and ku super-diagonals.
     ...
     pure subroutine stdlib_I64_dgemm(transa,transb,m,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! DGEMM performs one of the matrix-matrix operations
     !! C := alpha*op( A )*op( B ) + beta*C,
     !! where  op( X ) is one of
     !! op( X ) = X   or   op( X ) = X**T,
     ...
     pure subroutine stdlib_I64_dgemv(trans,m,n,alpha,a,lda,x,incx,beta,y,incy)
     !! DGEMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     !! m by n matrix.
     ...
     pure subroutine stdlib_I64_dger(m,n,alpha,x,incx,y,incy,a,lda)
     !! DGER performs the rank 1 operation
     !! A := alpha*x*y**T + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure function stdlib_I64_dnrm2( n, x, incx )
     !! DNRM2 returns the euclidean norm of a vector via the function
     !! name, so that
     !! DNRM2 := sqrt( x'*x )
        real(dp) :: stdlib_I64_dnrm2
        ! -- reference blas level1 routine (version 3.9.1_dp) --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ! march 2021
     ...
     pure subroutine stdlib_I64_drot(n,dx,incx,dy,incy,c,s)
     !! DROT applies a plane rotation.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_drotg( a, b, c, s )
     !! The computation uses the formulas
     !! sigma = sgn(a)    if |a| >  |b|
     !! = sgn(b)    if |b| >= |a|
     !! r = sigma*sqrt( a**2 + b**2 )
     ...
     pure subroutine stdlib_I64_drotm(n,dx,incx,dy,incy,dparam)    
     !! DROTM applies the modified Givens transformation, \(H\), to the 2-by-N matrix 
     !! $$ \left[ \begin{array}{c}DX^T\\DY^T\\ \end{array} \right], $$ 
     !! where \(^T\) indicates transpose. The elements of \(DX\) are in 
     !! DX(LX+I*INCX), I = 0:N-1, where LX = 1 if INCX >= 0, else LX = (-INCX)*N, 
     ...
     pure subroutine stdlib_I64_drotmg(dd1,dd2,dx1,dy1,dparam)
     !! DROTMG Constructs the modified Givens transformation matrix \(H\) which zeros the 
     !! second component of the 2-vector 
     !! $$ \left[ {\sqrt{DD_1}\cdot DX_1,\sqrt{DD_2}\cdot DY_2} \right]^T. $$
     !! With DPARAM(1)=DFLAG, \(H\) has one of the following forms:          
     ...
     pure subroutine stdlib_I64_dsbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
     !! DSBMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric band matrix, with k super-diagonals.
     ...
     pure subroutine stdlib_I64_dscal(n,da,dx,incx)
     !! DSCAL scales a vector by a constant.
     !! uses unrolled loops for increment equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure real(dp) function stdlib_I64_dsdot(n,sx,incx,sy,incy)
     !! Compute the inner product of two vectors with extended
     !! precision accumulation and result.
     !! Returns D.P. dot product accumulated in D.P., for S.P. SX and SY
     !! DSDOT = sum for I = 0 to N-1 of  SX(LX+I*INCX) * SY(LY+I*INCY),
     ...
     pure subroutine stdlib_I64_dspmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
     !! DSPMV performs the matrix-vector operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_dspr(uplo,n,alpha,x,incx,ap)
     !! DSPR performs the symmetric rank 1 operation
     !! A := alpha*x*x**T + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_dspr2(uplo,n,alpha,x,incx,y,incy,ap)
     !! DSPR2 performs the symmetric rank 2 operation
     !! A := alpha*x*y**T + alpha*y*x**T + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an
     !! n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_dswap(n,dx,incx,dy,incy)
     !! DSWAP interchanges two vectors.
     !! uses unrolled loops for increments equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_dsymm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! DSYMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     !! C are  m by n matrices.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('DSYMM ',info)
               return
           end if
           ! quick return if possible.
           if ((m==0) .or. (n==0) .or.((alpha==zero).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_dsymv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
     !! DSYMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_dsyr(uplo,n,alpha,x,incx,a,lda)
     !! DSYR performs the symmetric rank 1 operation
     !! A := alpha*x*x**T + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_dsyr2(uplo,n,alpha,x,incx,y,incy,a,lda)
     !! DSYR2 performs the symmetric rank 2 operation
     !! A := alpha*x*y**T + alpha*y*x**T + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an n
     !! by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_dsyr2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! DSYR2K performs one of the symmetric rank 2k operations
     !! C := alpha*A*B**T + alpha*B*A**T + beta*C,
     !! or
     !! C := alpha*A**T*B + alpha*B**T*A + beta*C,
     ...
     !! matrices in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('DSYR2K',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==zero).or.(k==0)).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_dsyrk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! DSYRK performs one of the symmetric rank k operations
     !! C := alpha*A*A**T + beta*C,
     !! or
     !! C := alpha*A**T*A + beta*C,
     ...
     !! in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('DSYRK ',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==zero).or.(k==0)).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_dtbmv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! DTBMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular band matrix, with ( k + 1 ) diagonals.
     ...
     pure subroutine stdlib_I64_dtbsv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! DTBSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular band matrix, with ( k + 1 )
     ...
     pure subroutine stdlib_I64_dtpmv(uplo,trans,diag,n,ap,x,incx)
     !! DTPMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_dtpsv(uplo,trans,diag,n,ap,x,incx)
     !! DTPSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_dtrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! DTRMM performs one of the matrix-matrix operations
     !! B := alpha*op( A )*B,   or   B := alpha*B*op( A ),
     !! where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !! op( A ) = A   or   op( A ) = A**T.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('DTRMM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_dtrmv(uplo,trans,diag,n,a,lda,x,incx)
     !! DTRMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix.
     ...
     pure subroutine stdlib_I64_dtrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! DTRSM solves one of the matrix equations
     !! op( A )*X = alpha*B,   or   X*op( A ) = alpha*B,
     !! where alpha is a scalar, X and B are m by n matrices, A is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('DTRSM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_dtrsv(uplo,trans,diag,n,a,lda,x,incx)
     !! DTRSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix.
     ...
     pure real(dp) function stdlib_I64_dzasum(n,zx,incx)
     !! DZASUM takes the sum of the (|Re(.)| + |Im(.)|)'s of a complex vector and
     !! returns a double precision result.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure function stdlib_I64_dznrm2( n, x, incx )
     !! DZNRM2 returns the euclidean norm of a vector via the function
     !! name, so that
     !! DZNRM2 := sqrt( x**H*x )
        real(dp) :: stdlib_I64_dznrm2
        ! -- reference blas level1 routine (version 3.9.1_dp) --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ! march 2021

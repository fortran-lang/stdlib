module stdlib_linalg_blas_z
     ...
     public :: stdlib_ztrsm
     public :: stdlib_ztrsv
     public :: stdlib_I64_zaxpy
     public :: stdlib_I64_zcopy
     public :: stdlib_I64_zdotc
     public :: stdlib_I64_zdotu
     public :: stdlib_I64_zdrot
     public :: stdlib_I64_zdscal
     public :: stdlib_I64_zgbmv
     public :: stdlib_I64_zgemm
     public :: stdlib_I64_zgemv
     public :: stdlib_I64_zgerc
     public :: stdlib_I64_zgeru
     public :: stdlib_I64_zhbmv
     public :: stdlib_I64_zhemm
     public :: stdlib_I64_zhemv
     public :: stdlib_I64_zher
     public :: stdlib_I64_zher2
     public :: stdlib_I64_zher2k
     public :: stdlib_I64_zherk
     public :: stdlib_I64_zhpmv
     public :: stdlib_I64_zhpr
     public :: stdlib_I64_zhpr2
     public :: stdlib_I64_zrotg
     public :: stdlib_I64_zscal
     public :: stdlib_I64_zswap
     public :: stdlib_I64_zsymm
     public :: stdlib_I64_zsyr2k
     public :: stdlib_I64_zsyrk
     public :: stdlib_I64_ztbmv
     public :: stdlib_I64_ztbsv
     public :: stdlib_I64_ztpmv
     public :: stdlib_I64_ztpsv
     public :: stdlib_I64_ztrmm
     public :: stdlib_I64_ztrmv
     public :: stdlib_I64_ztrsm
     public :: stdlib_I64_ztrsv
     ...
     pure subroutine stdlib_I64_zaxpy(n,za,zx,incx,zy,incy)
     !! ZAXPY constant times a vector plus a vector.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_zcopy(n,zx,incx,zy,incy)
     !! ZCOPY copies a vector, x, to a vector, y.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure complex(dp) function stdlib_I64_zdotc(n,zx,incx,zy,incy)
     !! ZDOTC forms the dot product of two complex vectors
     !! ZDOTC = X^H * Y
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure complex(dp) function stdlib_I64_zdotu(n,zx,incx,zy,incy)
     !! ZDOTU forms the dot product of two complex vectors
     !! ZDOTU = X^T * Y
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_zdrot( n, zx, incx, zy, incy, c, s )
     !! Applies a plane rotation, where the cos and sin (c and s) are real
     !! and the vectors cx and cy are complex.
     !! jack dongarra, linpack, 3/11/78.
        ! -- reference blas level1 routine --
     ...
     pure subroutine stdlib_I64_zdscal(n,da,zx,incx)
     !! ZDSCAL scales a vector by a constant.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_zgbmv(trans,m,n,kl,ku,alpha,a,lda,x,incx,beta,y,incy)
     !! ZGBMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,   or
     !! y := alpha*A**H*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     ...
     pure subroutine stdlib_I64_zgemm(transa,transb,m,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! ZGEMM performs one of the matrix-matrix operations
     !! C := alpha*op( A )*op( B ) + beta*C,
     !! where  op( X ) is one of
     !! op( X ) = X   or   op( X ) = X**T   or   op( X ) = X**H,
     ...
     pure subroutine stdlib_I64_zgemv(trans,m,n,alpha,a,lda,x,incx,beta,y,incy)
     !! ZGEMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,   or
     !! y := alpha*A**H*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     ...
     pure subroutine stdlib_I64_zgerc(m,n,alpha,x,incx,y,incy,a,lda)
     !! ZGERC performs the rank 1 operation
     !! A := alpha*x*y**H + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure subroutine stdlib_I64_zgeru(m,n,alpha,x,incx,y,incy,a,lda)
     !! ZGERU performs the rank 1 operation
     !! A := alpha*x*y**T + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure subroutine stdlib_I64_zhbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
     !! ZHBMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian band matrix, with k super-diagonals.
     ...
     pure subroutine stdlib_I64_zhemm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! ZHEMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     pure subroutine stdlib_I64_zhemv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
     !! ZHEMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_zher(uplo,n,alpha,x,incx,a,lda)
     !! ZHER performs the hermitian rank 1 operation
     !! A := alpha*x*x**H + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_zher2(uplo,n,alpha,x,incx,y,incy,a,lda)
     !! ZHER2 performs the hermitian rank 2 operation
     !! A := alpha*x*y**H + conjg( alpha )*y*x**H + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an n
     !! by n hermitian matrix.
     ...
     pure subroutine stdlib_I64_zher2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! ZHER2K performs one of the hermitian rank 2k operations
     !! C := alpha*A*B**H + conjg( alpha )*B*A**H + beta*C,
     !! or
     !! C := alpha*A**H*B + conjg( alpha )*B**H*A + beta*C,
     ...
     pure subroutine stdlib_I64_zherk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! ZHERK performs one of the hermitian rank k operations
     !! C := alpha*A*A**H + beta*C,
     !! or
     !! C := alpha*A**H*A + beta*C,
     ...
     pure subroutine stdlib_I64_zhpmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
     !! ZHPMV performs the matrix-vector operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_zhpr(uplo,n,alpha,x,incx,ap)
     !! ZHPR performs the hermitian rank 1 operation
     !! A := alpha*x*x**H + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_zhpr2(uplo,n,alpha,x,incx,y,incy,ap)
     !! ZHPR2 performs the hermitian rank 2 operation
     !! A := alpha*x*y**H + conjg( alpha )*y*x**H + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an
     !! n by n hermitian matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_zrotg( a, b, c, s )
     !! The computation uses the formulas
     !! |x| = sqrt( Re(x)**2 + Im(x)**2 )
     !! sgn(x) = x / |x|  if x /= 0
     !! = 1        if x  = 0
     ...
     pure subroutine stdlib_I64_zscal(n,za,zx,incx)
     !! ZSCAL scales a vector by a constant.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_zswap(n,zx,incx,zy,incy)
     !! ZSWAP interchanges two vectors.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_zsymm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! ZSYMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     !! C are m by n matrices.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('ZSYMM ',info)
               return
           end if
           ! quick return if possible.
           if ((m==0) .or. (n==0) .or.((alpha==czero).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_zsyr2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! ZSYR2K performs one of the symmetric rank 2k operations
     !! C := alpha*A*B**T + alpha*B*A**T + beta*C,
     !! or
     !! C := alpha*A**T*B + alpha*B**T*A + beta*C,
     ...
     !! matrices in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('ZSYR2K',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==czero).or.(k==0)).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_zsyrk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! ZSYRK performs one of the symmetric rank k operations
     !! C := alpha*A*A**T + beta*C,
     !! or
     !! C := alpha*A**T*A + beta*C,
     ...
     !! in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('ZSYRK ',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==czero).or.(k==0)).and. (beta==cone))) return
     ...
     pure subroutine stdlib_I64_ztbmv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! ZTBMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular band matrix, with ( k + 1 ) diagonals.
     ...
     pure subroutine stdlib_I64_ztbsv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! ZTBSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular band matrix, with ( k + 1 )
     ...
     pure subroutine stdlib_I64_ztpmv(uplo,trans,diag,n,ap,x,incx)
     !! ZTPMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_ztpsv(uplo,trans,diag,n,ap,x,incx)
     !! ZTPSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_ztrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! ZTRMM performs one of the matrix-matrix operations
     !! B := alpha*op( A )*B,   or   B := alpha*B*op( A )
     !! where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !! op( A ) = A   or   op( A ) = A**T   or   op( A ) = A**H.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('ZTRMM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_ztrmv(uplo,trans,diag,n,a,lda,x,incx)
     !! ZTRMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,   or   x := A**H*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix.
     ...
     pure subroutine stdlib_I64_ztrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! ZTRSM solves one of the matrix equations
     !! op( A )*X = alpha*B,   or   X*op( A ) = alpha*B,
     !! where alpha is a scalar, X and B are m by n matrices, A is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('ZTRSM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_ztrsv(uplo,trans,diag,n,a,lda,x,incx)
     !! ZTRSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,   or   A**H*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix.

module stdlib_linalg_blas_s
     ...
     public :: stdlib_strsm
     public :: stdlib_strsv
     public :: stdlib_I64_sasum
     public :: stdlib_I64_saxpy
     public :: stdlib_I64_scasum
     public :: stdlib_I64_scnrm2
     public :: stdlib_I64_scopy
     public :: stdlib_I64_sdot
     public :: stdlib_I64_sdsdot
     public :: stdlib_I64_sgbmv
     public :: stdlib_I64_sgemm
     public :: stdlib_I64_sgemv
     public :: stdlib_I64_sger
     public :: stdlib_I64_snrm2
     public :: stdlib_I64_srot
     public :: stdlib_I64_srotg
     public :: stdlib_I64_srotm
     public :: stdlib_I64_srotmg
     public :: stdlib_I64_ssbmv
     public :: stdlib_I64_sscal
     public :: stdlib_I64_sspmv
     public :: stdlib_I64_sspr
     public :: stdlib_I64_sspr2
     public :: stdlib_I64_sswap
     public :: stdlib_I64_ssymm
     public :: stdlib_I64_ssymv
     public :: stdlib_I64_ssyr
     public :: stdlib_I64_ssyr2
     public :: stdlib_I64_ssyr2k
     public :: stdlib_I64_ssyrk
     public :: stdlib_I64_stbmv
     public :: stdlib_I64_stbsv
     public :: stdlib_I64_stpmv
     public :: stdlib_I64_stpsv
     public :: stdlib_I64_strmm
     public :: stdlib_I64_strmv
     public :: stdlib_I64_strsm
     public :: stdlib_I64_strsv
     ...
     pure real(sp) function stdlib_I64_sasum(n,sx,incx)
     !! SASUM takes the sum of the absolute values.
     !! uses unrolled loops for increment equal to one.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_saxpy(n,sa,sx,incx,sy,incy)
     !! SAXPY constant times a vector plus a vector.
     !! uses unrolled loops for increments equal to one.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure real(sp) function stdlib_I64_scasum(n,cx,incx)
     !! SCASUM takes the sum of the (|Re(.)| + |Im(.)|)'s of a complex vector and
     !! returns a single precision result.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure function stdlib_I64_scnrm2( n, x, incx )
     !! SCNRM2 returns the euclidean norm of a vector via the function
     !! name, so that
     !! SCNRM2 := sqrt( x**H*x )
        real(sp) :: stdlib_I64_scnrm2
        ! -- reference blas level1 routine (version 3.9.1_sp) --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ! march 2021
     ...
     pure subroutine stdlib_I64_scopy(n,sx,incx,sy,incy)
     !! SCOPY copies a vector, x, to a vector, y.
     !! uses unrolled loops for increments equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure real(sp) function stdlib_I64_sdot(n,sx,incx,sy,incy)
     !! SDOT forms the dot product of two vectors.
     !! uses unrolled loops for increments equal to one.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure real(sp) function stdlib_I64_sdsdot(n,sb,sx,incx,sy,incy)
     !! Compute the inner product of two vectors with extended
     !! precision accumulation.
     !! Returns S.P. result with dot product accumulated in D.P.
     !! SDSDOT = SB + sum for I = 0 to N-1 of SX(LX+I*INCX)*SY(LY+I*INCY),
     ...
     !! defined in a similar way using INCY.
        ...
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           stdlib_I64_sdsdot = dsdot
           return
     end function stdlib_I64_sdsdot


     pure subroutine stdlib_I64_sgbmv(trans,m,n,kl,ku,alpha,a,lda,x,incx,beta,y,incy)
     !! SGBMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     !! m by n band matrix, with kl sub-diagonals and ku super-diagonals.
     ...
     pure subroutine stdlib_I64_sgemm(transa,transb,m,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! SGEMM performs one of the matrix-matrix operations
     !! C := alpha*op( A )*op( B ) + beta*C,
     !! where  op( X ) is one of
     !! op( X ) = X   or   op( X ) = X**T,
     ...
     pure subroutine stdlib_I64_sgemv(trans,m,n,alpha,a,lda,x,incx,beta,y,incy)
     !! SGEMV performs one of the matrix-vector operations
     !! y := alpha*A*x + beta*y,   or   y := alpha*A**T*x + beta*y,
     !! where alpha and beta are scalars, x and y are vectors and A is an
     !! m by n matrix.
     ...
     pure subroutine stdlib_I64_sger(m,n,alpha,x,incx,y,incy,a,lda)
     !! SGER performs the rank 1 operation
     !! A := alpha*x*y**T + A,
     !! where alpha is a scalar, x is an m element vector, y is an n element
     !! vector and A is an m by n matrix.
     ...
     pure function stdlib_I64_snrm2( n, x, incx )
     !! SNRM2 returns the euclidean norm of a vector via the function
     !! name, so that
     !! SNRM2 := sqrt( x'*x ).
        real(sp) :: stdlib_I64_snrm2
        ! -- reference blas level1 routine (version 3.9.1_sp) --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ! march 2021
     ...
     pure subroutine stdlib_I64_srot(n,sx,incx,sy,incy,c,s)
     !! applies a plane rotation.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine stdlib_I64_srotg( a, b, c, s )
     !! The computation uses the formulas
     !! sigma = sgn(a)    if |a| >  |b|
     !! = sgn(b)    if |b| >= |a|
     !! r = sigma*sqrt( a**2 + b**2 )
     ...
     pure subroutine stdlib_I64_srotm(n,sx,incx,sy,incy,sparam)
     !! SROTM applies the modified Givens transformation, \(H\), to the 2-by-N matrix 
     !! $$ \left[ \begin{array}{c}SX^T\\SY^T\\ \end{array} \right], $$ 
     !! where \(^T\) indicates transpose. The elements of \(SX\) are in 
     !! SX(LX+I*INCX), I = 0:N-1, where LX = 1 if INCX >= 0, else LX = (-INCX)*N, 
     ...
     pure subroutine stdlib_I64_srotmg(sd1,sd2,sx1,sy1,sparam)
     !! SROTMG Constructs the modified Givens transformation matrix \(H\) which zeros the 
     !! second component of the 2-vector 
     !! $$ \left[ {\sqrt{SD_1}\cdot SX_1,\sqrt{SD_2}\cdot SY_2} \right]^T. $$
     !! With SPARAM(1)=SFLAG, \(H\) has one of the following forms:          
     ...
     pure subroutine stdlib_I64_ssbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
     !! SSBMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric band matrix, with k super-diagonals.
     ...
     pure subroutine stdlib_I64_sscal(n,sa,sx,incx)
     !! SSCAL scales a vector by a constant.
     !! uses unrolled loops for increment equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_sspmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
     !! SSPMV performs the matrix-vector operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_sspr(uplo,n,alpha,x,incx,ap)
     !! SSPR performs the symmetric rank 1 operation
     !! A := alpha*x*x**T + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_sspr2(uplo,n,alpha,x,incx,y,incy,ap)
     !! SSPR2 performs the symmetric rank 2 operation
     !! A := alpha*x*y**T + alpha*y*x**T + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an
     !! n by n symmetric matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_sswap(n,sx,incx,sy,incy)
     !! SSWAP interchanges two vectors.
     !! uses unrolled loops for increments equal to 1.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
     ...
     pure subroutine stdlib_I64_ssymm(side,uplo,m,n,alpha,a,lda,b,ldb,beta,c,ldc)
     !! SSYMM performs one of the matrix-matrix operations
     !! C := alpha*A*B + beta*C,
     !! or
     !! C := alpha*B*A + beta*C,
     ...
     !! C are  m by n matrices.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('SSYMM ',info)
               return
           end if
           ! quick return if possible.
           if ((m==0) .or. (n==0) .or.((alpha==zero).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_ssymv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
     !! SSYMV performs the matrix-vector  operation
     !! y := alpha*A*x + beta*y,
     !! where alpha and beta are scalars, x and y are n element vectors and
     !! A is an n by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_ssyr(uplo,n,alpha,x,incx,a,lda)
     !! SSYR performs the symmetric rank 1 operation
     !! A := alpha*x*x**T + A,
     !! where alpha is a real scalar, x is an n element vector and A is an
     !! n by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_ssyr2(uplo,n,alpha,x,incx,y,incy,a,lda)
     !! SSYR2 performs the symmetric rank 2 operation
     !! A := alpha*x*y**T + alpha*y*x**T + A,
     !! where alpha is a scalar, x and y are n element vectors and A is an n
     !! by n symmetric matrix.
     ...
     pure subroutine stdlib_I64_ssyr2k(uplo,trans,n,k,alpha,a,lda,b,ldb,beta,c,ldc)
     !! SSYR2K performs one of the symmetric rank 2k operations
     !! C := alpha*A*B**T + alpha*B*A**T + beta*C,
     !! or
     !! C := alpha*A**T*B + alpha*B**T*A + beta*C,
     ...
     !! matrices in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('SSYR2K',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==zero).or.(k==0)).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_ssyrk(uplo,trans,n,k,alpha,a,lda,beta,c,ldc)
     !! SSYRK performs one of the symmetric rank k operations
     !! C := alpha*A*A**T + beta*C,
     !! or
     !! C := alpha*A**T*A + beta*C,
     ...
     !! in the second case.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('SSYRK ',info)
               return
           end if
           ! quick return if possible.
           if ((n==0) .or. (((alpha==zero).or.(k==0)).and. (beta==one))) return
     ...
     pure subroutine stdlib_I64_stbmv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! STBMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular band matrix, with ( k + 1 ) diagonals.
     ...
     pure subroutine stdlib_I64_stbsv(uplo,trans,diag,n,k,a,lda,x,incx)
     !! STBSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular band matrix, with ( k + 1 )
     ...
     pure subroutine stdlib_I64_stpmv(uplo,trans,diag,n,ap,x,incx)
     !! STPMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_stpsv(uplo,trans,diag,n,ap,x,incx)
     !! STPSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix, supplied in packed form.
     ...
     pure subroutine stdlib_I64_strmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! STRMM performs one of the matrix-matrix operations
     !! B := alpha*op( A )*B,   or   B := alpha*B*op( A ),
     !! where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !! op( A ) = A   or   op( A ) = A**T.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('STRMM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_strmv(uplo,trans,diag,n,a,lda,x,incx)
     !! STRMV performs one of the matrix-vector operations
     !! x := A*x,   or   x := A**T*x,
     !! where x is an n element vector and  A is an n by n unit, or non-unit,
     !! upper or lower triangular matrix.
     ...
     pure subroutine stdlib_I64_strsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     !! STRSM solves one of the matrix equations
     !! op( A )*X = alpha*B,   or   X*op( A ) = alpha*B,
     !! where alpha is a scalar, X and B are m by n matrices, A is a unit, or
     !! non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     ...
     !! The matrix X is overwritten on B.
        ...
        ! =====================================================================
           ...
           if (info/=0) then
               call stdlib_I64_xerbla('STRSM ',info)
               return
           end if
           ! quick return if possible.
           if (m==0 .or. n==0) return
     ...
     pure subroutine stdlib_I64_strsv(uplo,trans,diag,n,a,lda,x,incx)
     !! STRSV solves one of the systems of equations
     !! A*x = b,   or   A**T*x = b,
     !! where b and x are n element vectors and A is an n by n unit, or
     !! non-unit, upper or lower triangular matrix.

...
```fortran
{!src/examples/linalg/example_diag1.f90!}
```

```fortran
{!src/examples/linalg/example_diag2.f90!}
```

```fortran
{!src/examples/linalg/example_diag3.f90!}
```

```fortran
{!src/examples/linalg/example_diag4.f90!}
```

```fortran
{!src/examples/linalg/example_diag5.f90!}
```
...
```fortran
{!src/examples/linalg/example_eye1.f90!}
```

```fortran
{!src/examples/linalg/example_eye2.f90!}
```
...
### Example
```fortran
{!src/examples/linalg/example_trace.f90!}
```
...
```fortran
{!src/examples/linalg/example_outer_product.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_square.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_diagonal.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_symmetric.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_skew_symmetric.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_hermitian.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_triangular.f90!}
```
...
```fortran
{!src/examples/linalg/example_is_hessenberg.f90!}
```

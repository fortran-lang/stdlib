...
```fortran
{!test/examples/stats/demo_corr.f90!}
```
...
```fortran
{!test/examples/stats/demo_cov.f90!}
```
...
```fortran
{!test/examples/stats/demo_mean.f90!}
```
...
```fortran
{!test/examples/stats/demo_median.f90!}
```
...
```fortran
{!test/examples/stats/demo_moment.f90!}
```
...
```fortran
{!test/examples/stats/demo_var.f90!}
```

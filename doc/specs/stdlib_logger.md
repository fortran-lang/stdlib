...
```fortran
{!src/examples/logger/example_global_logger.f90!}
```
...
```fortran
{!src/examples/logger/example_add_log_unit.f90!}
```
...
```fortran
{!src/examples/logger/example_configure.f90!}
```
...
```fortran
{!src/examples/logger/example_log_io_error.f90!}
```

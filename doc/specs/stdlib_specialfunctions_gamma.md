...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_gamma.f90!}
```
...
```fortran
{!test/examples/specialfunctions_gamma/demo_log_gamma.f90!}
```
...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_log_factorial.f90!}
```
...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_ligamma.f90!}
```
...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_uigamma.f90!}
```
...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_gamma_p.f90!}
```
...
### Example
```fortran
{!test/examples/specialfunctions_gamma/demo_gamma_q.f90!}
```

...
```fortran
{!test/examples/io/demo_loadtxt.f90!}
```
...
```fortran
{!test/examples/io/demo_open.f90!}
```
...
```fortran
{!test/examples/io/demo_savetxt.f90!}
```
...
```fortran
{!test/examples/io/demo_loadnpy.f90!}
```
...
```fortran
{!test/examples/io/demo_savenpy.f90!}
```
...
```fortran
{!test/examples/io/demo_getline.f90!}
```
...
```fortran
{!test/examples/io/demo_fmt_constants.f90!}
```

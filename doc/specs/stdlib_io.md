...
```fortran
{!test/example/io/example_loadtxt.f90!}
```
...
```fortran
{!test/example/io/example_open.f90!}
```
...
```fortran
{!test/example/io/example_savetxt.f90!}
```
...
```fortran
{!test/example/io/example_loadnpy.f90!}
```
...
```fortran
{!test/example/io/example_savenpy.f90!}
```
...
```fortran
{!test/example/io/example_getline.f90!}
```
...
```fortran
{!test/example/io/example_fmt_constants.f90!}
```

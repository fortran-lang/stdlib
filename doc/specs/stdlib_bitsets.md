...
```fortran
{!test/examples/bitsets/demo_assignment.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_all.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_and.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_and_not.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_any.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_bit_count.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_bits.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_clear.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_extract.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_flip.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_from_string.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_init.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_input.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_none.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_not.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_or.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_output.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_read_bitset.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_set.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_test.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_to_string.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_value.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_write_bitset.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_xor.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_equality.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_inequality.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_ge.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_gt.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_le.f90!}
```
...
```fortran
{!test/examples/bitsets/demo_lt.f90!}
```

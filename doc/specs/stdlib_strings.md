...
```fortran
{!test/examples/strings/demo_strip.f90!}
```
...
```fortran
{!test/examples/strings/demo_chomp.f90!}
```
...
```fortran
{!test/examples/strings/demo_starts_with.f90!}
```
...
```fortran
{!test/examples/strings/demo_ends_with.f90!}
```
...
```fortran
{!test/examples/strings/demo_slice.f90!}
```
...
```fortran
{!test/examples/strings/demo_find.f90!}
```
...
```fortran
{!test/examples/strings/demo_replace_all.f90!}
```
...
```fortran
{!test/examples/strings/demo_padl.f90!}
```
...
```fortran
{!test/examples/strings/demo_padr.f90!}
```
...
```fortran
{!test/examples/strings/demo_count.f90!}
```
...
```fortran
{!test/examples/strings/demo_to_string.f90!}
```

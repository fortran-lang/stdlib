...
```fortran
{!src/examples/stats_distribution_exponential/example_exponential_rvs.f90!}
```
...
```fortran
{!src/examples/stats_distribution_exponential/example_exponential_pdf.f90!}
```
...
```fortran
{!src/examples/stats_distribution_exponential/example_exponential_cdf.f90!}
```

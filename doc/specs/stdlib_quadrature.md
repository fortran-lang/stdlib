...
```fortran
{!src/examples/quadrature/example_trapz.f90!}
```
...
```fortran
{!src/examples/quadrature/example_trapz_weights.f90!}
```
...
```fortran
{!src/examples/quadrature/example_simps.f90!}
```
...
```fortran
{!src/examples/quadrature/example_simps_weights.f90!}
```
...
```fortran
{!src/examples/quadrature/example_gauss_legendre.f90!}
```
...
```fortran
{!src/examples/quadrature/example_gauss_legendre_lobatto.f90!}
```

...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_fidx_bidx.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_constructor.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_insert_at.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_get.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_len.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_clear.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_equality_operator.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_inequality_operator.f90!}
```
...
```fortran
{!src/examples/stringlist_type/example_stringlist_type_concatenate_operator.f90!}
```
